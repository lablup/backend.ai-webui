import{a as pe,j as e,r as c}from"./iframe-CXsUyA8a.js";import{n as de}from"./astryxLabel-X--i2ZA0.js";import{I as me,A as ye,n as ge}from"./astryxNumberStepper-BTRvKsXw.js";import{u as he}from"./useControllableValue-Cw-tx4uL.js";import{N as xe}from"./NumberInput-D33-UbXm.js";import{i as A}from"./isNumber-DFHzuiZY.js";import{B as n}from"./BAIFlex-BlT8atRw.js";import"./preload-helper-Dp1pzeXC.js";import"./InputGroupContext-CIVQQmzp.js";import"./InputClearButton-DjUhMDBg.js";import"./useResolvedRequired-CzgbfYEP.js";import"./useDevWarning-BvfIG6hf.js";import"./useInputStatusIcon-_Pk8tygl.js";const s=({dynamicSteps:a=[0,.0625,.125,.25,.5,.75,1,2,4,8,16,32,64,128,256,512,1024,2048,4096,8192,16384,32768,65536],min:r,max:t,placeholder:v,disabled:l,addonAfter:f,label:o,isLabelHidden:ce,...le})=>{const{t:b}=pe(),[S,B]=he(le,{defaultValue:a[0]}),V=i=>{const C=ge(a,S,i);if(C<0||C>=a.length)return;let u=a[C];A(r)&&u<r?u=r:A(t)&&u>t&&(u=t),B(u)},ue=i=>{l||i.key!=="ArrowUp"&&i.key!=="ArrowDown"||(i.preventDefault(),V(i.key==="ArrowUp"?"up":"down"))},I=o??v??b("general.Select");return e.jsxs(me,{label:I,isLabelHidden:ce??o===void 0,isDisabled:l,children:[e.jsx(xe,{label:I,isLabelHidden:!0,value:S,onChange:i=>B(i??0),onKeyDown:ue,min:r,max:t,units:f===void 0?void 0:de(f),placeholder:v,isDisabled:l,width:"100%"}),e.jsx(ye,{onStep:V,isDisabled:l,increaseLabel:b("general.Increase"),decreaseLabel:b("general.Decrease")})]})},De={title:"Input/BAIDynamicStepInputNumber",component:s,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
