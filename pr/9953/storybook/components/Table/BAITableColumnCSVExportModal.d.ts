...
export interface BAITableColumnCSVExportModalProps<T = unknown> extends Pick<BAIDialogProps, 'afterOpenChange'> {
    open: boolean;
...
declare const BAITableColumnCSVExportModal: <T>({ open, onRequestClose, onExport, supportedFields, columns, notice, afterOpenChange, }: BAITableColumnCSVExportModalProps<T>) => React.JSX.Element;
