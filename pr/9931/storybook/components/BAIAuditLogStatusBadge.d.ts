 ...
 * Relay dependency.
 */
export type AuditLogStatus = 'SUCCESS' | 'ERROR' | 'UNKNOWN' | 'RUNNING' | 'DENIED';
export interface BAIAuditLogStatusBadgeProps extends Omit<BAIBadgeProps, 'text' | 'color' | 'processing'> {
 ...
 */
declare const BAIAuditLogStatusBadge: ({ status, ...badgeProps }: BAIAuditLogStatusBadgeProps) => import("react").JSX.Element;
