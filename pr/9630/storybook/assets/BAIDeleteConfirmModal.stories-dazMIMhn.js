import{r as o,j as e}from"./iframe-BG8PBoo1.js";import{B as a}from"./BAIButton-BJfXWN_p.js";import{B as O}from"./BAICheckbox-CoFHh1VR.js";import{B as n}from"./BAIDeleteConfirmModal-DzUjkWCF.js";import{B as k}from"./BAIFlex-BkQ2VyQ2.js";import{T as i}from"./trash-2-BTQ2asy4.js";import{F as I}from"./folder-CC8Wuh3T.js";import{T as j}from"./Token-QgajrrRs.js";import"./preload-helper-Dp1pzeXC.js";import"./astryxLabel-BRI8evVq.js";import"./CheckboxInput-CkVYrOLh.js";import"./useResolvedRequired-CoSQgkd7.js";import"./useIndicator-hXhbGzBp.js";import"./isRenderable-BUV0eL6r.js";import"./rtlStyles-T4i24HtE.js";import"./BAIModal-D7Ev4ZkV.js";import"./VStack-Ny5tOoG8.js";import"./TextInput-S_kDpJ-X.js";import"./InputGroupContext-B33AkX3J.js";import"./useInputStatusIcon-SiE6_InR.js";import"./InputClearButton-IRT3YizG.js";import"./useDevWarning-A-IafJzr.js";import"./circle-alert-CrYA2rBK.js";import"./Banner-BovruW-c.js";import"./composeEventHandlers-BolWE7qY.js";const ze={title:"Modal/BAIDeleteConfirmModal",component:n,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
- Built on \`BAIModal\`
        `}}}},l={parameters:{docs:{description:{story:"Single item deletion with simple confirm. No text input required."}}},render:()=>{const[r,t]=o.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Delete Item"}),e.jsx(n,{open:r,items:[{key:"1",label:"my-important-resource"}],onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},d={parameters:{docs:{description:{story:"Single item with `requireConfirmInput={true}`. Item list is hidden (name already appears in description). User must type the item name into the confirmation input to enable the Delete button."}}},render:()=>{const[r,t]=o.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Delete (Confirm Required)"}),e.jsx(n,{open:r,items:[{key:"1",label:"production-database"}],requireConfirmInput:!0,onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},c={parameters:{docs:{description:{story:'Resource-typed deletion using the `target` prop. The default description becomes "Are you sure you want to permanently delete {target}?", surfacing the resource type (e.g. "Resource Preset", "Resource Policy") in the dialog copy. Typically paired with `requireConfirmInput` for irreversible deletes.'}}},render:()=>{const[r,t]=o.useState(!1),s="gpu-large-preset";return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Delete Resource Preset"}),e.jsx(n,{open:r,title:"Delete Resource Preset",target:"Resource Preset",items:[{key:s,label:s}],confirmText:s,requireConfirmInput:!0,inputProps:{placeholder:s},onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},p={parameters:{docs:{description:{story:'Multiple items require typing "Delete" to confirm. Shows scrollable item list above the confirmation input.'}}},render:()=>{const[r,t]=o.useState(!1),s=[{key:"1",label:"project-alpha"},{key:"2",label:"project-beta"},{key:"3",label:"project-gamma"},{key:"4",label:"project-delta"},{key:"5",label:"project-epsilon"}];return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Delete 5 Items"}),e.jsx(n,{open:r,items:s,onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},m={parameters:{docs:{description:{story:"Large selection (50 items) demonstrating scroll behavior within the item list."}}},render:()=>{const[r,t]=o.useState(!1),s=Array.from({length:50},(ie,C)=>({key:String(C),label:`resource-${String(C+1).padStart(3,"0")}`}));return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Delete 50 Items"}),e.jsx(n,{open:r,items:s,onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},u={parameters:{docs:{description:{story:"Items with ReactNode labels — icons, tags, and custom components."}}},render:()=>{const[r,t]=o.useState(!1),s=[{key:"1",label:e.jsxs(k,{gap:"xs",align:"center",children:[e.jsx(I,{size:"1em"}),e.jsx("span",{children:"shared-dataset"}),e.jsx(j,{color:"blue",label:"Public"})]})},{key:"2",label:e.jsxs(k,{gap:"xs",align:"center",children:[e.jsx(I,{size:"1em"}),e.jsx("span",{children:"model-weights-v2"}),e.jsx(j,{color:"red",label:"Private"})]})},{key:"3",label:e.jsxs(k,{gap:"xs",align:"center",children:[e.jsx(I,{size:"1em"}),e.jsx("span",{children:"training-logs"}),e.jsx(j,{color:"green",label:"Archived"})]})}];return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Delete Folders"}),e.jsx(n,{open:r,items:s,onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},h={parameters:{docs:{description:{story:"Extra content slot with checkboxes, similar to PurgeUsersModal pattern."}}},render:()=>{const[r,t]=o.useState(!1),s=[{key:"1",label:"user-john@example.com"},{key:"2",label:"user-jane@example.com"}];return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Purge Users"}),e.jsx(n,{open:r,items:s,extraContent:e.jsxs(k,{direction:"column",align:"start",children:[e.jsx(O,{children:"Also delete shared folders"}),e.jsx(O,{children:"Terminate running sessions"})]}),onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},f={parameters:{docs:{description:{story:'Reversible action (e.g. revoke a role assignment, remove a permission from a role). `reversible` keeps the exact same modal chrome as the irreversible-delete modal but never renders the typed-confirmation input and omits the "This action cannot be undone." warning.'}}},render:()=>{const[r,t]=o.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Revoke User"}),e.jsx(n,{open:r,reversible:!0,title:"Revoke User",description:"Revoke the following user(s) from this role?",okText:"Revoke User",items:[{key:"1",label:"user-john@example.com"}],onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},g={parameters:{docs:{description:{story:'Reversible variant with multiple items. Normally 2+ items force the typed-confirmation input; with `reversible` the item list is still shown but no input is required and the "cannot be undone" warning is omitted.'}}},render:()=>{const[r,t]=o.useState(!1),s=[{key:"1",label:"user-john@example.com"},{key:"2",label:"user-jane@example.com"},{key:"3",label:"user-bob@example.com"}];return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Revoke 3 Users"}),e.jsx(n,{open:r,reversible:!0,title:"Revoke User",description:"Revoke the following user(s) from this role?",okText:"Revoke User",items:s,onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},b={parameters:{docs:{description:{story:"Long, unbreakable titles (e.g. a full container image reference) wrap inside the modal header instead of overflowing past the modal border."}}},render:()=>{const[r,t]=o.useState(!1),s="cr.backend.ai/testing/aimet:1.22.2-tf24-py38-cuda11.1-customized_274887c86af24173aa004423019dfcc5@x86_64";return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Delete Image"}),e.jsx(n,{open:r,title:`Delete "${s}"`,items:[{key:s,label:s}],requireConfirmInput:!0,confirmText:s,inputProps:{placeholder:s},onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},x={parameters:{docs:{description:{story:"`plainItems` drops the default surface (background / border / padding / scroll) around the item list. Use when an item `label` is already a self-contained block (e.g. a table or card) so the default box does not produce a redundant double border."}}},render:()=>{const[r,t]=o.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Remove Permission"}),e.jsx(n,{open:r,reversible:!0,plainItems:!0,title:"Remove Permission",description:"Remove the following permission from this role?",okText:"Remove Permission",items:[{key:"1",label:e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",border:"1px solid #d9d9d9"},children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{style:{border:"1px solid #d9d9d9",padding:8},children:"Scope"}),e.jsx("th",{style:{border:"1px solid #d9d9d9",padding:8},children:"Target"}),e.jsx("th",{style:{border:"1px solid #d9d9d9",padding:8},children:"Entity"}),e.jsx("th",{style:{border:"1px solid #d9d9d9",padding:8},children:"Operation"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{style:{border:"1px solid #d9d9d9",padding:8},children:"User"}),e.jsx("td",{style:{border:"1px solid #d9d9d9",padding:8},children:"test@lablup.com"}),e.jsx("td",{style:{border:"1px solid #d9d9d9",padding:8},children:"Notification Channel"}),e.jsx("td",{style:{border:"1px solid #d9d9d9",padding:8},children:"Create"})]})})]})}],onOk:()=>t(!1),onCancel:()=>t(!1)})]})}},y={parameters:{docs:{description:{story:"Edge case: empty items array. OK button is disabled."}}},render:()=>{const[r,t]=o.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(a,{danger:!0,icon:e.jsx(i,{size:"1em"}),onClick:()=>t(!0),children:"Delete (No Selection)"}),e.jsx(n,{open:r,items:[],onOk:()=>t(!1),onCancel:()=>t(!1)})]})}};var B,v,A;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...($=(K=h.parameters)==null?void 0:K.docs)==null?void 0:$.source}}};var G,H,J;f.parameters={...f.parameters,docs:{...(G=f.parameters)==null?void 0:G.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(J=(H=f.parameters)==null?void 0:H.docs)==null?void 0:J.source}}};var Q,V,X;g.parameters={...g.parameters,docs:{...(Q=g.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(X=(V=g.parameters)==null?void 0:V.docs)==null?void 0:X.source}}};var Y,Z,ee;b.parameters={...b.parameters,docs:{...(Y=b.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(se=(re=x.parameters)==null?void 0:re.docs)==null?void 0:se.source}}};var ne,oe,ae;y.parameters={...y.parameters,docs:{...(ne=y.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ae=(oe=y.parameters)==null?void 0:oe.docs)==null?void 0:ae.source}}};const Pe=["SingleItem","SingleItemWithInput","WithTarget","MultipleItems","ManyItems","CustomRenderedItems","WithExtraContent","Reversible","ReversibleMultipleItems","LongTitle","PlainItems","EmptyItems"];export{u as CustomRenderedItems,y as EmptyItems,b as LongTitle,m as ManyItems,p as MultipleItems,x as PlainItems,f as Reversible,g as ReversibleMultipleItems,l as SingleItem,d as SingleItemWithInput,h as WithExtraContent,c as WithTarget,Pe as __namedExportsOrder,ze as default};
