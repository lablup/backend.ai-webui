import{a as Q,r as d,j as e}from"./iframe-BvVGtxqo.js";import{B as m}from"./BAIFlex-CtC0v7TS.js";import{N as X}from"./NumberInput-CmHKPaF5.js";import{T as Y}from"./TextInput-DWX9P7XI.js";import"./preload-helper-Dp1pzeXC.js";import"./useResolvedRequired-BY-Psy39.js";import"./useInputStatusIcon-vUV8ELye.js";import"./InputGroupContext-BZuJA-Ve.js";import"./InputClearButton-A1JqOlkR.js";import"./useDevWarning-Cqxp10ij.js";const n=({defaultValue:t,onCommit:o,type:r,placeholder:s,disabled:c,status:u,label:i,isLabelHidden:q,...K})=>{const{t:O}=Q(),[a,B]=d.useState(t??""),[$,J]=d.useState(t);$!==t&&(J(t),B(t??""));const I={...K,label:i??O("general.Select"),isLabelHidden:q??i===void 0,placeholder:s,isDisabled:c,status:u==="error"||u==="warning"?{type:u}:void 0},p=l=>o==null?void 0:o(l);if(r==="number"){const l=a===""?null:Number(a);return e.jsx(X,{...I,value:Number.isNaN(l)?null:l,onChange:E=>B(E===null?"":String(E)),onEnter:()=>p(a),onBlur:()=>p(a)})}return e.jsx(Y,{...I,type:r==="password"||r==="email"?r:"text",value:a,onChange:l=>B(l),onEnter:()=>p(a),onBlur:()=>p(a)})},le={title:"Input/BAIUncontrolledInput",component:n,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
