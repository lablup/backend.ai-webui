...
`}}})();ae.hash="c76ddd2bc0d0edc5ec72cca26edf6ad9";const _t={title:"Fragments/BAIArtifactRevisionTable",component:se,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
}`,...(_=(Y=R.parameters)==null?void 0:Y.docs)==null?void 0:_.source},description:{story:"Revision table with no revisions (empty state).",...(q=(W=R.parameters)==null?void 0:W.docs)==null?void 0:q.description}}};var J,H,X,Z,ee;y.parameters={...y.parameters,docs:{...(J=y.parameters)==null?void 0:J.docs,source:{originalSource:`{
  name: 'RealWorldUsage',
  parameters: {
    docs: {
      description: {
...
}`,...(X=(H=y.parameters)==null?void 0:H.docs)==null?void 0:X.source},description:{story:"Real-world example with version history and latest revision indicator.",...(ee=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:ee.description}}};const Wt=["Default","DifferentStatuses","WithCustomColumns","Loading","Empty","RealWorldExample"];export{v as Default,p as DifferentStatuses,R as Empty,f as Loading,y as RealWorldExample,g as WithCustomColumns,Wt as __namedExportsOrder,_t as default};
