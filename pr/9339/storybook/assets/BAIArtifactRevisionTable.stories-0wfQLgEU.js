...
}`,...(C=(T=p.parameters)==null?void 0:T.docs)==null?void 0:C.source},description:{story:"Revision table showing different revision statuses.",...(w=(x=p.parameters)==null?void 0:x.docs)==null?void 0:w.description}}};var z,j,K,V,Q;g.parameters={...g.parameters,docs:{...(z=g.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: 'CustomColumns',
  parameters: {
    docs: {
      description: {
...
}`,...(K=(j=g.parameters)==null?void 0:j.docs)==null?void 0:K.source},description:{story:"Revision table with custom columns including action buttons.",...(Q=(V=g.parameters)==null?void 0:V.docs)==null?void 0:Q.description}}};var P,U,M,G,$;f.parameters={...f.parameters,docs:{...(P=f.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: 'LoadingState',
  parameters: {
    docs: {
      description: {
