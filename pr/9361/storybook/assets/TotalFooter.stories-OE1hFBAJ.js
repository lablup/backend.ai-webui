import{e as m,a as u,j as t,d as g}from"./iframe-CHHFS3of.js";import{B as h}from"./BAIFlex-Bhrcnfos.js";import"./preload-helper-Dp1pzeXC.js";/**
...
- Pagination components showing total results
        `}}},argTypes:{total:{control:{type:"number",min:0,max:1e4,step:1},description:"Total number of items to display",table:{type:{summary:"number"}}},loading:{control:{type:"boolean"},description:"Show loading indicator",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}}}},e={name:"Basic",parameters:{docs:{description:{story:"Basic usage showing total item count."}}},args:{total:42}},o={parameters:{docs:{description:{story:"Loading state with spinner. Useful when data is being fetched or updated."}}},args:{loading:!0,total:42}};var a,s,n;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  name: 'Basic',
  parameters: {
    docs: {
      description: {
...
}`,...(l=(i=o.parameters)==null?void 0:i.docs)==null?void 0:l.source}}};const j=["Default","Loading"];export{e as Default,o as Loading,j as __namedExportsOrder,L as default};
