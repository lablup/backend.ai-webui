import{a as z,b as W,j as n}from"./iframe-BX4um4Zu.js";import{B as V}from"./BAIFlex-BeiGC6d_.js";import{B as U}from"./BAIRowWrapWithDividers-Cyb3Ba9p.js";import{B as g}from"./BAIStatistic-Do_cfYJZ.js";import{E as q}from"./EmptyState-BmTxmAbm.js";import"./preload-helper-Dp1pzeXC.js";import"./isUndefined-DCTLXrZ8.js";import"./_castFunction-a6W-o7Lo.js";import"./identity-DKeuBCMA.js";import"./toInteger-IaU3VNDu.js";import"./toFinite-BrKbOmGN.js";import"./_trimmedEndIndex-DuQxD0U0.js";import"./isSymbol-bPz1-CBD.js";const H=({resourceData:e,displayType:t,progressMode:p="hidden",progressSteps:m,precision:y=2})=>{const{t:N}=z(),{token:r}=W();return e.cpu||e.memory||e.accelerators.length>0?n.jsxs(V,{direction:"row",wrap:"wrap",gap:"lg",children:[n.jsxs(U,{children:[e.cpu&&n.jsx(g,{current:e.cpu[t].current,total:e.cpu[t].total,title:e.cpu.metadata.title,unit:e.cpu.metadata.displayUnit,progressMode:p,progressSteps:m,precision:y,style:{color:t==="free"?r("--color-success"):void 0}}),e.memory&&n.jsx(g,{current:e.memory[t].current,total:e.memory[t].total,title:e.memory.metadata.title,unit:e.memory.metadata.displayUnit,progressMode:p,progressSteps:m,precision:y,style:{color:t==="free"?r("--color-success"):void 0}})]}),e.accelerators.length>0&&n.jsx(U,{dividerColor:r("--color-border-emphasized"),style:{backgroundColor:r("--color-background-body"),borderRadius:r("--radius-element"),padding:r("--spacing-4")},children:e.accelerators.map(s=>n.jsx(g,{current:s[t].current,total:s[t].total,title:s.metadata.title,unit:s.metadata.displayUnit,progressMode:p,progressSteps:m,precision:y,style:{color:t==="free"?r("--color-success"):void 0}},s.key))})]}):n.jsx(q,{title:N("comp:ResourceStatistics.NoResourcesData")||""})},se={title:"Statistic/ResourceStatistics",component:H,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
}`,...(R=(M=i.parameters)==null?void 0:M.docs)==null?void 0:R.source}}};var B,S,D;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(D=(S=c.parameters)==null?void 0:S.docs)==null?void 0:D.source}}};var T,k,v;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
