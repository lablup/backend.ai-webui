import{a as Q,r as d,j as e}from"./iframe-CffZ8dTH.js";import{B as m}from"./BAIFlex-DG0g2hYX.js";import{N as X}from"./NumberInput-DGodlCIC.js";import{T as Y}from"./TextInput-SgD44oP5.js";import"./preload-helper-Dp1pzeXC.js";import"./useResolvedRequired-P2KiKMfv.js";import"./useInputStatusIcon-DdgKOgLy.js";import"./InputGroupContext-B-c9kNdk.js";import"./InputClearButton-BHVP1aGq.js";import"./useDevWarning-PAjaGKQ3.js";const n=({defaultValue:t,onCommit:o,type:r,placeholder:s,disabled:c,status:u,label:i,isLabelHidden:q,...K})=>{const{t:O}=Q(),[a,B]=d.useState(t??""),[$,J]=d.useState(t);$!==t&&(J(t),B(t??""));const I={...K,label:i??O("general.Select"),isLabelHidden:q??i===void 0,placeholder:s,isDisabled:c,status:u==="error"||u==="warning"?{type:u}:void 0},p=l=>o==null?void 0:o(l);if(r==="number"){const l=a===""?null:Number(a);return e.jsx(X,{...I,value:Number.isNaN(l)?null:l,onChange:E=>B(E===null?"":String(E)),onEnter:()=>p(a),onBlur:()=>p(a)})}return e.jsx(Y,{...I,type:r==="password"||r==="email"?r:"text",value:a,onChange:l=>B(l),onEnter:()=>p(a),onBlur:()=>p(a)})},le={title:"Input/BAIUncontrolledInput",component:n,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
