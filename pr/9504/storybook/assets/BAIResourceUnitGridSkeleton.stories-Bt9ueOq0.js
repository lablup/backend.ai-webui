import{j as e,aM as a,aC as I}from"./iframe-BpdPUIyf.js";import{B as r}from"./BAIFlex-fuoYo-UG.js";import"./preload-helper-Dp1pzeXC.js";const R=3,f=[140,180,100],S="var(--size-element-sm)",b=5,c=10,A=40,T=12,d=[["45%","25%"],["30%","40%"],["55%","20%"]],k="var(--size-element-sm)",B=({rows:h=R,className:x,..._})=>{"use memo";let t=0;return e.jsxs(r,{direction:"column",align:"stretch",gap:"sm",className:I("bai-resource-unit-grid-skeleton",x),..._,children:[e.jsx(r,{gap:"sm",align:"center",children:f.map((i,s)=>e.jsx(a,{width:i,height:S,radius:2,index:t++},s))}),e.jsx(r,{gap:"sm",wrap:"wrap",align:"center",children:Array.from({length:b},(i,s)=>e.jsxs(r,{gap:4,align:"center",children:[e.jsx(a,{width:c,height:c,radius:1,index:t++}),e.jsx(a,{width:A,height:T,radius:1,index:t++})]},s))}),Array.from({length:Math.max(0,h)},(i,s)=>{const E=d[s%d.length];return e.jsx(r,{gap:"sm",align:"center",className:"bai-resource-unit-grid-skeleton-row",children:E.map((L,y)=>e.jsx(a,{width:L,height:k,radius:1,index:t++},y))},s)})]})},j={title:"Data Display/BAIResourceUnitGridSkeleton",component:B,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
