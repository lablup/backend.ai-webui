...
export interface BAIDeploymentStatusBadgeProps extends Omit<BadgeProps, 'variant' | 'label'> {
    /**
 ...
 * (ADR 0007).
 */
declare const BAIDeploymentStatusBadge: React.FC<BAIDeploymentStatusBadgeProps>;
