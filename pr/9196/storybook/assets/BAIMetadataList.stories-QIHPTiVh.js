...
}`,...(g=(L=o.parameters)==null?void 0:L.docs)==null?void 0:g.source},description:{story:"Side by side. `bordered` is opt-in precisely so both can be used — adopting\nit is a per-surface choice, not a global restyle.",...(B=(A=o.parameters)==null?void 0:A.docs)==null?void 0:B.description}}};var w,v,j,S,P;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'grid',
    gap: 32
  }}>
...
}`,...(j=(v=l.parameters)==null?void 0:v.docs)==null?void 0:j.source},description:{story:"antd's three `size` steps, which set the bordered cell padding.",...(P=(S=l.parameters)==null?void 0:S.docs)==null?void 0:P.description}}};var T,C,E,O,z;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`{
