import{a as pe,j as e,r as c}from"./iframe-C4rsP06f.js";import{n as de}from"./astryxLabel-D0A0bVzk.js";import{I as me,A as ye,n as ge}from"./astryxNumberStepper-BtOi5w74.js";import{u as he}from"./useControllableValue-BGjHjhIq.js";import{N as xe}from"./NumberInput-B_3Ilcmu.js";import{i as A}from"./isNumber-CBuysCnZ.js";import{B as n}from"./BAIFlex-BMjFSmc1.js";import"./preload-helper-Dp1pzeXC.js";import"./InputGroupContext-CAKM5Ff4.js";import"./InputClearButton-D3p2AeEk.js";import"./useResolvedRequired-BOZx4ANM.js";import"./useDevWarning-C7HCz4x0.js";import"./useInputStatusIcon-BO-nbdqV.js";const s=({dynamicSteps:a=[0,.0625,.125,.25,.5,.75,1,2,4,8,16,32,64,128,256,512,1024,2048,4096,8192,16384,32768,65536],min:r,max:t,placeholder:v,disabled:l,addonAfter:f,label:o,isLabelHidden:ce,...le})=>{const{t:b}=pe(),[S,B]=he(le,{defaultValue:a[0]}),V=i=>{const C=ge(a,S,i);if(C<0||C>=a.length)return;let u=a[C];A(r)&&u<r?u=r:A(t)&&u>t&&(u=t),B(u)},ue=i=>{l||i.key!=="ArrowUp"&&i.key!=="ArrowDown"||(i.preventDefault(),V(i.key==="ArrowUp"?"up":"down"))},I=o??v??b("general.Select");return e.jsxs(me,{label:I,isLabelHidden:ce??o===void 0,isDisabled:l,children:[e.jsx(xe,{label:I,isLabelHidden:!0,value:S,onChange:i=>B(i??0),onKeyDown:ue,min:r,max:t,units:f===void 0?void 0:de(f),placeholder:v,isDisabled:l,width:"100%"}),e.jsx(ye,{onStep:V,isDisabled:l,increaseLabel:b("general.Increase"),decreaseLabel:b("general.Decrease")})]})},De={title:"Input/BAIDynamicStepInputNumber",component:s,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
