...
}`,...(H=(V=x.parameters)==null?void 0:V.docs)==null?void 0:H.source}}};var U,Y,K;y.parameters={...y.parameters,docs:{...(U=y.parameters)==null?void 0:U.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(K=(Y=y.parameters)==null?void 0:Y.docs)==null?void 0:K.source}}};var _,q,X;B.parameters={...B.parameters,docs:{...(_=B.parameters)==null?void 0:_.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(X=(q=B.parameters)==null?void 0:q.docs)==null?void 0:X.source}}};var G,J,Q;w.parameters={...w.parameters,docs:{...(G=w.parameters)==null?void 0:G.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ee=($=A.parameters)==null?void 0:$.docs)==null?void 0:ee.source}}};var te,ne,oe;C.parameters={...C.parameters,docs:{...(te=C.parameters)==null?void 0:te.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(oe=(ne=C.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var re,ie,ae;O.parameters={...O.parameters,docs:{...(re=O.parameters)==null?void 0:re.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ae=(ie=O.parameters)==null?void 0:ie.docs)==null?void 0:ae.source}}};const Be=["Default","ConfirmBeforeClose","StickyTitle","WarningType","ErrorType","TypeVariants","WindowControls","MinimizedState","MaximizedState","FullscreenState","MinimizedPlacement","SelectiveWindowActions"];export{h as ConfirmBeforeClose,m as Default,g as ErrorType,A as FullscreenState,w as MaximizedState,C as MinimizedPlacement,B as MinimizedState,O as SelectiveWindowActions,u as StickyTitle,x as TypeVariants,f as WarningType,y as WindowControls,Be as __namedExportsOrder,ye as default};
