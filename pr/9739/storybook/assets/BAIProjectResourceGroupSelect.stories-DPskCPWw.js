import{c as he,r as y,R as fe,j as a,ax as ye,ay as Se,az as je}from"./iframe-FibSO3TA.js";import{B as be}from"./BAISelect-DGe4P-xP.js";import{B as ve}from"./BAITextHighlighter-CXcpYNJ0.js";import{u as _}from"./useControllableValue-C1rctBEC.js";import{u as Pe}from"./reactQueryAlias-94LZdsSu.js";import{u as we}from"./useConnectedBAIClient-CiltvRUo.js";import{f as xe}from"./flatMap-4_2Ug2js.js";import{f as Ae}from"./filter-DDNI4jap.js";import{i as Ge}from"./includes-jS9LNTvi.js";import{s as Re}from"./some-C-vR8oe3.js";import{f as Ce}from"./find-DCbZIq9m.js";import{m as Be}from"./map-Djqx9Z4I.js";import"./preload-helper-Dp1pzeXC.js";import"./astryxLabel-bYzmUXP4.js";import"./isString-tD7kfhWj.js";import"./isEmpty-CHiyNWZS.js";import"./InputClearButton-DYj8hfYH.js";import"./useResolvedRequired-Dkgcgh9_.js";import"./useDevWarning-DGmeiAdA.js";import"./Selector-BrU-d1B3.js";import"./useFocusReturnVisibility-2efOsvlq.js";import"./SelectorOption-B7bFoy3L.js";import"./Item-BdCNQ6mG.js";import"./InputGroupContext-BabOS0fm.js";import"./usePopover-Jc8bfj2O.js";import"./rtlStyles-T4i24HtE.js";import"./useIndicator-Dmb7uVzv.js";import"./isRenderable-BUV0eL6r.js";import"./Divider-Cnfcqhm7.js";import"./Badge-C_p_AKPh.js";import"./CheckboxInput-3G9L2LHX.js";import"./toString-w2mwRjaZ.js";import"./isSymbol-BpBzWZpB.js";import"./_baseFlatten-DnlGOoWn.js";import"./_baseEach-iYpszmBO.js";import"./get-oNIfv-Sv.js";import"./_baseGet-CIQvN7UM.js";import"./identity-DKeuBCMA.js";import"./_baseIndexOf-Be9UPhX8.js";import"./_baseFindIndex-Cj99RmFE.js";import"./toInteger-DswT7juD.js";import"./toFinite-EOhe1gVF.js";import"./_trimmedEndIndex-DuQxD0U0.js";const Ie=({method:e,url:o,body:r=null,client:t})=>{const c=t==null?void 0:t.newSignedRequest(e,o,r,null);return t==null?void 0:t._wrapWithPromise(c)},_e=()=>{const e=we();return({method:o,url:r,body:t=null})=>Ie({method:o,url:r,body:t,client:e})};class Ee extends Error{constructor(o){super(o instanceof Error?o.message:"Failed to fetch storage host information."),this.name="StorageHostFetchError",this.originalError=o}}const Fe=(e,o)=>{"use memo";var v,B,I,f,p,b;const r=he.c(14),t=_e();let c;r[0]!==e?(c=["ResourceGroupSelectQuery",e],r[0]=e,r[1]=c):c=r[1];let l;r[2]!==t||r[3]!==e?(l=async()=>{if(!e)return null;const i=new URLSearchParams;i.set("group",e);const[n,d]=await Promise.allSettled([t({method:"GET",url:`/scaling-groups?${i.toString()}`}),t({method:"GET",url:"/folders/_/hosts"})]);if(d.status==="rejected")throw new Ee(d.reason);if(n.status==="rejected")throw n.reason;return[n.value,d.value]},r[2]=t,r[3]=e,r[4]=l):l=r[4];let h;r[5]!==c||r[6]!==l?(h={queryKey:c,queryFn:l,staleTime:3e5},r[5]=c,r[6]=l,r[7]=h):h=r[7];const{data:s}=Pe(h);let u;if(r[8]!==((v=s==null?void 0:s[0])==null?void 0:v.scaling_groups)||r[9]!==((B=s==null?void 0:s[1])==null?void 0:B.volume_info)||r[10]!==o){const i=xe((I=s==null?void 0:s[1])==null?void 0:I.volume_info,De);u=Ae(((f=s==null?void 0:s[0])==null?void 0:f.scaling_groups)??[],n=>Ge(i,n.name)?!1:o!=null&&o.filter?o.filter(n.name):!0),r[8]=(p=s==null?void 0:s[0])==null?void 0:p.scaling_groups,r[9]=(b=s==null?void 0:s[1])==null?void 0:b.volume_info,r[10]=o,r[11]=u}else u=r[11];const j=u;let m;return r[12]!==j?(m={resourceGroups:j},r[12]=j,r[13]=m):m=r[13],m};function De(e){return(e==null?void 0:e.sftp_scaling_groups)??[]}const g=({projectName:e,autoSelectDefault:o,filter:r,showSearch:t,loading:c,...l})=>{const[h,s]=_({value:typeof t=="object"?t==null?void 0:t.searchValue:void 0,onChange:typeof t=="object"?t==null?void 0:t.onSearch:void 0}),[u,j]=_(l),[m,v]=y.useTransition(),[B,I]=y.useState(),f=fe.useCallback((n,...d)=>{I(n),v(()=>{j(n,...d)})},[v,j]),{resourceGroups:p}=Fe(e,{filter:r});y.useEffect(()=>{u&&p.length>0&&!Re(p,n=>n.name===u)&&f(void 0)},[p,u,f]);const b=Ce(p,n=>n.name==="default")||p[0],i=b?{label:b.name,value:b.name}:void 0;return y.useEffect(()=>{o&&i&&!u&&f(i.value,i)},[o,i==null?void 0:i.value]),a.jsx(be,{defaultActiveFirstOption:!0,showSearch:t?{searchValue:h,onSearch:s}:void 0,defaultValue:o?i:void 0,loading:c||m,disabled:m,options:Be(p,n=>({value:n.name,label:n.name})),optionRender:n=>{var d;return a.jsx(ve,{keyword:h,children:(d=n.data.value)==null?void 0:d.toString()})},...l,value:m?B:u,onChange:f})},de=[{name:"default"},{name:"gpu-cluster"},{name:"cpu-only"},{name:"high-memory"}],Te=Array.from({length:15},(e,o)=>({name:`resource-group-${o+1}`})),ge={allowed:["host1","host2"],default:"host1",volume_info:{vol1:{backend:"xfs",capabilities:["quota","fast-lookup"],usage:{percentage:45.2},sftp_scaling_groups:["sftp-only"]}}},Ne=(e=de,o=ge)=>{const r={newSignedRequest:(t,c,l)=>({url:c}),_wrapWithPromise:t=>t.url.includes("/scaling-groups")?Promise.resolve({scaling_groups:e}):t.url.includes("/folders/_/hosts")?Promise.resolve(o):Promise.resolve({})};return Promise.resolve(r)},We=()=>({}),S=({children:e,scalingGroups:o=de,volumeInfo:r=ge})=>{const t=y.useMemo(()=>Ne(o,r),[o,r]),[c]=y.useState(()=>new ye({defaultOptions:{queries:{retry:!1,gcTime:0,staleTime:0}}}));return a.jsx(Se,{locale:{lang:"en"},clientPromise:t,anonymousClientFactory:We,children:a.jsx(je,{client:c,children:a.jsx(y.Suspense,{fallback:a.jsx("div",{children:"Loading..."}),children:e})})})},Rr={title:"Select/BAIProjectResourceGroupSelect",component:g,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
