...
export declare const availableDeploymentSorterValues: readonly ["name", "createdAt", "domain", "project", "resourceGroup", "tag", ...("-createdAt" | "-name" | "-domain" | "-tag" | "-project" | "-resourceGroup")[]];
