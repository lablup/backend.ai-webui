import{a as Q,r as d,j as e}from"./iframe-Dw3PD-Sj.js";import{B as m}from"./BAIFlex-9kQJ-mYR.js";import{N as X}from"./NumberInput-Cmbim58w.js";import{T as Y}from"./TextInput-DsXEN4hN.js";import"./preload-helper-Dp1pzeXC.js";import"./useResolvedRequired-BKsrKOuy.js";import"./useInputStatusIcon-uRcKeL2N.js";import"./InputGroupContext-C2PMp0qP.js";import"./InputClearButton-jWSwGP6B.js";import"./useDevWarning-DUd0Y5Hc.js";const n=({defaultValue:t,onCommit:o,type:r,placeholder:s,disabled:c,status:u,label:i,isLabelHidden:q,...K})=>{const{t:O}=Q(),[a,B]=d.useState(t??""),[$,J]=d.useState(t);$!==t&&(J(t),B(t??""));const I={...K,label:i??O("general.Select"),isLabelHidden:q??i===void 0,placeholder:s,isDisabled:c,status:u==="error"||u==="warning"?{type:u}:void 0},p=l=>o==null?void 0:o(l);if(r==="number"){const l=a===""?null:Number(a);return e.jsx(X,{...I,value:Number.isNaN(l)?null:l,onChange:E=>B(E===null?"":String(E)),onEnter:()=>p(a),onBlur:()=>p(a)})}return e.jsx(Y,{...I,type:r==="password"||r==="email"?r:"text",value:a,onChange:l=>B(l),onEnter:()=>p(a),onBlur:()=>p(a)})},le={title:"Input/BAIUncontrolledInput",component:n,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
