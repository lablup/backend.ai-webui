import{a as Q,r as d,j as e}from"./iframe-CUlnQibr.js";import{B as m}from"./BAIFlex-TamgOO5V.js";import{N as X}from"./NumberInput-B-cDU1iR.js";import{T as Y}from"./TextInput-DQ60cd3Y.js";import"./preload-helper-Dp1pzeXC.js";import"./useResolvedRequired-71J3I2Tp.js";import"./useInputStatusIcon-DUEV14PH.js";import"./InputGroupContext-CPga163l.js";import"./InputClearButton-DVOjlFic.js";import"./useDevWarning-HCQxMpWG.js";const n=({defaultValue:t,onCommit:o,type:r,placeholder:s,disabled:c,status:u,label:i,isLabelHidden:q,...K})=>{const{t:O}=Q(),[a,B]=d.useState(t??""),[$,J]=d.useState(t);$!==t&&(J(t),B(t??""));const I={...K,label:i??O("general.Select"),isLabelHidden:q??i===void 0,placeholder:s,isDisabled:c,status:u==="error"||u==="warning"?{type:u}:void 0},p=l=>o==null?void 0:o(l);if(r==="number"){const l=a===""?null:Number(a);return e.jsx(X,{...I,value:Number.isNaN(l)?null:l,onChange:E=>B(E===null?"":String(E)),onEnter:()=>p(a),onBlur:()=>p(a)})}return e.jsx(Y,{...I,type:r==="password"||r==="email"?r:"text",value:a,onChange:l=>B(l),onEnter:()=>p(a),onBlur:()=>p(a)})},le={title:"Input/BAIUncontrolledInput",component:n,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
