...
- `./DOCUMENTATION-STYLE-GUIDE.md` - Formatting and structure rules to enforce
- `./TERMINOLOGY.md` - Standardized terminology to verify against
- `./TRANSLATION-GUIDE.md` - Language-specific rules for translation review
- `./SCREENSHOT-GUIDELINES.md` - Image naming and placement standards
...
- **Update plan**: `./.agent-output/docs-update-plan-{topic}.md` (if available)
...
#### UI Labels and Text
- Cross-reference with i18n files for each language:
...
Verify all terminology against `./TERMINOLOGY.md`.
...
Save the review report to `./.agent-output/docs-review-report-{topic}.md`.
...
1. Ensure the output directory exists: `mkdir -p ./.agent-output/`
