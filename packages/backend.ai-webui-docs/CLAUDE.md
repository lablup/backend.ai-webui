...
1. **docs-update-planner** - Analyzes PR changes or feature descriptions to create a documentation update plan (`docs-update-plan.md`)
2. **docs-update-writer** - Writes documentation content across all 4 languages following the plan
3. **docs-update-reviewer** - Reviews for accuracy, consistency, style, and translation quality; auto-fixes issues
