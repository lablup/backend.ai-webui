...
メニューアイコンをタップすると、サイドバーと同じメニューを含むナビゲーションドロワーが画面の横からスライドして表示されます。ドロワーの上部には、Backend.AI ロゴが配置されたブランドカラーのヘッダーが表示されます。ドロワーは、ヘッダーの閉じるボタンをクリックするか、ドロワーの外側をクリックすると閉じます。メニュー項目を選択してページを移動した場合も自動的に閉じます。
