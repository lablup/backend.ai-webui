...
セッションリストには、各セッションが作成されたときに使用されたキーペアのアクセスキーを
表示する **アクセスキー** カラムも用意されています。このカラムはデフォルトで非表示に
なっており、テーブル右下の歯車ボタンから開く **テーブル設定** ダイアログで表示できます。
自分のセッションが現在ログインしているアクセスキーとは異なるキーペアで作成された場合は、
アクセスキーの横に警告アイコンが表示され、「デフォルトのアクセスキーとは異なるキーで
作成されたセッションです。」というツールチップを確認できます。
...
セッション詳細パネルには、そのセッションが作成されたときに使用されたキーペアの
アクセスキーが **アクセスキー** 項目として表示されます。値の横にあるコピーボタンを
クリックすると、アクセスキーをコピーできます。セッションリストと同様に、自分の
セッションが現在ログインしているアクセスキーとは異なるキーペアで作成された場合は、
「デフォルトのアクセスキーとは異なるキーで作成されたセッションです。」という
ツールチップ付きの警告アイコンが表示されます。
...
- **ステータス**: アクションの結果（`SUCCESS`、`ERROR`、`RUNNING`、または`UNKNOWN`）
- **時刻**: アクションが発生した日時
