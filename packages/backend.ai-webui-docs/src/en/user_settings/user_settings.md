...
lists 20 languages: English, Korean, Brazilian Portuguese, Simplified Chinese,
Traditional Chinese, French, Finnish, German, Greek, Indonesian, Italian,
Japanese, Mongolian, Polish, Portuguese, Russian, Spanish, Thai, Turkish, and
Vietnamese. You can type in the dropdown to filter and quickly find a language.
