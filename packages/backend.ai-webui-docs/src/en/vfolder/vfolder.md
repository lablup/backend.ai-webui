...
Items in the same upload whose names are not already taken are uploaded regardless of the selection, and the dialog reports how many of them there are below the table.
