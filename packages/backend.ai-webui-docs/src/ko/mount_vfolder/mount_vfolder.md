...
Backend.AI에서는 연산 세션을 종료해도 폴더 안의 파일을 보존할 수 있는 옵션을 제공합니다.
...
이제 연산 세션을 종료하고 스토리지 페이지로 이동합니다.
...
따라서 `.linuxbrew`라는 자동 마운트 폴더를 생성해 두면, 연산 세션을 종료하고 새로운 연산 세션을 생성하더라도 이전에 설치한 Homebrew 패키지를 다시 사용할 수 있습니다.
