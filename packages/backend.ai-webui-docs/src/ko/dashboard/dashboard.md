...
**대시보드** 페이지는 모든 프로젝트와 자원 그룹의 자원 사용량, 한도, 실행 중인 세션 정보를 한눈에 확인할 수 있는 종합 현황 화면입니다. 사용 중인 자원의 분포를 직관적으로 파악하고 시스템 활동 상태를 실시간으로 모니터링할 수 있습니다.
...
- **나의 총자원 사용량:**
    모든 프로젝트에서 현재 사용 중인 자원량을 합산하여 표시합니다. 각 자원의 수치 아래에는 사용량 막대가 함께 표시되며, 막대에 마우스 커서를 올리면 총자원 제한 대비 사용량을 확인할 수 있습니다. 도메인, 프로젝트, 키페어 등 여러 제한이 동시에 적용될 경우 **가장 엄격한 제한**이 적용됩니다.
