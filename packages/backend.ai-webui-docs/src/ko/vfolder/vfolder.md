...
- **사용 방식**: 폴더의 용도를 설정합니다.
   ...
   * 모델: 배포 및 관리에 특화된 폴더입니다. 이 모드를 선택하면 폴더 복제 가능 여부를 설정할 수 있습니다.
...
**만들기** 버튼으로 현재 경로에 새로운 디렉토리를 생성할 수 있으며, **업로드** 버튼으로 현재 경로에 로컬 파일 혹은 폴더를 업로드할 수도 있습니다. 이러한 파일 작업은 앞서 설명한 연산 세션 마운트 방식으로도 모두 수행 가능합니다.
