...
`슈퍼관리자` 계정으로 세션을 생성하는 경우, 세션 소유자를 추가로 지정할 수 있습니다. 토글을 활성화하면 사용자 이메일 필드가 나타납니다.
...
:::note
감사 로그는 백엔드에 의해 적용되며, 슈퍼관리자에게만 표시될 수 있습니다. 일반 사용자는 탭에 접근할 수 있더라도 결과가 비어 있을 수 있습니다.
:::
