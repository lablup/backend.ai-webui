...
- **상태 전환 (이전 / 이후)**: 해당 스케줄링 단계 전후의 세션 상태
...
확장 컬럼 헤더의 케밥 메뉴(⋮)를 사용하면 테이블 전체의 행 펼치기 방식을 제어할 수 있습니다. 다음 세 가지 보기 모드를 사용할 수 있습니다:

- **모두 펼치기**: 모든 행을 펼쳐 세부 단계를 즉시 확인할 수 있습니다.
- **모두 접기**: 모든 행을 접어 최상위 기록만 표시합니다.
