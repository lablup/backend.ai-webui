...
세션 목록에는 각 세션이 생성될 때 사용된 키페어의 액세스 키를 보여주는 **액세스 키**
컬럼도 제공됩니다. 이 컬럼은 기본적으로 숨겨져 있으며, 테이블 오른쪽 하단의 톱니바퀴
버튼을 클릭해 열리는 **표 설정** 대화창에서 표시할 수 있습니다. 본인의 세션이 현재
로그인에 사용 중인 액세스 키가 아닌 다른 키페어로 생성된 경우, 액세스 키 옆에 경고
아이콘이 표시되며 "기본 액세스 키가 아닌 다른 키로 생성된 세션입니다." 툴팁을 확인할 수
있습니다.
...
세션 상세 정보 패널에는 해당 세션이 생성될 때 사용된 키페어의 액세스 키가 **액세스 키** 항목으로 표시됩니다. 값 옆의 복사 버튼을 클릭하면 액세스 키를 복사할 수 있습니다. 세션 목록에서와 마찬가지로, 본인의 세션이 현재 로그인에 사용 중인 액세스 키가 아닌 다른 키페어로 생성된 경우 "기본 액세스 키가 아닌 다른 키로 생성된 세션입니다." 툴팁이 있는 경고 아이콘이 함께 표시됩니다.
