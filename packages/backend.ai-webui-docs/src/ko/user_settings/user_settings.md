...
UI에 출력되는 언어를 설정합니다. 언어 선택기는 검색 가능한 드롭다운으로, 영어,
한국어, 브라질 포르투갈어, 중국어 간체, 중국어 번체, 프랑스어, 핀란드어, 독일어,
그리스어, 인도네시아어, 이탈리아어, 일본어, 몽골어, 폴란드어, 포르투갈어,
러시아어, 스페인어, 태국어, 터키어, 베트남어 등 20개 언어를 지원합니다.
