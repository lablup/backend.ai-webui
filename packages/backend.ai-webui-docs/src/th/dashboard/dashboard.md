...
แดชบอร์ดจะรีเฟรชข้อมูลทุกแผงอัตโนมัติทุก **15 วินาที** เพื่อให้ข้อมูลที่แสดงเป็นปัจจุบันอยู่เสมอโดยไม่ต้องดำเนินการด้วยตนเอง แผงที่มีปุ่มรีเฟรชอยู่ในส่วนหัวสามารถรีเฟรชแยกเป็นรายแผงได้ทุกเมื่อ — ดูการทำงานของปุ่มรีเฟรชที่ใช้ร่วมกันได้ที่ [รีเฟรชอัตโนมัติ](#common-auto-refresh)
