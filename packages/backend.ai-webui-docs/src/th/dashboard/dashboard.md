...
บอร์ดยังคงแสดงอยู่บนหน้าจอขณะที่การรีเฟรชกำลังทำงาน ค่าที่คุณกำลังดูอยู่จะยังคงปรากฏ และคุณสามารถย้าย ปรับขนาด และเลื่อนแผงต่อไปได้ในระหว่างที่ระบบดึงข้อมูลใหม่ แต่ละแผงจะรายงานความคืบหน้าของตนเองแยกกัน

- ปุ่มรีเฟรชในส่วนหัวของแผงจะแสดงสัญลักษณ์กำลังโหลดขณะที่ระบบกำลังดึงข้อมูลของแผงนั้น
- หากแผงจำเป็นต้องสร้างเนื้อหาขึ้นใหม่ ระบบจะแสดงโครงร่างการโหลด (skeleton) เฉพาะภายในพื้นที่ของแผงนั้น ส่วนที่เหลือของบอร์ดยังคงแสดงและใช้งานได้ตามปกติ

คุณยังสามารถรีเฟรชแผงใดแผงหนึ่งได้ตลอดเวลาโดยคลิกปุ่มรีเฟรชในส่วนหัวของแผงนั้น โดยไม่ต้องรอการรีเฟรชอัตโนมัติรอบถัดไป

:::note
[แดชบอร์ดของผู้ดูแลระบบระดับสูง](#superadmin-dashboard) ใช้รอบการรีเฟรชทุก **30 วินาที** แทน
:::
