...
- **การใช้ทรัพยากรทั้งหมดของฉัน:**
    แสดงทรัพยากรที่คุณกำลังใช้อยู่โดยรวมยอดจากทุกโปรเจกต์ ใต้ตัวเลขของทรัพยากรแต่ละรายการจะมีแถบแสดงการใช้งาน เมื่อวางเมาส์เหนือแถบดังกล่าวจะเห็นสัดส่วนการใช้งานเทียบกับขีดจำกัดทรัพยากรทั้งหมดของคุณ เมื่อมีขีดจำกัดหลายรายการ (โดเมน โปรเจกต์ หรือคีย์แพร์) ระบบจะใช้ขีดจำกัด**ที่เข้มงวดที่สุด**
