...
:::note
ดีพลอยเมนต์สำหรับผู้ดูแลระบบแต่ละรายการมีเส้นทางเฉพาะของตัวเองที่ `/admin-deployments/:id` แล้ว เมื่อคุณเปิดดีพลอยเมนต์จากหน้า Admin Serving URL จะเปลี่ยนเป็นเส้นทางนี้ จึงสามารถเชื่อมโยงไปยังหน้ารายละเอียดดีพลอยเมนต์โดยตรงหรือบันทึกเป็นบุ๊กมาร์กได้
:::
...
พรีเซตเหล่านี้จัดการได้จากแท็บ **Prometheus Preset** บนหน้า Admin Serving (`/admin-deployments?tab=prometheus-preset`)

![](../images/admin_prometheus_preset_list.png)
<!-- TODO: จับภาพหน้าจอรายการพรีเซตคำสั่ง Prometheus -->

:::note
แท็บนี้ **สำหรับผู้ดูแลระบบเท่านั้น** และจะปรากฏก็ต่อเมื่อ Backend.AI Manager รองรับความสามารถ `prometheus-query-preset` หากแท็บไม่ปรากฏในระบบของคุณ แสดงว่ารุ่น Manager ของคุณยังไม่รองรับฟีเจอร์นี้
:::
...
<!-- TODO: จับภาพหน้าจอโมดอลสร้างพรีเซตพร้อมพื้นที่ตัวอย่างแบบสด -->
...
<!-- TODO: จับภาพหน้าจอโมดอลแก้ไขพรีเซตที่ตัวอย่างแบบสดสะท้อนเทมเพลตปัจจุบัน -->
