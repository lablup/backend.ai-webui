...
กล่องโต้ตอบนี้จะแสดงข้อความแจ้งว่าโฟลเดอร์ที่สร้างในหน้านี้จะเป็นโฟลเดอร์โปรเจกต์
...
คลิก ID ของเอเจนต์เพื่อเปิดแผง **ข้อมูลเอเจนต์** ซึ่งแสดงการใช้ทรัพยากรที่แน่นอนของโหนดนั้น แผงนี้มีสองแท็บ ได้แก่ แท็บ **ทรัพยากร** ที่แสดงการใช้งานแยกตามสล็อตทรัพยากร และแท็บ **เซสชัน** ที่แสดงรายการเซสชันการคำนวณซึ่งถูกกำหนดให้กับเอเจนต์นี้ ทำให้คุณเห็นว่ามีอะไรกำลังทำงานอยู่บนโหนดก่อนที่จะหยุดหรือรีสตาร์ทเอเจนต์ ในแท็บ **เซสชัน** ให้ใช้ตัวเลือก **กำลังทำงาน** / **เสร็จสิ้น** เพื่อสลับระหว่างเซสชันที่ยังใช้ทรัพยากรของโหนดอยู่กับเซสชันที่เสร็จสิ้นแล้ว และคลิกชื่อเซสชันเพื่อเปิดรายละเอียดของเซสชันนั้น
