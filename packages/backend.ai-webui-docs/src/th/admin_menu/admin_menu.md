...
ปุ่มรีเฟรชที่มุมบนขวาของรายการการปรับใช้มีดรอปดาวน์เลือกช่วงเวลารีเฟรชอัตโนมัติที่ใช้ร่วมกัน (ดูที่ [รีเฟรชอัตโนมัติ](#common-auto-refresh)) โดยรายการนี้เริ่มต้นที่ช่วงเวลา 15 วินาที
...
เนื่องจากคำสั่ง Prometheus อาจมีต้นทุนในการประมวลผลสูง ปุ่มรีเฟรชในแท็บนี้จึงให้ช่วงเวลารีเฟรชอัตโนมัติที่ยาวกว่ารายการอื่นของผู้ดูแลระบบ ได้แก่ 30 วินาที 1 นาที 5 นาที และ 10 นาที และรีเฟรชอัตโนมัติจะเริ่มต้นเป็น **ปิด** (ดูที่ [รีเฟรชอัตโนมัติ](#common-auto-refresh))
...
ทั้งสองแท็บจะรีเฟรชเอง โดยแท็บ **เซสชัน** เริ่มต้นที่ช่วงเวลา 15 วินาที และแท็บ **เซสชันที่รอดำเนินการ**
ที่ 10 วินาที แต่ละแท็บจะจดจำตัวเลือกของตนเองแยกกัน (ดูที่ [รีเฟรชอัตโนมัติ](#common-auto-refresh))
...
- **รีเฟรชอัตโนมัติ**: เนื่องจากคำสั่ง Fair Share มีต้นทุนสูง ปุ่มรีเฟรชจึงให้ช่วงเวลาที่ยาวกว่าที่อื่น ได้แก่ 30 วินาที 1 นาที 5 นาที และ 10 นาที และรีเฟรชอัตโนมัติจะเริ่มต้นเป็น **ปิด** (ดูที่ [รีเฟรชอัตโนมัติ](#common-auto-refresh))
...
คุณสามารถจำกัดรายการด้วยตัวกรองคุณสมบัติ ซึ่งรองรับ **ID**, **จุดเชื่อมต่อ** และ **จัดตารางได้** รายการเริ่มต้นที่ช่วงเวลารีเฟรชอัตโนมัติ 15 วินาที และเนื่องจากการสอบถามเอเจนต์ทั้งคลัสเตอร์มีต้นทุนสูง ช่วงเวลาที่สั้นที่สุดที่ให้เลือกที่นี่ก็คือ 15 วินาทีเช่นกัน (ดูที่ [รีเฟรชอัตโนมัติ](#common-auto-refresh))
...
ปุ่มรีเฟรชเหนือรายการมีดรอปดาวน์เลือกช่วงเวลารีเฟรชอัตโนมัติที่ใช้ร่วมกัน (ดูที่ [รีเฟรชอัตโนมัติ](#common-auto-refresh)) ในแท็บนี้ รีเฟรชอัตโนมัติจะเป็น **ปิด** จนกว่าคุณจะเลือกช่วงเวลา
