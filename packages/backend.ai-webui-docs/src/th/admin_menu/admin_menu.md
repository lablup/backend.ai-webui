...
หน้าผู้ใช้เก็บสถานะของตาราง (ตัวกรอง การเรียงลำดับ หน้า และแท็บสถานะ) ไว้ใน URL ของหน้า และจดจำแยกกันในแต่ละแท็บ การสลับไปมาระหว่างแท็บ **ผู้ใช้** และ **ข้อมูลประจำตัว** แล้วกลับมาจะคืนค่ามุมมองเดิม และคุณสามารถบุ๊กมาร์กหรือแชร์ URL เพื่อเปิดรายการเดิมได้อีกครั้ง
...
แต่ละแท็บเก็บสถานะของตาราง (ตัวกรอง การเรียงลำดับ และหน้า) ไว้ใน URL ของหน้าแยกกัน การย้ายไปแท็บอื่นแล้วกลับมาจะคืนค่ามุมมองเดิม และ URL ที่คุณคัดลอกจะเปิดมุมมองเดียวกันนั้นได้อีกครั้ง

ปุ่มรีเฟรชที่มุมบนขวาของรายการการปรับใช้มีดรอปดาวน์เลือกช่วงเวลารีเฟรชอัตโนมัติ รายการจะโหลดใหม่ทุก 15 วินาที จนกว่าคุณจะเลือกช่วงเวลาอื่นหรือ **ปิด** จากดรอปดาวน์ ขณะที่รีเฟรชอัตโนมัติทำงานอยู่ เส้นขอบนับถอยหลังจะค่อย ๆ เต็มรอบปุ่มเพื่อบอกว่าจะโหลดใหม่เมื่อใด ตัวเลือกของคุณจะถูกจดจำไว้สำหรับรายการนี้ในเบราว์เซอร์นี้
...
เนื่องจากคำสั่ง Prometheus อาจมีต้นทุนในการประมวลผลสูง ปุ่มรีเฟรชในแท็บนี้จึงให้ช่วงเวลารีเฟรชอัตโนมัติที่ยาวกว่ารายการอื่นของผู้ดูแลระบบ ได้แก่ 30 วินาที 1 นาที 5 นาที และ 10 นาที รีเฟรชอัตโนมัติจะเป็น **ปิด** จนกว่าคุณจะเลือกช่วงเวลาใดช่วงเวลาหนึ่ง และตัวเลือกของคุณจะถูกจดจำไว้สำหรับแท็บนี้ในเบราว์เซอร์นี้
...
แต่ละแท็บในสามแท็บเก็บสถานะของตาราง (ตัวกรอง การเรียงลำดับ และหน้า) ไว้ใน URL ของหน้าแยกกัน การย้ายไปแท็บอื่นแล้วกลับมาจะคืนค่ามุมมองเดิม และ URL ที่คุณคัดลอกจะเปิดมุมมองเดียวกันนั้นได้อีกครั้ง
...
- Max Concurrent Logins: จำนวนเซสชันสูงสุดที่ผู้ใช้สามารถเข้าสู่ระบบพร้อมกันได้
  หากตั้งค่าเป็น Unlimited จะไม่มีการจำกัด และรายการจะแสดงเป็น "∞"
...
แต่ละแท็บเก็บสถานะของตาราง (ตัวกรอง การเรียงลำดับ และหน้า) ไว้ใน URL ของหน้าแยกกัน การสลับแท็บแล้วกลับมาจึงคืนค่ามุมมองเดิม
...
ทั้งสองแท็บจะรีเฟรชเอง โดยแท็บ **เซสชัน** ทุก 15 วินาที และแท็บ **เซสชันที่รอดำเนินการ** ทุก 10 วินาที
ใช้ดรอปดาวน์ช่วงเวลาถัดจากปุ่มรีเฟรชเพื่อเลือกจังหวะอื่น หรือ **ปิด** เพื่อหยุดการโหลดใหม่อัตโนมัติ ขณะที่รีเฟรช
อัตโนมัติทำงานอยู่ เส้นขอบนับถอยหลังจะค่อย ๆ เต็มรอบปุ่มเพื่อบอกว่าจะโหลดใหม่เมื่อใด แต่ละแท็บจะจดจำตัวเลือกของตนเอง
...
- **รีเฟรชอัตโนมัติ**: ปุ่มรีเฟรชมีดรอปดาวน์เลือกช่วงเวลา เนื่องจากคำสั่ง Fair Share มีต้นทุนสูง ช่วงเวลาที่ให้เลือกจึงยาวกว่าที่อื่น ได้แก่ 30 วินาที 1 นาที 5 นาที และ 10 นาที และรีเฟรชอัตโนมัติจะเป็น **ปิด** จนกว่าคุณจะเลือกช่วงเวลาใดช่วงเวลาหนึ่ง ขณะที่ทำงานอยู่ เส้นขอบนับถอยหลังจะค่อย ๆ เต็มรอบปุ่มเพื่อบอกว่าจะโหลดใหม่เมื่อใด และตัวเลือกของคุณจะถูกจดจำไว้ในเบราว์เซอร์นี้ ปุ่มนี้ยังใช้เป็นการรีเฟรชด้วยตนเองได้ตลอดเวลา
...
คุณสามารถเลือกอิมเมจที่ยังไม่ได้ติดตั้งหลายรายการ แล้วคลิกปุ่ม **ติดตั้งอิมเมจ** เพื่อติดตั้งบนโหนดเอเจนต์ที่มีอยู่พร้อมกัน ปุ่มในไดอะล็อกยืนยันคือ **ติดตั้ง**
...
คุณสามารถจำกัดรายการด้วยตัวกรองคุณสมบัติ ซึ่งรองรับ **ID**, **จุดเชื่อมต่อ** และ **จัดตารางได้** รายการจะโหลดใหม่ทุก 15 วินาที ใช้ดรอปดาวน์ช่วงเวลาถัดจากปุ่มรีเฟรชเพื่อเลือก 30 วินาที 1 นาที หรือ 5 นาทีแทน หรือ **ปิด** เพื่อหยุดการโหลดใหม่อัตโนมัติ เนื่องจากการสอบถามเอเจนต์ทั้งคลัสเตอร์มีต้นทุนสูง ช่วงเวลาที่สั้นที่สุดที่ให้เลือกที่นี่คือ 15 วินาที
...
ปุ่มรีเฟรชเหนือรายการมีดรอปดาวน์เลือกช่วงเวลารีเฟรชอัตโนมัติ รีเฟรชอัตโนมัติจะเป็น **ปิด** จนกว่าคุณจะเลือกช่วงเวลา ขณะที่ทำงานอยู่ เส้นขอบนับถอยหลังจะค่อย ๆ เต็มรอบปุ่มเพื่อบอกว่าจะโหลดใหม่เมื่อใด และตัวเลือกของคุณจะถูกจดจำไว้สำหรับแท็บนี้ในเบราว์เซอร์นี้
...
- **ประกาศระบบ**: คลิก **แก้ไขประกาศ** เพื่อสร้างหรือเปลี่ยนแบนเนอร์ประกาศที่แสดงต่อผู้ใช้ทุกคนที่ด้านบนของหน้า
...
Superadmin สามารถเผยแพร่ข้อความสั้น ๆ ที่ผู้ใช้ทุกคนจะเห็นเป็นแบนเนอร์ที่ด้านบนของหน้า เช่น การแจ้งช่วงเวลาบำรุงรักษาที่วางแผนไว้ ประกาศเขียนด้วย Markdown และจัดการได้ทั้งหมดจาก WebUI ไม่ว่าจะเคยเผยแพร่ประกาศมาก่อนหรือไม่ก็ตาม
...
หน้าโปรเจกต์มีให้เฉพาะ Superadmin เท่านั้น โดยจะแสดงรายการโปรเจกต์ทั้งหมดในคลัสเตอร์ และให้ Superadmin สร้าง แก้ไข ปิดการใช้งาน เปิดใช้งาน และลบโปรเจกต์อย่างถาวรได้ แต่ละแถวยังมีทางลัดสำหรับการให้สิทธิ์ผู้ดูแลโปรเจกต์ด้วย
