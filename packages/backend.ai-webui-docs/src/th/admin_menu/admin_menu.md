...
:::note[ข้อกำหนดเวอร์ชัน]
การตรวจสอบความถูกต้องของพารามิเตอร์ runtime ที่จำเป็น (เครื่องหมายดอกจันสีแดงและการบล็อกการส่ง) และ toggle **เปิดใช้การตรวจสอบสุขภาพ (Enable Health Check)** กำหนดให้ใช้ Backend.AI Manager เวอร์ชัน 26.4.4 ขึ้นไป
:::
