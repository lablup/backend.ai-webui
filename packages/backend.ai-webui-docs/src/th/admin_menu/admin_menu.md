...
กล่องโต้ตอบนี้ไม่มีตัวเลือกประเภทโฟลเดอร์ และจะมีข้อความแจ้งว่าโฟลเดอร์ที่สร้างในหน้านี้
จะเป็นโฟลเดอร์โปรเจกต์ ให้เลือกโปรเจกต์ที่จะเป็นเจ้าของโฟลเดอร์ในช่อง **โครงการปลายทาง**
ที่ด้านบนของกล่องโต้ตอบ จากนั้นป้อนชื่อโฟลเดอร์และตั้งค่า **การอนุญาตเมานต์** เป็น 'อ่านเท่านั้น'
...
- **รหัสเซสชัน**: จำกัดรายการให้เหลือเซสชันเดียวด้วยรหัสของเซสชัน ค่าที่ป้อนต้องตรงกับ UUID ของเซสชันทุกตัวอักษร จึงเหมาะกับกรณีที่คุณมีรหัสจากบันทึกล็อกหรือคำขอความช่วยเหลือ แล้วต้องการค้นหาเซสชันที่เกี่ยวข้อง

รายการเซสชันในหน้านี้ยังแสดงคอลัมน์ **รหัสเซสชัน** เป็นค่าเริ่มต้นด้วย หากไม่ต้องการใช้ คุณสามารถซ่อนคอลัมน์นี้ได้จากการตั้งค่าคอลัมน์ของตาราง
...
คลิก ID ของเอเจนต์เพื่อเปิดแผง **ข้อมูลเอเจนต์** ซึ่งแสดงการใช้ทรัพยากรที่แน่นอนของโหนดนั้น แผงนี้มีสองแท็บ ได้แก่ แท็บ **ทรัพยากร** ที่แสดงการใช้งานแยกตามสล็อตทรัพยากร และแท็บ **เซสชัน** ที่แสดงรายการเซสชันการคำนวณซึ่งถูกกำหนดให้กับเอเจนต์นี้ ทำให้คุณเห็นว่ามีอะไรกำลังทำงานอยู่บนโหนดก่อนที่จะหยุดหรือรีสตาร์ทเอเจนต์ ในแท็บ **เซสชัน** ให้ใช้ตัวเลือก **กำลังทำงาน** / **เสร็จสิ้น** เพื่อสลับระหว่างเซสชันที่ยังใช้ทรัพยากรของโหนดอยู่กับเซสชันที่เสร็จสิ้นแล้ว และคลิกชื่อเซสชันเพื่อเปิดรายละเอียดของเซสชันนั้นได้โดยไม่ต้องออกจากหน้าเอเจนต์
