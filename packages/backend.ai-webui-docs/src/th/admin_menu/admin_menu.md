...
- **ชื่อเมตริก**: เมตริกที่พรีเซตนี้รายงาน (ใช้เป็นป้ายแสดงผลโดยผู้บริโภค เช่น กฎการปรับขนาดอัตโนมัติ)
...
- **ชื่อเมตริก**: ป้ายเมตริกที่ผู้บริโภค (เช่น กฎการปรับขนาดอัตโนมัติ) จะแสดง
...
คลิก **บันทึก** เพื่อใช้การเปลี่ยนแปลงของคุณ ผู้บริโภคของพรีเซต (เช่น กฎการปรับขนาดอัตโนมัติ ที่อ้างอิงพรีเซต) จะรับเทมเพลตคำสั่งใหม่โดยอัตโนมัติในครั้งถัดไปที่ประเมินเมตริก
...
:::danger
การลบพรีเซตคำสั่ง Prometheus เป็นการกระทำ **ถาวรและไม่สามารถยกเลิกได้** กฎการปรับขนาดอัตโนมัติ และฟีเจอร์อื่น ๆ ที่อ้างอิงพรีเซตที่ลบจะสูญเสียเทมเพลตคำสั่งและอาจหยุดทำงานจนกว่าจะถูกกำหนดค่าใหม่ให้ชี้ไปยังพรีเซตอื่น
:::
...
คลิก ID ของเอเจนต์เพื่อเปิดแผง **ข้อมูลเอเจนต์** ซึ่งแสดงการใช้ทรัพยากรที่แน่นอนของโหนดนั้น
