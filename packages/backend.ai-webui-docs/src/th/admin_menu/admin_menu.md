...
- **ขีดจำกัดอัตรา (ต่อ 15 นาที)**: จำนวนคำขอสูงสุดที่สามารถส่งไปยังเซิร์ฟเวอร์
  ...
  ตามรูปแบบของผู้ใช้
   ...
   `ขีดจำกัดอัตราต้องมากกว่าศูนย์และน้อยกว่า 50000` และบล็อกการส่ง ดังนั้นค่าที่คุณพิมพ์จะไม่ถูกลดลงเงียบ ๆ
...
หน้าโปรเจกต์แสดงรายการโปรเจกต์ทั้งหมดในคลัสเตอร์ และให้ผู้ดูแลระบบสร้าง แก้ไข ปิดการใช้งาน เปิดใช้งาน และลบโปรเจกต์อย่างถาวรได้ แต่ละแถวยังมีทางลัดสำหรับการให้สิทธิ์ผู้ดูแลโปรเจกต์ด้วย
