...
- **การปรับใช้**: แสดงรายการการปรับใช้ข้ามทุกโปรเจกต์ พร้อมตัวกรองวงจรชีวิตและคุณสมบัติเดียวกับหน้าการปรับใช้สำหรับผู้ใช้ มุมมองข้ามโปรเจกต์นี้ยังมีคุณสมบัติตัวกรอง **โปรเจกต์** เพิ่มเติม ซึ่งคุณเลือกจากดรอปดาวน์โปรเจกต์ที่ค้นหาได้ แทนที่จะพิมพ์รหัสโปรเจกต์เอง
...
- **โปรเจกต์ (Project)**: กรองตามโปรเจกต์ที่เป็นเจ้าของ แทนที่จะพิมพ์ตัวระบุโปรเจกต์เอง ให้เลือกโปรเจกต์จากดรอปดาวน์ที่ค้นหาได้ซึ่งแสดงรายการโปรเจกต์ Model Store โดยแท็กตัวกรองจะแสดงชื่อโปรเจกต์
...
คุณสามารถค้นหาและจำกัดรายการได้ด้วยตัวกรองคุณสมบัติด้านบนของตาราง และคลิกหัวคอลัมน์ใด ๆ เพื่อเปลี่ยนลำดับการเรียง คุณสมบัติ **หมวดหมู่** จะเลือกจากดรอปดาวน์ของหมวดหมู่ที่กำหนดไว้ในคลัสเตอร์นี้ แทนที่จะพิมพ์รหัสหมวดหมู่เอง และแท็กตัวกรองจะแสดงชื่อหมวดหมู่
