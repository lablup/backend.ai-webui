...
ในหน้าผู้ใช้ ให้สลับไปที่แท็บ **ไม่ทำงาน** โดยใช้ตัวเลือกสถานะ **คล่องแคล่ว** /
**ไม่ทำงาน** ที่อยู่เหนือรายการ คุณสามารถลบผู้ใช้อย่างถาวรได้สองวิธี:
...
- **ต้องการลบโฟลเดอร์เสมือนที่แชร์ด้วยหรือไม่?**: กำหนดว่าจะจัดการอย่างไรกับโฟลเดอร์เสมือน
  ของผู้ใช้ที่ถูกลบถาวรซึ่งถูกแชร์กับผู้ใช้อื่น เมื่อเลือก โฟลเดอร์เหล่านั้นจะถูกโอน
  ความเป็นเจ้าของไปยังผู้ดูแลระบบที่ทำการลบถาวรและจะยังคงอยู่ (หากชื่อซ้ำกับโฟลเดอร์เดิม
  ของผู้ดูแลระบบ จะมีการเติมส่วนต่อท้ายแบบสุ่ม) เมื่อไม่เลือก โฟลเดอร์เหล่านั้นจะถูกลบ
  พร้อมกับโฟลเดอร์เสมือนอื่นของผู้ใช้
- **ต้องการลบ deployment ที่สร้างไว้ด้วยหรือไม่?**: เมื่อเลือก deployment ที่ผู้ใช้
  ...
  แต่จะมอบหมายความเป็นเจ้าของให้ผู้ดูแลระบบที่ทำการลบถาวรแทน

:::warning
ป้ายกำกับของตัวเลือกแรกอ่านเหมือนว่าการเลือกจะลบโฟลเดอร์ที่แชร์ แต่ผลลัพธ์จริงตรงกันข้าม:
**การเลือกจะเก็บโฟลเดอร์เหล่านั้นไว้** ภายใต้ความเป็นเจ้าของของผู้ดูแลระบบ
ส่วนการไม่เลือกจะลบโฟลเดอร์พร้อมกับข้อมูลอื่นของผู้ใช้
:::
...
- **โปรเจกต์ (Project)**: กรองตาม UUID ของโปรเจกต์ที่เป็นเจ้าของ ค่าจะถูกตรวจสอบก่อนนำตัวกรองไปใช้ ดังนั้นตัวระบุที่มีรูปแบบไม่ถูกต้องจะถูกปฏิเสธพร้อมข้อความแทนที่จะคืนรายการว่าง
...
ในแท็บ **เซสชัน** ตัวกรองคุณสมบัติมีเงื่อนไขต่อไปนี้:

- **โปรเจกต์**: เลือกโปรเจกต์จากดรอปดาวน์ที่ค้นหาได้ซึ่งแสดงโปรเจกต์ในคลัสเตอร์นี้ เนื่องจากเลือกโปรเจกต์จากรายการ
  คุณจึงไม่ต้องค้นหาตัวระบุของโปรเจกต์ และแท็กตัวกรองที่ได้จะแสดงชื่อโปรเจกต์
- **ชื่อเซสชัน**, **กลุ่มทรัพยากร**, **เอเจนต์**, **อีเมลของเจ้าของ**: จำกัดรายการด้วยการจับคู่ข้อความ
...
คลิก ID ของเอเจนต์เพื่อเปิดแผง **ข้อมูลเอเจนต์** ซึ่งแสดงการใช้ทรัพยากรที่แน่นอนของโหนดนั้น แผงนี้มีสองแท็บ ได้แก่ แท็บ **ทรัพยากร** ที่แสดงการใช้งานแยกตามสล็อตทรัพยากร และแท็บ **เซสชัน** ที่แสดงรายการเซสชันการคำนวณซึ่งถูกกำหนดให้กับเอเจนต์นี้ ทำให้คุณเห็นว่ามีอะไรกำลังทำงานอยู่บนโหนดก่อนที่จะหยุดหรือรีสตาร์ทเอเจนต์ ในแท็บ **เซสชัน** ให้ใช้ตัวเลือก **กำลังทำงาน** / **เสร็จสิ้น** เพื่อสลับระหว่างเซสชันที่ยังใช้ทรัพยากรของโหนดอยู่กับเซสชันที่เสร็จสิ้นแล้ว และคลิกชื่อเซสชันเพื่อเปิดรายละเอียดของเซสชันนั้นในหน้าเซสชันสำหรับผู้ดูแลระบบ
