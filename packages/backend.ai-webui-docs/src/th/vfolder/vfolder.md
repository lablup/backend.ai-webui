...
ปุ่ม **ลบ** **เปลี่ยนชื่อ** และ **สร้างโฟลเดอร์** จะถูกปิดใช้งานเมื่อสิทธิ์ของคุณต่อโฟลเดอร์นี้ไม่รวมสิทธิ์การเขียนหรือการลบ เช่น โฟลเดอร์ที่แชร์ให้คุณแบบ **อ่านเท่านั้น** ในกรณีนี้คุณยังคงเรียกดูโฟลเดอร์และดาวน์โหลดเนื้อหาภายในได้
...
รายละเอียดของโฟลเดอร์ ส่วนสิทธิ์การเขียนบนตัวโฟลเดอร์เองนั้นมาจากการเป็นเจ้าของโฟลเดอร์
หรือจากสิทธิ์ที่คุณได้รับตอนที่โฟลเดอร์ถูกแชร์ให้คุณ
:::
