...
คุณสามารถสร้างไดเรกทอรีใหม่ในพาธปัจจุบันได้ด้วยปุ่ม **สร้าง** หรืออัปโหลดไฟล์หรือโฟลเดอร์ภายในเครื่องได้ด้วยปุ่ม **อัปโหลด** การดำเนินการเกี่ยวกับไฟล์ทั้งหมดเหล่านี้ยังสามารถทำได้โดยใช้วิธีการเมาท์โฟลเดอร์เข้าสู่เซสชันการคำนวณตามที่อธิบายไว้ข้างต้น
...
คุณสามารถกรองบันทึกการตรวจสอบได้โดยใช้ตัวควบคุมต่อไปนี้:

- **สถานะ**: กรองตามผลลัพธ์ของการดำเนินการ (เช่น SUCCESS หรือ ERROR)
- **การดำเนินการ**: กรองตามประเภทการดำเนินการ (เช่น create หรือ delete)
- **เรียกใช้โดย**: ค้นหาด้วย ID ผู้ใช้ที่ดำเนินการ รายการจะแสดงในรูปแบบ "email (id)"
- **เวลา**: จำกัดผลลัพธ์ให้แสดงเฉพาะช่วงวันและเวลาที่ระบุ

ปุ่มรีเฟรชอัตโนมัติช่วยให้บันทึกอัปเดตอยู่เสมอโดยไม่ต้องโหลดหน้าทั้งหมดใหม่ บันทึกใช้การโหลดแบบ lazy — คำขอจะถูกส่งไปยังเซิร์ฟเวอร์เฉพาะครั้งแรกที่คุณเปิดแท็บ

:::note
แท็บ Audit Log จะมองเห็นได้สำหรับผู้ใช้ทุกคน แต่ backend จะบังคับใช้ข้อจำกัดการเข้าถึง เฉพาะ superadmin เท่านั้นที่จะได้รับข้อมูล audit log ผู้ใช้ทั่วไปจะเห็นรายการว่างเปล่า
:::
