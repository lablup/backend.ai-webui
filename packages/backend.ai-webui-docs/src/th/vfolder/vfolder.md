...
- **โหมดการใช้งาน**: กำหนดวัตถุประสงค์ของโฟลเดอร์
   ...
   * โมเดล: กำหนดให้เป็นโฟลเดอร์เฉพาะสำหรับการให้บริการโมเดลและการจัดการโมเดล หากเลือกโหมดนี้ คุณจะสามารถตั้งค่าว่าโฟลเดอร์นั้นสามารถโคลนได้หรือไม่
...
- **การอนุญาตเมานต์**: สิทธิ์การเมาท์ที่ใช้เมื่อเมาท์โฟลเดอร์เข้าไปในเซสชันการคำนวณ **อ่านและเขียน** อนุญาตให้เขียนลงในโฟลเดอร์ภายในเซสชัน **อ่านเท่านั้น** ป้องกันไม่ให้เขียน
...
:::note
โฟลเดอร์ที่สร้างจากหน้าข้อมูลจะเป็น **โฟลเดอร์ผู้ใช้** เสมอ ส่วน **โฟลเดอร์โปรเจกต์** จะถูกสร้างโดยผู้ดูแลระบบจากหน้าข้อมูลสำหรับผู้ดูแลระบบ
:::
...
### เมื่อไม่สามารถสร้างเซสชัน SFTP ได้

หากไม่สามารถเริ่มเซสชัน SFTP ได้ กล่องโต้ตอบ 'สร้างเซสชัน SFTP ไม่สำเร็จ' จะปรากฏขึ้นแทนกล่องโต้ตอบการเชื่อมต่อ SSH / SFTP โดยจะแสดงสาเหตุที่เซิร์ฟเวอร์รายงาน ตามด้วยสถานะ HTTP และรหัสข้อผิดพลาดในวงเล็บ (ตัวอย่างเช่น `... (HTTP 500, BAI_E0001)`) เพื่อให้คุณสามารถแจ้งข้อผิดพลาดนี้แก่ผู้ดูแลระบบได้ ใต้สาเหตุจะมีคำแนะนำว่าการปิดเซสชันอัปโหลดที่ไม่ได้ใช้งานอาจช่วยเพิ่มทรัพยากรบนโฮสต์ SFTP

กล่องโต้ตอบนี้มีปุ่มสองปุ่ม ดังนี้

- 'ไปที่เซสชันอัปโหลด': เปิดหน้าเซสชันที่กรองตามชนิด 'เซสชันอัปโหลด' ซึ่งคุณสามารถยุติเซสชันอัปโหลดที่ไม่ต้องการใช้อีกต่อไปได้
- 'ปิด': ปิดกล่องโต้ตอบโดยไม่ดำเนินการใด ๆ เพิ่มเติม

สาเหตุที่พบบ่อยที่สุดของข้อผิดพลาดนี้คือคุณใช้เซสชันอัปโหลด (SFTP) พร้อมกันครบจำนวนสูงสุดที่นโยบายทรัพยากรคีย์แพร์อนุญาตแล้ว
