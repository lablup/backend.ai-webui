...
<!-- TODO: Re-capture data_page.png — ปุ่มรีเฟรชเหนือรายการโฟลเดอร์เปลี่ยนเป็นตัวควบคุมแบบแยกที่มีเชฟรอนสำหรับเลือกช่วงเวลา -->
...
ปุ่มรีเฟรชเหนือรายการโฟลเดอร์จะโหลดรายการโฟลเดอร์ใหม่โดยไม่ต้องโหลดทั้งหน้าใหม่
เชฟรอนที่อยู่ถัดไปจะเปิดเมนู **รีเฟรชอัตโนมัติ** ซึ่งคุณสามารถเลือกความถี่ที่รายการจะ
โหลดใหม่ด้วยตัวเองได้ ได้แก่ `ปิด`, `5วิ`, `10วิ`, `15วิ`, `30วิ` หรือ `1น.`
เครื่องหมายถูกจะกำกับช่วงเวลาที่ใช้งานอยู่ในปัจจุบัน

![](../images/vfolder_auto_refresh_menu.png)
<!-- TODO: Capture screenshot of vfolder_auto_refresh_menu.png — ปุ่มรีเฟรชในหน้าข้อมูลที่เปิดเมนูรีเฟรชอัตโนมัติอยู่ แสดงรายการ ปิด / 5วิ / 10วิ / 15วิ / 30วิ / 1น. พร้อมเครื่องหมายถูกบนรายการที่ใช้งานอยู่ -->

รายการโฟลเดอร์จะเริ่มต้นด้วยการรีเฟรชอัตโนมัติเป็น `ปิด` เนื่องจากเนื้อหาของโฟลเดอร์
ไม่ค่อยเปลี่ยนแปลงด้วยตัวเอง เมื่อคุณเลือกช่วงเวลาแล้ว ระบบจะจดจำตัวเลือกนั้นสำหรับ
รายการนี้และนำมาใช้อีกครั้งเมื่อคุณเปิดหน้านี้ในครั้งถัดไป รวมถึงกรณีที่คุณเลือก `ปิด`
อีกครั้งด้วย

ขณะที่การรีเฟรชอัตโนมัติเปิดอยู่ ช่วงเวลาที่เลือกจะแสดงถัดจากเชฟรอน และเส้นขอบนับถอยหลัง
จะค่อย ๆ เติมรอบปุ่มจนถึงการโหลดใหม่ครั้งถัดไป หากคุณรีเฟรชด้วยตนเอง การนับถอยหลังจะ
เริ่มใหม่ การรีเฟรชอัตโนมัติจะหยุดชั่วคราวขณะที่หน้าไม่ปรากฏบนจอ เช่น เมื่อคุณสลับไปยัง
แท็บอื่นของเบราว์เซอร์ และจะทำงานต่อเมื่อคุณกลับมา
...
ภายในแผงซ้าย คุณสามารถเห็นไดเรกทอรีและไฟล์ทั้งหมดในโฟลเดอร์ คลิกที่ชื่อไดเรกทอรีในคอลัมน์ชื่อเพื่อนำทางเข้าไปในไดเรกทอรีนั้น ใช้ปุ่มในคอลัมน์การกระทำเพื่อดาวน์โหลดหรือลบไฟล์หรือไดเรกทอรี คุณสามารถเปลี่ยนชื่อไฟล์หรือไดเรกทอรีได้เช่นกัน สำหรับการดำเนินการไฟล์ที่ละเอียดมากขึ้น คุณสามารถเมาท์โฟลเดอร์นี้เมื่อสร้างเซสชันการคำนวณ จากนั้นใช้บริการเช่น Terminal หรือ Jupyter Notebook
...
แท็บนี้มีปุ่มรีเฟรชของตัวเองพร้อมเมนูช่วงเวลา **รีเฟรชอัตโนมัติ** แบบเดียวกับที่อธิบายไว้ใน
[รีเฟรชรายการโฟลเดอร์](#refresh-folder-list) ช่วงเวลาของปุ่มนี้ก็เริ่มต้นที่ `ปิด`
เช่นกัน และถูกจดจำแยกจากรายการโฟลเดอร์
...
<!-- TODO: Capture screenshot of vfolder_bulk_move_to_trash.png — โมดัลย้ายไปที่ถังขยะที่เปิดจากการเลือกหลายโฟลเดอร์ซึ่งมีทั้งโฟลเดอร์ที่ลบได้และลบไม่ได้ โดยต้องเห็นการแจ้งเตือนโฟลเดอร์ที่ถูกยกเว้นและรายการโฟลเดอร์อยู่เหนือข้อความยืนยัน -->

หากรายการที่เลือกมีโฟลเดอร์ที่คุณไม่มีสิทธิ์ลบ โมดัลจะแสดงการแจ้งเตือนหัวข้อ
*"โฟลเดอร์ต่อไปนี้ที่ไม่มีสิทธิ์ลบจะถูกยกเว้น"* พร้อมรายชื่อโฟลเดอร์เหล่านั้น โปรดอ่าน
รายการนี้ก่อนยืนยัน เพราะมีเพียงโฟลเดอร์ที่เหลือเท่านั้นที่จะย้ายไปยังแท็บถังขยะ และ
ข้อความยืนยันใต้การแจ้งเตือนก็นับเฉพาะโฟลเดอร์เหล่านั้น หากมีโฟลเดอร์ที่ถูกยกเว้นจำนวนมาก
รายการจะเลื่อนภายในการแจ้งเตือนแทนที่จะขยายโมดัลให้ยาวขึ้น
