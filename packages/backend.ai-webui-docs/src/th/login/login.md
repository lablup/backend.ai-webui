...
### ภาษาของหน้าเข้าสู่ระบบ

หน้าเข้าสู่ระบบจะแสดงเป็นภาษาของเบราว์เซอร์ของคุณ คุณไม่จำเป็นต้องเข้าสู่ระบบก่อนหรือเปลี่ยนการตั้งค่าใด ๆ ในการเข้าใช้งานครั้งแรก และในหน้าต่างแบบส่วนตัว (incognito) ที่ยังไม่มีข้อมูลใดถูกบันทึกไว้ WebUI จะอ่านภาษาที่เบราว์เซอร์รายงานและแสดงกล่องโต้ตอบเข้าสู่ระบบ ข้อความตัวอย่างในช่องกรอกข้อมูล และปุ่มต่าง ๆ เป็นภาษานั้น

ภาษาจะถูกเลือกตามลำดับต่อไปนี้

1. ภาษาที่คุณเคยเลือกไว้ในการตั้งค่าผู้ใช้ หากเคยเลือกไว้ก่อนหน้านี้ การเลือกนี้จะถูกจดจำไว้ในเบราว์เซอร์และมีผลกับหน้าเข้าสู่ระบบด้วย ไม่ใช่เฉพาะหลังจากเข้าสู่ระบบแล้วเท่านั้น
2. โลแคลแบบเต็มของเบราว์เซอร์ หาก WebUI มีคำแปลสำหรับโลแคลนั้น (เช่น `pt-BR`)
3. ส่วนภาษาพื้นฐานของโลแคล หากไม่มีคำแปลที่ตรงกับโลแคลแบบเต็ม (เช่น `de` สำหรับเบราว์เซอร์ที่ตั้งค่าเป็น `de-AT`)
4. ภาษาอังกฤษ หากไม่มีรายการใดข้างต้นตรงกับภาษาที่ WebUI มีให้

:::note
หากต้องการเลือกภาษาของอินเทอร์เฟซด้วยตนเอง ให้เข้าสู่ระบบแล้วเปิดแท็บ [ทั่วไป](#general-tab) ในการตั้งค่าผู้ใช้ ภาษาที่คุณเลือกจะแทนที่การตรวจจับภาษาของเบราว์เซอร์นับจากนั้น ทั้งภายในแอปพลิเคชันและในหน้าเข้าสู่ระบบ
:::
...
:::note
หากระบบของคุณมีตัวจับเวลาเซสชันการเข้าสู่ระบบที่เปิดใช้งาน คุณจะถูกออกจากระบบโดยอัตโนมัติเมื่อตัวจับเวลาหมดอายุ สำหรับรายละเอียด โปรดดูส่วน [ตัวจับเวลาเซสชันการเข้าสู่ระบบ](#login-session-timer) ในคุณสมบัติแถบด้านบน
:::
...
หลังจากเข้าสู่ระบบ แถบด้านข้างทางซ้ายจะเป็นเครื่องมือนำทางหลักของคุณ คุณสามารถเปลี่ยนความกว้างของแถบด้านข้างได้ และรายการที่แสดงจะขึ้นอยู่กับบทบาทที่คุณมีในโปรเจกต์ที่เปิดอยู่ในขณะนั้น
...
รายการสำหรับผู้ดูแลโปรเจกต์จะถูกพิจารณาจาก**โปรเจกต์ที่เปิดอยู่ในขณะนั้น** ไม่ใช่จากบัญชีของคุณโดยรวม เนื่องจากโปรเจกต์ที่คุณกำลังทำงานอยู่เป็นส่วนหนึ่งของที่อยู่หน้าเว็บ การสลับโปรเจกต์จากตัวเลือกโปรเจกต์ในแถบด้านบนจึงทำให้มีการประเมินบทบาทของคุณใหม่ กล่าวคือ บัญชีเดียวกันอาจเป็นผู้ดูแลโปรเจกต์ในโปรเจกต์หนึ่งและเป็นผู้ใช้ทั่วไปในอีกโปรเจกต์หนึ่ง รายการสำหรับผู้ดูแลโปรเจกต์จึงปรากฏหรือหายไปจากแถบด้านข้างตามนั้น เช่นเดียวกันเมื่อคุณเปิดบุ๊กมาร์กหรือลิงก์ที่แชร์มาซึ่งระบุโปรเจกต์ใดโปรเจกต์หนึ่ง แถบด้านข้างจะสะท้อนบทบาทของคุณในโปรเจกต์นั้นทันทีที่หน้าเว็บโหลดเสร็จ

สำหรับรายการที่ผู้ดูแลโปรเจกต์จะได้รับและรายละเอียดของแต่ละรายการ โปรดดูส่วน [แถบด้านข้างของผู้ดูแลโปรเจกต์](#the-project-admin-sidebar) ในบทคุณสมบัติสำหรับผู้ดูแลโปรเจกต์
