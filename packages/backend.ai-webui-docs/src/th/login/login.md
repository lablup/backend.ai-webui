...
:::note
หน้าจอเข้าสู่ระบบจะแสดงพื้นหลังแบบเคลื่อนไหว Diagonal Weave ด้านหลังกล่องโต้ตอบเข้าสู่ระบบ ข้อมูลเวอร์ชันและ build ของแอปพลิเคชันจะแสดงที่มุมล่างซ้าย และข้อมูลลิขสิทธิ์จะแสดงที่มุมล่างขวาของหน้าจอ ช่องอีเมลจะถูกโฟกัสโดยอัตโนมัติเมื่อกล่องโต้ตอบเข้าสู่ระบบเปิดขึ้น
:::
