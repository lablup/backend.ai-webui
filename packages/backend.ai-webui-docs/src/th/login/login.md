...
กรอกข้อมูลที่จำเป็น อ่านและยอมรับข้อกำหนดในการให้บริการ / นโยบายความเป็นส่วนตัว และคลิกปุ่ม SIGNUP ขึ้นอยู่กับการตั้งค่าของระบบ อาจต้องกรอกโทเค็นการเชิญเพื่อลงทะเบียน อีเมลยืนยันอาจถูกส่งเพื่อยืนยันว่าอีเมลนั้นเป็นของคุณ หากมีการส่งอีเมลยืนยัน คุณจะต้องอ่านอีเมลและคลิกลิงก์ภายในเพื่อผ่านการตรวจสอบก่อนที่จะสามารถเข้าสู่ระบบด้วยบัญชีของคุณได้
...
ป้อนอีเมล (หรือชื่อผู้ใช้) และรหัสผ่าน จากนั้นคลิกปุ่ม **Login**
...
หากผู้ดูแลระบบได้ตั้งค่า SSO (Single Sign-On) ปุ่มเข้าสู่ระบบเพิ่มเติมอาจปรากฏด้านล่างปุ่ม **Login** มาตรฐาน
