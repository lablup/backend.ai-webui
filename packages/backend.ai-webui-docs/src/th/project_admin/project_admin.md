...
เมื่อคุณอยู่ในหน้าผู้ดูแลโปรเจกต์หน้าใดหน้าหนึ่ง จะมีแบนเนอร์ข้อมูลเพียงรายการเดียวปรากฏเหนือเนื้อหาของหน้า เพื่อเตือนคุณว่าจะแสดงเฉพาะรายการที่เป็นของโปรเจกต์ที่เลือกอยู่ในปัจจุบันเท่านั้น แบนเนอร์นี้แสดงผลเพียงครั้งเดียวที่ระดับเลย์เอาต์ แทนที่จะแสดงแยกกันในแต่ละหน้า
...
คอลัมน์ **รีวิชัน** แสดงรีวิชันปัจจุบันของการปรับใช้เป็นลิงก์ `#N` ที่คลิกได้ คลิกที่ลิงก์นี้เพื่อเปิดแผงที่แสดงรายละเอียดของรีวิชันปัจจุบัน
   ...
   ข้อมูลรีวิชันปัจจุบันใช้งานได้บน Backend.AI Manager 26.4.3 ขึ้นไป
