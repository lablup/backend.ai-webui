...
:::note
ฟีเจอร์ผู้ดูแลโปรเจกต์ที่อธิบายในบทนี้รองรับตั้งแต่ **Backend.AI WebUI 26.4.0** เป็นต้นไป
:::
...
เมื่อคุณเลือกโปรเจกต์ที่คุณเป็นผู้ดูแลโปรเจกต์ ส่วน **การจัดการระบบ** ของแถบด้านข้างจะแสดงรายการสี่รายการที่อุทิศให้กับการจัดการโปรเจกต์นั้น:
...
ทั้งสี่หน้านี้จะแสดงแบนเนอร์ข้อมูลที่ด้านบนเพื่อเตือนคุณว่าเนื้อหาถูกจำกัดอยู่ที่โปรเจกต์ที่เลือกอยู่ในปัจจุบัน
...
1. เลือกเซสชันที่ต้องการยุติโดยใช้ช่องทำเครื่องหมายในคอลัมน์ซ้ายสุด หากต้องการยุติเซสชันเดียว คุณสามารถใช้การดำเนินการยุติของแถวนั้นได้
2. คลิกไอคอนปิดเครื่องในส่วนหัวของตารางเพื่อเปิดโมดอลยืนยัน
3. ตรวจสอบรายการเซสชันเป้าหมายในโมดอลแล้วคลิก **ตกลง** เพื่อยืนยัน
...
- คลิก**ไอคอนถังขยะ**เพื่อลบการปรับใช้หลังจากการยืนยัน
...
- แท็บ **ใช้งานอยู่ / ลบแล้ว**: สลับระหว่างโฟลเดอร์ที่ใช้งานอยู่และโฟลเดอร์ที่ถูกลบแบบนุ่ม
- **ตัวกรองโหมด**: กรองตามโหมดการใช้งานของโฟลเดอร์ — **ทั้งหมด**, **ทั่วไป**, **ข้อมูล**, **เมาท์อัตโนมัติ**, **โมเดล**
...
สลับไปยังแท็บ **ลบแล้ว** เพื่อดูโฟลเดอร์ที่ถูกลบแบบนุ่ม การดำเนินการสองอย่างพร้อมใช้งานในแต่ละแถว:

- **คืนค่า**: ย้ายโฟลเดอร์กลับไปยังแท็บใช้งานอยู่
- **ลบถาวร**: ล้างโฟลเดอร์อย่างถาวร การดำเนินการนี้ไม่สามารถยกเลิกได้ และต้องการให้คุณพิมพ์ชื่อโฟลเดอร์เพื่อยืนยัน
