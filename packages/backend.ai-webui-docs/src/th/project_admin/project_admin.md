...
ผู้ดูแลระบบระดับสูงสามารถมอบและเพิกถอนสิทธิ์ผู้ดูแลโปรเจกต์ให้กับผู้ใช้หนึ่งคนหรือมากกว่าได้ในที่เดียวผ่านโมดอล **ตั้งค่าผู้ดูแลโปรเจกต์** ซึ่งเปิดจากหน้าผู้ดูแล**โปรเจกต์** (**ผู้ใช้ → โปรเจกต์**) นี่คือวิธีหลักในการจัดการผู้ดูแลโปรเจกต์บน**ตัวจัดการเวอร์ชัน 26.8.0 ขึ้นไป**
...
- **คำเตือน**: การเพิกถอนสิทธิ์ผู้ดูแลโปรเจกต์จะ**ไม่**ลบโปรเจกต์นั้นออกจากรายการโปรเจกต์ที่ได้รับอนุญาตของผู้ใช้โดยอัตโนมัติ หากต้องการบล็อกการเข้าถึงโปรเจกต์ โปรดลบออกจากรายการด้วยตนเอง

ถัดจากชื่อโมดอล ไอคอนรูปโล่ (**ดูสิทธิ์ RBAC**) จะเปิดหน้าการจัดการ RBAC โดยที่บทบาท `project-<project_id>-admin` ของโปรเจกต์ถูกกรองไว้ล่วงหน้าและแผงรายละเอียดเปิดอยู่ เพื่อให้คุณตรวจสอบบทบาทพื้นฐานได้ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับบทบาทนั้น ดูที่[การมอบสิทธิ์ผู้ดูแลโปรเจกต์](#grant-project-admin)ในบทการจัดการ RBAC
...
หน้าผู้ดูแลโปรเจกต์ทั้งสี่หน้ามีตัวควบคุมการรีเฟรชแบบเดียวกันที่ปลายด้านขวาของแถบเครื่องมือเหนือตาราง คลิกปุ่มรีเฟรชเพื่อโหลดรายการใหม่ทันที
...
- แต่ละหน้าจะจดจำช่วงเวลาของตนเอง และค่าที่คุณเลือกจะคงอยู่แม้โหลดหน้าใหม่ การเลือก **ปิด** จะหยุดการรีเฟรชอัตโนมัติเฉพาะหน้านั้นเท่านั้น

การคลิกปุ่มรีเฟรชด้วยตนเองจะเริ่มนับถอยหลังใหม่ด้วย ดังนั้นการรีเฟรชอัตโนมัติครั้งถัดไปจะห่างออกไปเต็มช่วงเวลาที่เลือกไว้
...
- **สภาพแวดล้อม**: แสดงคอนเทนเนอร์อิมเมจของเซสชัน โดยเรียงเป็นไอคอนของอิมเมจ ตามด้วยชื่อพื้นฐาน เวอร์ชัน และสถาปัตยกรรม ไอคอนและชื่อที่แสดงมาจากข้อมูลเมตาของอิมเมจที่ลงทะเบียนไว้ในระบบ ส่วนอิมเมจที่ไม่มีข้อมูลเมตาลงทะเบียนไว้จะแสดงไอคอนเริ่มต้น
- **ประเภทเซสชัน**: แสดงประเภทของเซสชันเป็นแท็กสี — `INTERACTIVE`, `BATCH` หรือ `INFERENCE`
- **โหมดคลัสเตอร์**: แสดง **เดี่ยว** หรือ **หลาย** ตามด้วยขนาดคลัสเตอร์ของเซสชันในวงเล็บ

หากต้องการเปลี่ยนคอลัมน์ที่แสดง ให้คลิกไอคอนการตั้งค่า (รูปเฟือง) ที่อยู่ข้างตัวควบคุมการแบ่งหน้าใต้ตาราง แล้วปรับการเลือกในโมดอล **การตั้งค่าตาราง** คอลัมน์ที่ซ่อนไว้โดยค่าเริ่มต้น ได้แก่ **ID เซสชัน** และ **โครงการ** ก็สามารถแสดงได้จากที่นั่น
