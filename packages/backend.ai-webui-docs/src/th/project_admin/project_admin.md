...
ถัดจากชื่อโมดอล ไอคอน **ดูสิทธิ์ RBAC** จะเปิดหน้าการจัดการ RBAC โดยที่บทบาท `project-<project_id>-admin` ของโปรเจกต์ถูกกรองไว้ล่วงหน้าและแผงรายละเอียดเปิดอยู่ เพื่อให้คุณตรวจสอบบทบาทพื้นฐานได้ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับบทบาทนั้น ดูที่[การมอบสิทธิ์ผู้ดูแลโปรเจกต์](#grant-project-admin)ในบทการจัดการ RBAC
