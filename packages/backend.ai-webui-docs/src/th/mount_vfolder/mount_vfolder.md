...
# การเชื่อมต่อโฟลเดอร์เข้ากับเซสชันการคำนวณ
...
Backend.AI มีตัวเลือกในการเก็บไฟล์ในโฟลเดอร์ไว้เมื่อเซสชันการคำนวณถูกยุติ
...
ตอนนี้ให้ยุติเซสชันการคำนวณและไปที่หน้า Storage
...
ดังนั้น หากคุณสร้างโฟลเดอร์เมาท์อัตโนมัติชื่อ `.linuxbrew` ไว้แล้ว แพ็กเกจ Homebrew ที่ติดตั้งไว้ก่อนหน้านี้จะสามารถใช้งานได้อีกครั้ง แม้ว่าจะยุติเซสชันการคำนวณเดิมและสร้างเซสชันการคำนวณใหม่ก็ตาม