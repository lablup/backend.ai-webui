...
การคลิกที่ช่อง **Deployment** (แสดงข้อความ **เลือกจุดสิ้นสุด** เมื่อยังไม่ได้เลือก) จะเปิดเมนูแบบดร็อปดาวน์ที่แสดงรายการ deployment ที่มีอยู่ โดยมีช่องค้นหาอยู่ด้านบนและจำนวน deployment ทั้งหมดอยู่ด้านล่าง
