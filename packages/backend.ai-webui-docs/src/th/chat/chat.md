...
หาก deployment ที่เลือกเป็นของโปรเจกต์อื่นที่ไม่ใช่โปรเจกต์ที่ใช้งานอยู่ในปัจจุบัน (เช่น การ์ดยังคงการเลือกไว้หลังจากที่คุณสลับโปรเจกต์) กล่องโต้ตอบยืนยันชื่อ **ต้องการสลับไปยังโปรเจกต์อื่นหรือไม่** จะปรากฏขึ้นก่อน การยืนยันจะสลับโปรเจกต์ที่ใช้งานอยู่ไปยังโปรเจกต์ของ deployment นั้นแล้วเปิดหน้ารายละเอียด ส่วนการยกเลิกจะคงโปรเจกต์ปัจจุบันไว้เช่นเดิม
