...
เมื่อคุณสลับไปยังแท็บอื่นแล้วกลับมา มุมมองเดิมจะกลับมาแทนที่จะรีเซ็ต
สถานะการแสดงผลของแท็บที่คุณกำลังใช้งานอยู่ยังเก็บไว้ใน URL ของหน้าด้วย
...
หน้าจอแต่ละแห่งจะจดจำช่วงเวลาที่คุณเลือกแยกจากกันและคงไว้หลังการโหลดใหม่ ตัวอย่างเช่น การเลือก
...
ผลกระทบ ตัวเลือกนี้ปิดอยู่เป็นค่าเริ่มต้น
:::
...
เนื่องจากคุณมักเปิดหน้าต่างบันทึกเพื่อเฝ้าดูบรรทัดใหม่ที่เข้ามา การรีเฟรชอัตโนมัติจึงเริ่มต้น
ที่ช่วงเวลา 10 วินาที คุณสามารถเลือกช่วงเวลาอื่น หรือเลือก **ปิด** จากตัวเลือกถัดจากปุ่มรีเฟรช
และค่าที่เลือกจะคงอยู่สำหรับครั้งถัดไปที่คุณเปิดหน้าต่างบันทึก มุมมองบันทึกจะเลื่อนไปยัง
บรรทัดล่าสุดหลังการโหลดใหม่แต่ละครั้ง และบรรทัดที่เพิ่มเข้ามาตั้งแต่การโหลดครั้งก่อนจะแสดงด้วยสีเน้น
