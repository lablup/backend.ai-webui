...
เพื่อเปิดรายการในสถานะเดียวกันได้ อย่างไรก็ตาม URL จะเก็บเฉพาะแท็บที่คุณกำลังดูอยู่เท่านั้น
หลังจากโหลดใหม่ แท็บอื่นจึงเริ่มต้นจากค่าเริ่มต้น
...
ป้ายจะเปลี่ยนระดับก่อนที่ค่าเฉลี่ยจะลดลงต่ำกว่าเกณฑ์จริง ๆ ดังนั้นเซสชันอาจแสดงเป็น
...
กล่าวคือ เมื่อแท็กมีสี หมายความว่าการเรียกคืนใกล้จะเกิดขึ้นแล้ว
