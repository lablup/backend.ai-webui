...
รายการเซสชันยังมีคอลัมน์ **คีย์การเข้าถึง** ซึ่งแสดงคีย์การเข้าถึงของคีย์แพร์ที่ใช้สร้างแต่ละเซสชัน
คอลัมน์นี้ถูกซ่อนไว้ตามค่าเริ่มต้น คุณสามารถเปิดใช้งานได้ในกล่องโต้ตอบ **การตั้งค่าตาราง**
ซึ่งเปิดได้ด้วยปุ่มรูปเฟืองที่มุมขวาล่างของตาราง หากเซสชันของคุณเองถูกสร้างด้วยคีย์แพร์อื่น
ที่ไม่ใช่คีย์การเข้าถึงที่คุณกำลังเข้าสู่ระบบอยู่ จะมีไอคอนคำเตือนแสดงถัดจากคีย์การเข้าถึง
พร้อมคำแนะนำเครื่องมือว่า "เซสชันนี้ถูกสร้างด้วยคีย์อื่นที่ไม่ใช่คีย์การเข้าถึงเริ่มต้นของคุณ"
...
แผงรายละเอียดเซสชันยังแสดงรายการ **คีย์การเข้าถึง** ซึ่งเป็นคีย์การเข้าถึงของคีย์แพร์ที่ใช้สร้างเซสชันนั้น
คลิกปุ่มคัดลอกถัดจากค่าเพื่อคัดลอกคีย์ดังกล่าว เช่นเดียวกับในรายการเซสชัน หากเซสชันของคุณเอง
ถูกสร้างด้วยคีย์แพร์อื่นที่ไม่ใช่คีย์การเข้าถึงที่คุณกำลังเข้าสู่ระบบอยู่ จะมีไอคอนคำเตือนพร้อมคำแนะนำเครื่องมือว่า
"เซสชันนี้ถูกสร้างด้วยคีย์อื่นที่ไม่ใช่คีย์การเข้าถึงเริ่มต้นของคุณ" แสดงอยู่ด้วย
