...
บน Backend.AI Manager เวอร์ชัน 26.8.0 ขึ้นไป เซสชันอาจปรากฏในสถานะ `RESERVED`, `PREEMPTED` และ `RESCHEDULING` ได้ด้วย ตัวจัดกำหนดการจะใช้สถานะเหล่านี้เมื่อจำเป็นต้องปลดปล่อยทรัพยากรให้กับงานที่มีลำดับความสำคัญสูงกว่า
...
:::note
สถานะเหล่านี้และคำอธิบายเหตุผลจะแสดงเฉพาะเมื่อ Backend.AI Manager เป็นเวอร์ชัน 26.8.0 ขึ้นไปเท่านั้น บนเซิร์ฟเวอร์เวอร์ชันที่เก่ากว่า แท็กสถานะเซสชันจะยังคงแสดงค่าข้อมูลสถานะแบบดิบ
:::
