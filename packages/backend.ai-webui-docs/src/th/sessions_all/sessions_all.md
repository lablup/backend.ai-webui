...
:::note
โหมด **Expand Errors Only** (ที่อธิบายด้านล่าง) จะใช้เฉพาะกับรายการที่มองเห็นได้ในหน้าปัจจุบันเท่านั้น ไม่ใช่กับประวัติทั้งหมด
:::
...
เมนู kebab (⋮) ในส่วนหัวของคอลัมน์ขยายช่วยให้คุณควบคุมวิธีการขยายแถวทั่วทั้งตารางได้ มีโหมดการแสดงผลสามแบบ:

- **Expand All**: ขยายทุกแถวเพื่อให้มองเห็นขั้นตอนย่อยทั้งหมดได้ทันที
- **Collapse All**: ยุบทุกแถวเพื่อแสดงเฉพาะบันทึกประวัติระดับบนสุด
- **Expand Errors Only** (ค่าเริ่มต้น): ขยายแถวที่มีผลลัพธ์ไม่ใช่ SUCCESS โดยอัตโนมัติ และซ่อนขั้นตอนย่อยที่เป็น SUCCESS ภายในแถวที่ขยายแล้วด้วย โหมดนี้มีประโยชน์มากที่สุดสำหรับการระบุอย่างรวดเร็วว่าเกิดอะไรขึ้นผิดพลาดในวงจรชีวิตการจัดตารางของเซสชัน
