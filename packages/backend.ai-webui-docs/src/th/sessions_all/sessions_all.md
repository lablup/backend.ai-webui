...
ปุ่มรีเฟรชทางด้านขวาของแถบเครื่องมือรายการจะโหลดรายการเซสชันใหม่ทันที
และมีตัวเลือกช่วงเวลารีเฟรชอัตโนมัติที่ใช้ร่วมกันด้วย (ดูที่
[รีเฟรชอัตโนมัติ](#common-auto-refresh)) การรีเฟรชอัตโนมัติเปิดใช้งานตั้งแต่แรกบน
หน้าจอของเซสชันการคำนวณ: **รายการเซสชัน** เริ่มต้นที่ช่วงเวลา 15 วินาที ส่วน
**แผงรายละเอียดเซสชัน** และหน้าต่าง **บันทึกคอนเทนเนอร์** เริ่มต้นที่ช่วงเวลา 10 วินาที
โดยแต่ละหน้าจอจะจดจำช่วงเวลาที่เลือกแยกจากกัน
...
การคลิกเมนู kebab (⋮) ในส่วนหัวของคอลัมน์ขยายจะเปิดเมนู **ตัวเลือกการขยาย** ซึ่งให้คุณเลือกขยายทุกแถว ยุบทุกแถว หรือขยายเฉพาะแถวที่มีผลลัพธ์ไม่ใช่ SUCCESS ค่าเริ่มต้นคือ **ขยายเฉพาะข้อผิดพลาด** ซึ่งในโหมดนี้ขั้นตอนย่อยที่เป็น SUCCESS ภายในแถวที่ขยายจะถูกซ่อนด้วย สิ่งที่ผิดพลาดในวงจรชีวิตการจัดตารางของเซสชันจึงมองเห็นได้ทันที
...
ที่ช่วงเวลา 10 วินาที มุมมองบันทึกจะเลื่อนไปยังบรรทัดล่าสุดหลังการโหลดใหม่แต่ละครั้ง
และบรรทัดที่เพิ่มเข้ามาตั้งแต่การโหลดครั้งก่อนจะแสดงด้วยสีเน้น
