...
การสร้างบริการโมเดลแบ่งเป็นสองขั้นตอน
...
หากโปรเจกต์ของคุณไม่มี preset ที่เข้ากันได้ หน้าต่างจะเปลี่ยนเป็นโหมดด้วยตนเอง และคุณจะกรอกฟิลด์โดยตรง ดูวิธีการสร้างและจัดการ preset ได้ที่เอกสาร Deployment Presets
