...
สลับกลับไปที่บัญชีผู้ใช้ B แล้วไปที่หน้า Data ป้ายคำเชิญจะปรากฏข้างรายการหน้าข้อมูลในแถบด้านข้าง และข้างกับสรุปสถานะของโฟลเดอร์ ป้ายจะแสดงจำนวนคำเชิญที่ค้างอยู่และยังไม่ได้รับการตอบกลับ
...
:::note
สิทธิ์ที่อธิบายในส่วนนี้ใช้กับโฟลเดอร์จัดเก็บแต่ละรายการและจัดการโดยเจ้าของโฟลเดอร์ ส่วนสิทธิ์โฟลเดอร์ที่ใช้กับทั้งโฮสต์จัดเก็บเป็นการตั้งค่าสำหรับผู้ดูแลระบบเท่านั้น ซึ่งกำหนดค่าได้ในแท็บ **สิทธิ์โฟลเดอร์โครงการ** และ **สิทธิ์โฟลเดอร์ผู้ใช้** ของ Storage Host Detail Drawer โดยเลือกโดเมนหรือผู้ใช้เป้าหมายจากตัวเลือกแทนการพิมพ์ชื่อ สำหรับรายละเอียด โปรดดู[สิทธิ์โฟลเดอร์ผู้ใช้](#user-folder-permission)
:::
