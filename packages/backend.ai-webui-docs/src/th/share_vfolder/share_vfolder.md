...
:::note
หากต้องการใช้ตัวเปิดเซสชันแบบเดิม โปรดดู[การตั้งค่าผู้ใช้](#general-tab) สำหรับคำแนะนำการใช้งาน โปรดดู[ลิงก์](https://webui.docs.backend.ai/en/23.09_a/sessions_all/sessions_all.html)ต่อไปนี้ หากต้องการทราบข้อมูลเพิ่มเติมเกี่ยวกับตัวเปิดเซสชัน NEO โปรดดู[สร้างเซสชัน](#start-a-new-session)
:::
