...
ไปที่หน้า Data และตรวจสอบว่าโฟลเดอร์ `tests` แสดงในรายการ หากไม่เห็นในรายการ ให้ลองรีเฟรชหน้าเบราว์เซอร์ เนื่องจากคุณได้ยอมรับคำเชิญแล้ว จึงสามารถดูเนื้อหาของโฟลเดอร์ `tests` ของผู้ใช้ A ในบัญชีผู้ใช้ B ได้ ต่างจากโฟลเดอร์ที่ผู้ใช้ B สร้างเอง โฟลเดอร์ที่แชร์จะแสดงที่อยู่อีเมลของผู้ใช้ A ในคอลัมน์เจ้าของ นอกจากนี้ยังจะเห็นเครื่องหมาย `อ่านเท่านั้น` ที่แสดงในคอลัมน์สิทธิ์การเมาท์
