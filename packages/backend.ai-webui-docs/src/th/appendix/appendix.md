...
เซิร์ฟเวอร์ Backend.AI มีตัวจัดตารางงานที่พัฒนาขึ้นเองในตัว มันจะตรวจสอบทรัพยากรที่มีอยู่ของโหนดเอเจนต์ทั้งหมดโดยอัตโนมัติและมอบหมายคำขอในการสร้างเซสชันการคำนวณไปยังเอเจนต์ที่ตรงตามคำขอทรัพยากรของผู้ใช้ นอกจากนี้ เมื่อทรัพยากรไม่เพียงพอ คำขอของผู้ใช้ในการสร้างเซสชันการคำนวณจะถูกลงทะเบียนในสถานะ PENDING ในคิวงาน ภายหลัง เมื่อทรัพยากรมีให้ใช้งานอีกครั้ง คำขอที่ถูกระงับจะถูกดำเนินการต่อเพื่อสร้างเซสชันการคำนวณ
...
รอครู่หนึ่งแล้วคุณจะเห็นการเซสชันการคำนวณสามรายการถูกแสดงอยู่ ถ้าคุณสังเกตอย่างใกล้ชิดที่แผงสถานะ คุณจะเห็นว่าการเซสชันการคำนวณสองจากสามรายการอยู่ในสถานะ RUNNING แต่การเซสชันการคำนวณอีกหนึ่งรายการยังคงอยู่ในสถานะ PENDING การเซสชัน PENDING นี้ถูกลงทะเบียนในคิวงานเท่านั้นและยังไม่ได้ถูกจัดสรรคอนเทนเนอร์จริงเนื่องจากทรัพยากร GPU ไม่เพียงพอ

![](../images/pending_session_list.png)

ตอนนี้เราจะทำลายหนึ่งในสองเซสชันที่อยู่ในสถานะ RUNNING จากนั้นคุณจะเห็นว่าเซสชันการคำนวณในสถานะ PENDING จะถูกจัดสรรทรัพยากรโดยตัวจัดกำหนดงานและเปลี่ยนเป็นสถานะ RUNNING ในไม่ช้า ในลักษณะนี้ ตัวจัดกำหนดงานจะใช้คิวงานเพื่อเก็บคำขอเซสชันการคำนวณของผู้ใช้และประมวลผลคำขอโดยอัตโนมัติเมื่อมีทรัพยากรพร้อมใช้งาน
...
## แปลงเซสชันการคำนวณเป็นภาพ Docker ส่วนตัวใหม่

หากคุณต้องการแปลงเซสชันการคำนวณที่กำลังทำงาน (คอนเทนเนอร์) เป็นภาพ Docker ใหม่ที่คุณสามารถใช้ในภายหลังเพื่อสร้างเซสชันการคำนวณใหม่ คุณต้องเตรียมสภาพแวดล้อมของเซสชันการคำนวณของคุณและขอให้ผู้ดูแลระบบทำการแปลงมัน

- ก่อนอื่น ให้เตรียมเซสชันการคำนวณของคุณโดยการติดตั้งแพ็คเกจที่คุณต้องการและปรับแต่งการตั้งค่าตามที่คุณต้องการ
...
แนะนำให้ใช้ [โฟลเดอร์ออโต้เมาท์](#using-automount-folder) เพื่อ[ติดตั้งแพ็คเกจ Python ผ่าน pip](#install_pip_pkg) อย่างไรก็ตาม หากคุณต้องการเพิ่มแพ็คเกจ Python ในอิมเมจใหม่ คุณควรติดตั้งด้วย `sudo pip install <ชื่อแพ็คเกจ>` เพื่อบันทึกไว้ในไดเรกทอรีระบบแทนที่จะเป็นโฮมไดเรกทอรี เนื้อหาในโฮมไดเรกทอรีของคุณ ซึ่งปกติคือ `/home/work/` จะไม่ถูกบันทึกเมื่อแปลงเซสชันการคำนวณเป็นอิมเมจ Docker ใหม่
:::

- เมื่อเซสชันการคำนวณของคุณเตรียมพร้อมแล้ว กรุณาขอให้ผู้ดูแลระบบแปลงเป็นอิมเมจ Docker ใหม่ คุณต้องแจ้งชื่อเซสชันหรือ ID และที่อยู่อีเมลของคุณในแพลตฟอร์ม
- ผู้ดูแลระบบจะแปลงเซสชันการคำนวณของคุณเป็นอิมเมจ Docker ใหม่และส่งชื่ออิมเมจเต็มและแท็กให้คุณ
...
- เซสชันการคำนวณใหม่จะถูกสร้างขึ้นโดยใช้อิมเมจ Docker ใหม่
