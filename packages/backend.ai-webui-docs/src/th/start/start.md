...
1. ป้อน URL พื้นที่เก็บข้อมูล GitHub ที่ถูกต้องในฟิลด์ **GitHub URL**
2. เลือก **Storage Host** ที่จะบันทึกพื้นที่เก็บข้อมูล
...
1. ป้อน URL พื้นที่เก็บข้อมูล GitLab ที่ถูกต้องในฟิลด์ **GitLab URL**
2. ระบุ **ชื่อ Branch ของ GitLab** ตามต้องการ (ค่าเริ่มต้น: `master`)
3. เลือก **Storage Host** ที่จะบันทึกพื้นที่เก็บข้อมูล
