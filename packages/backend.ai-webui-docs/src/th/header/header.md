...
เมื่อแตะไอคอนเมนู แผงนำทางแบบเลื่อน (drawer) จะเลื่อนเข้ามาจากด้านข้าง โดยมีเมนูชุดเดียวกับแถบด้านข้าง และด้านบนของแผงจะเป็นส่วนหัวสีของแบรนด์พร้อมโลโก้ Backend.AI ปิดแผงได้ด้วยปุ่มปิดในส่วนหัวหรือแตะพื้นที่นอกแผง และแผงจะปิดโดยอัตโนมัติเมื่อคุณเลือกรายการเมนูเพื่อไปยังหน้าอื่น
