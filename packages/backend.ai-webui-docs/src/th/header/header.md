...
- **รหัสผ่านเดิม**: รหัสผ่านปัจจุบันของคุณ ฟิลด์นี้จะแสดงเฉพาะเมื่อเชื่อมต่อกับเซิร์ฟเวอร์
  เวอร์ชันก่อน Backend.AI 26.4.0 และคุณต้องป้อนรหัสผ่านนี้เมื่อตั้งรหัสผ่านใหม่
...
:::note
ฟิลด์ **IP ไคลเอนต์ที่อนุญาต** สามารถใช้งานได้ตั้งแต่ Backend.AI 26.4.0 เป็นต้นไป
:::
