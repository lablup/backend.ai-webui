...
- **ตัวแปรสภาพแวดล้อม**: คู่ key/value ที่จะถูกส่งให้คอนเทนเนอร์ของ inference server สำหรับ `vLLM` และ `SGLang` ตัวแปรเฉพาะ runtime ที่ระบุไว้ข้างต้นจะถูกกรอกไว้ล่วงหน้า คุณสามารถเพิ่ม แก้ไข หรือลบรายการได้อย่างอิสระ เมื่อพิมพ์ชื่อตัวแปร ระบบจะแนะนำชื่อตัวแปรสภาพแวดล้อมที่ใช้บ่อย
