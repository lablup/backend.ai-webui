...
- **พาธย่อย**: โฟลเดอร์ย่อยภายในโฟลเดอร์โมเดลที่จะเมาต์แทนรากของโฟลเดอร์ คลิกที่ฟิลด์นี้เพื่อเปิดตัวเลือกไดเรกทอรี แล้วเลือกโฟลเดอร์ย่อยจากโครงสร้างไดเรกทอรีของโฟลเดอร์โมเดลที่เลือกไว้ เว้นว่างไว้เพื่อเมาต์รากของโฟลเดอร์
...
- **คำสั่ง**: คำสั่งสำหรับเปิดใช้งาน inference server เช่น `python -m http.server 8000` ในโหมด **Shell** ฟิลด์นี้เป็นกล่องข้อความหลายบรรทัด ส่วนในโหมด **Exec** จะเปลี่ยนชื่อเป็น **คำสั่ง (argv)** และเป็นช่องกรอกบรรทัดเดียว หากต้องการส่งสตริง JSON เป็นอาร์กิวเมนต์เดียว ให้ครอบ JSON ทั้งหมดด้วยเครื่องหมายอัญประกาศเดี่ยว และคงเครื่องหมายอัญประกาศคู่ภายในไว้ตามเดิม เช่น `--override-generation-config '{"temperature": 0.7}'`
...
เหนือตารางมีแถบตัวกรองคุณสมบัติและปุ่มรีเฟรช คุณสามารถกรองรายการตาม **หมายเลข Revision**, **วันที่สร้าง**, **โหมดคลัสเตอร์**, **อิมเมจ** และ **โฟลเดอร์โมเดล** ได้ ค่าของ **อิมเมจ** และ **โฟลเดอร์โมเดล** จะเลือกจากรายการแบบเลื่อนลงแทนการพิมพ์ตัวระบุ และแท็กตัวกรองที่ได้จะแสดงชื่อที่คุณเลือก รายการแบบเลื่อนลงของ **โฟลเดอร์โมเดล** จำกัดขอบเขตอยู่ที่โปรเจกต์ของการปรับใช้นี้เอง และแสดงเฉพาะโฟลเดอร์ที่ใช้งานแบบโมเดลโดยไม่รวมโฟลเดอร์ที่ถูกลบแล้ว ซึ่งเป็นขอบเขตเดียวกับตัวเลือกโฟลเดอร์ในหน้าต่างเพิ่ม Revision
...
คลิกปุ่ม `เพิ่มกฎ` เพื่อเปิดตัวแก้ไข **เพิ่มกฎการปรับขนาดอัตโนมัติ**
