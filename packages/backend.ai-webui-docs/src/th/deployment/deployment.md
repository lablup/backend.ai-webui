...
- **กำลังทำงาน**: แสดงการปรับใช้ที่กำลังทำงานหรือกำลังสร้าง นี่คือมุมมองเริ่มต้น
- **สิ้นสุดแล้ว**: แสดงการปรับใช้ที่ถูกยุติแล้ว
...
- **พาธย่อย**: โฟลเดอร์ย่อยภายในโฟลเดอร์โมเดลที่จะเมาต์แทนรากของโฟลเดอร์ คลิกที่ฟิลด์นี้เพื่อเปิดตัวเลือกไดเรกทอรี แล้วเลือกโฟลเดอร์ย่อยจากโครงสร้างไดเรกทอรีของโฟลเดอร์โมเดลที่เลือกไว้ โดยไม่สามารถพิมพ์พาธเองได้ ฟิลด์นี้จะใช้งานไม่ได้จนกว่าจะเลือก **โฟลเดอร์โมเดล** และพาธที่เลือกไว้จะถูกล้างเมื่อคุณเปลี่ยนโฟลเดอร์โมเดล พาธที่เลือกจะแสดงโดยมี `/` นำหน้า เว้นว่างไว้เพื่อเมาต์รากของโฟลเดอร์
...
การ์ด **Revisions** บนหน้ารายละเอียดการปรับใช้มีสามแท็บ ได้แก่ **Revision ปัจจุบัน**, **ประวัติ Revision** และ **บันทึกการตรวจสอบ** ปุ่ม `เพิ่ม Revision` ที่ด้านบนของการ์ดใช้งานได้จากทุกแท็บ และเปิดหน้าต่างเพิ่ม Revision (ดู [การเพิ่ม Revision](#add-revision)) ปุ่มนี้จะถูกปิดใช้งานสำหรับการปรับใช้ที่กำลังหยุดหรือไม่ได้ใช้งานอีกต่อไป และสำหรับการปรับใช้ที่อยู่ในโปรเจกต์อื่นที่ไม่ใช่โปรเจกต์ที่เลือกในปัจจุบัน ระหว่างที่ปิดใช้งาน คำแนะนำของปุ่มจะระบุเหตุผล — *"การปรับใช้กำลังหยุดหรือไม่ได้ใช้งานอีกต่อไป"* หรือ *"สลับไปยังโปรเจกต์ของการปรับใช้นี้เพื่อเพิ่ม Revision"*
...
- ปุ่ม **ปรับใช้** ถูกปิดใช้งานสำหรับ Revision ที่ใช้งานอยู่และ Revision ที่กำลังถูกปรับใช้ และยังใช้งานไม่ได้ขณะที่การปรับใช้หยุดอยู่ หรือขณะที่การปรับใช้หรือการย้อนกลับกำลังดำเนินการอยู่แล้ว

การคลิกหมายเลข Revision ในแถวใด ๆ จะเปิด drawer รายละเอียด Revision ที่แสดงการกำหนดค่าทั้งหมดของ Revision นั้น Drawer ยังมีปุ่ม **ปรับใช้** และปุ่ม **สร้าง Revision ใหม่จากนี้** ด้วย โดยปุ่ม **ปรับใช้** จะถูกปิดใช้งานภายใต้เงื่อนไขเดียวกับในตาราง
...
คลิกปุ่ม `เพิ่มกฎ` เพื่อเปิดตัวแก้ไข **เพิ่มกฎการปรับขนาดอัตโนมัติ** ปุ่มนี้จะถูกปิดใช้งานสำหรับการปรับใช้ที่กำลังหยุดหรือไม่ได้ใช้งานอีกต่อไป และสำหรับการปรับใช้ที่คุณไม่ได้เป็นเจ้าของ ระหว่างที่ปิดใช้งาน คำแนะนำของปุ่มจะระบุเหตุผล — *"การปรับใช้กำลังหยุดหรือไม่ได้ใช้งานอีกต่อไป"* หรือ *"เฉพาะเจ้าของการปรับใช้เท่านั้นที่สามารถจัดการการปรับใช้นี้ได้"*

หากต้องการแก้ไขกฎที่มีอยู่ ให้คลิกไอคอนแก้ไขในแถวนั้น ตัวแก้ไข **แก้ไขกฎการปรับขนาดอัตโนมัติ** จะเปิดขึ้นโดยมีค่าของกฎที่กรอกไว้ล่วงหน้า ตัวแก้ไขประกอบด้วยฟิลด์ต่อไปนี้ตามลำดับ:
...
![](../images/token_generation_dialog.png)
   ...
   ปุ่ม `สร้างโทเค็นการเข้าถึง` จะถูกปิดใช้งานจนกว่า manager จะออก endpoint ของเครือข่ายให้การปรับใช้นี้ ระหว่างที่ปิดใช้งาน คำแนะนำของปุ่มจะระบุว่า *"ยังไม่ได้ออก endpoint ของเครือข่าย"* ปุ่มนี้ยังถูกปิดใช้งานสำหรับการปรับใช้ที่คุณไม่ได้เป็นเจ้าของ (*"เฉพาะเจ้าของการปรับใช้เท่านั้นที่สามารถจัดการโทเค็นการเข้าถึงได้"*) และการปรับใช้ที่กำลังหยุดหรือไม่ได้ใช้งานอีกต่อไป (*"การปรับใช้กำลังหยุดหรือไม่ได้ใช้งานอีกต่อไป"*) สองเงื่อนไขหลังนี้ทำให้การลบโทเค็นถูกปิดใช้งานด้วยเช่นกัน
