...
ปุ่มรีเฟรชที่ด้านบนของรายการยังใช้ควบคุมการรีเฟรชอัตโนมัติได้ด้วย (ดูที่ [รีเฟรชอัตโนมัติ](#common-auto-refresh)) โดยรายการการปรับใช้เริ่มต้นที่ช่วงเวลา `15วิ`
...
เหตุการณ์ที่มีขั้นตอนย่อยสามารถขยายได้ โดยคลิกไอคอน `+` ที่ต้นแถวเพื่อดูตารางขั้นตอนย่อยของเหตุการณ์นั้น เมนูในส่วนหัวของคอลัมน์ขยายมีตัวเลือกการแสดงผลสามแบบ ได้แก่ ขยายทุกแถว ยุบทุกแถว หรือขยายเฉพาะแถวที่มีข้อผิดพลาด ค่าเริ่มต้นคือ **ขยายเฉพาะข้อผิดพลาด** คุณจึงเห็นรายการที่ล้มเหลว ลองใหม่ และหมดอายุได้ทันทีที่เปิดโมดอล
...
ปุ่มรีเฟรชของการ์ดเรพลิกามีตัวเลือกช่วงเวลารีเฟรชอัตโนมัติของตัวเอง (ดูที่ [รีเฟรชอัตโนมัติ](#common-auto-refresh)) เนื่องจากสถานะของเรพลิกาเปลี่ยนแปลงเร็ว การ์ดนี้จึงเริ่มต้นที่ `10วิ` และช่วงเวลาที่คุณเลือกจะถูกจดจำแยกจากค่าของรายการการปรับใช้
