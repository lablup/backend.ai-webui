...
คลิกปุ่มลิงก์ **ประวัติการจัดตาราง** ที่อยู่ถัดจากแท็กสถานะ เพื่อเปิดโมดอล **ประวัติการจัดตารางของการปรับใช้** โมดอลนี้จะเปิดแบบเต็มหน้าจอ และแสดงเหตุการณ์การจัดตารางที่บันทึกไว้สำหรับการปรับใช้นี้โดยเรียงจากใหม่ไปเก่า พร้อมแถบตัวกรองคุณสมบัติ (ID, เฟส, ผลลัพธ์, สถานะเดิม, สถานะใหม่, รหัสข้อผิดพลาด, ข้อความ, สร้างเมื่อ, อัปเดตเมื่อ) และปุ่มรีเฟรช
...
แถวสุดท้ายของตารางขั้นตอนย่อยในเฟสของการปรับใช้คือเครื่องหมายผลลัพธ์ที่มีพื้นหลังเน้นสี ซึ่งย้ำผลลัพธ์ของเฟสนั้นเองแทนที่จะเป็นงานที่ทำจริง แถวนี้ไม่มีระยะเวลา และข้อความจะแสดงว่า *"เครื่องหมายผลลัพธ์ของความพยายามนี้"* แถวที่มีเพียงเครื่องหมายนี้เป็นขั้นตอนย่อยเดียวจะขยายไม่ได้ เพราะจะเป็นการแสดงข้อมูลซ้ำกับแถวด้านบน
...
ถัดจากแท็กสถานะในคอลัมน์ **วงจรชีวิต** จะมีปุ่มไอคอนประวัติ เมื่อคลิกจะเปิดโมดอล **ประวัติการจัดตารางเวลาของ Replica** ของเรพลิกานั้น ซึ่งคุณสามารถกรองประวัติเหตุการณ์การจัดตารางของเรพลิกาได้ตามช่วงวันที่ สถานะ และอื่น ๆ โมดอลนี้จะเปิดแบบเต็มหน้าจอเช่นกัน และขยายขั้นตอนย่อยเป็นตารางแบบอินไลน์ชุดเดียวกับที่อธิบายไว้ใน [ประวัติการจัดตาราง](#scheduling-history-substeps)
