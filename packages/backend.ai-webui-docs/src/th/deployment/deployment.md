...
- **พาธย่อย**: โฟลเดอร์ย่อยภายในโฟลเดอร์โมเดลที่จะเมาต์แทนรากของโฟลเดอร์ หากเว้นว่างไว้จะเมาต์รากของโฟลเดอร์ ฟิลด์นี้จะแสดงเฉพาะเมื่อเซิร์ฟเวอร์รองรับพาธย่อยของการเมาต์
...
:::
   ...
   บนเซิร์ฟเวอร์ที่ไม่รองรับการตั้งค่าโหมดการรันคำสั่ง ฟิลด์ **การรันคำสั่ง** และ **Shell** จะไม่แสดง และส่วนนี้จะมีเพียงฟิลด์ **คำสั่งเริ่มต้น** กับ **พอร์ต** เท่านั้น ในกรณีนี้คำสั่งจะถูกรันโดยไม่ผ่าน shell จึงยังต้องครอบด้วย `/bin/bash -c "..."` อย่างชัดเจนหากต้องใช้ shell operator
