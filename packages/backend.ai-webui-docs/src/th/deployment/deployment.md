...
- **ความล่าช้าเริ่มต้น**: จำนวนวินาทีที่รอหลังจากคอนเทนเนอร์เริ่มทำงานก่อนที่จะเริ่มตรวจสอบสุขภาพครั้งแรก (ค่าเริ่มต้น: `60.0`) ให้ตั้งค่าสูงขึ้นสำหรับโมเดลขนาดใหญ่ที่ต้องใช้เวลาโหลดนาน
...
- **สถานะ Lifecycle**: ตำแหน่งของเรพลิกาใน lifecycle (เช่น *กำลังจัดเตรียม*, *กำลังทำงาน*, *กำลังสิ้นสุด*)
- **สถานะสุขภาพ**: สถานะสุขภาพปัจจุบันของกระบวนการเรพลิกา (เช่น *ปกติ*, *ผิดปกติ*)
...
- **ชื่อโมเดล**, **เส้นทางโมเดล**, **คำสั่งเริ่มต้น**, **พอร์ต**, **URL ตรวจสอบสถานะ**, **ความล่าช้าเริ่มต้น**, **จำนวนครั้งที่ลองใหม่สูงสุด**, **ช่วงเวลา (s)**, **เวลารอสูงสุด (s)**
