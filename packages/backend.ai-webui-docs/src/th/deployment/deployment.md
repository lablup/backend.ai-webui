...
**เปิดสาธารณะ** ก็ถูกกำหนดตายตัวในลักษณะเดียวกัน ในหน้าต่าง **แก้ไขการปรับใช้** ช่องทำเครื่องหมายนี้จะเป็นแบบอ่านอย่างเดียว และคำแนะนำจะระบุว่า *"ไม่สามารถเปลี่ยนการตั้งค่าการเข้าถึงสาธารณะที่เลือกไว้ตอนสร้างได้"*
:::
...
# ระดับรูท — ค่าเริ่มต้นสำหรับรันไทม์แวเรียนต์ทั้งหมด
environment:
...
# แวเรียนต์ vLLM — เขียนทับเฉพาะฟิลด์ที่ระบุไว้เท่านั้น
vllm:
  environment:
...
- **โหมดคลัสเตอร์**: รูปแบบการจัดกลุ่มของเซสชันการคำนวณของแต่ละเรพลิกา (โหมด / ขนาด)
