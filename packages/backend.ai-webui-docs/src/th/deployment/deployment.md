...
คลิกปุ่ม `สร้างการปรับใช้` ที่มุมขวาบนของส่วนหัวการ์ด **การปรับใช้** เพื่อเปิดหน้าต่าง **สร้างการปรับใช้**
...
ในหน้าการปรับใช้ ให้คลิกปุ่ม `สร้างการปรับใช้` ที่มุมขวาบนของส่วนหัวการ์ด **การปรับใช้** เพื่อเปิดหน้าต่าง **สร้างการปรับใช้** หน้าต่างนี้รับเฉพาะเมตาดาตาระดับการปรับใช้เท่านั้น และจะยังไม่มีการสร้าง Revision ในขั้นตอนนี้
