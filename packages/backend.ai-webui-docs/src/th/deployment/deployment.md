...
- **พาธย่อย**: โฟลเดอร์ย่อยภายในโฟลเดอร์โมเดลที่จะเมาต์แทนรากของโฟลเดอร์ ไม่สามารถพิมพ์พาธได้โดยตรง ให้เลือก **โฟลเดอร์โมเดล** ก่อน (ฟิลด์นี้จะถูกปิดใช้งานจนกว่าคุณจะเลือก) จากนั้นคลิกที่ฟิลด์เพื่อเรียกดูไดเรกทอรีภายในโฟลเดอร์ แล้วคลิก **เลือกตำแหน่งนี้** เพื่อกำหนดพาธ พาธที่เลือกจะแสดงโดยมี `/` นำหน้า ดังนั้นรากของโฟลเดอร์จะแสดงเป็น `/` หากเปลี่ยน **โฟลเดอร์โมเดล** พาธย่อยที่เลือกไว้แล้วจะถูกล้าง หากเว้นว่างไว้จะเมาต์รากของโฟลเดอร์
