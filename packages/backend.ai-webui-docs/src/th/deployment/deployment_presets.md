...
หน้าการปรับใช้ของผู้ดูแลระบบมีหลายแท็บ ได้แก่ **การปรับใช้**, **การจัดการร้านค้าโมเดล**, **Prometheus Preset** และ **ค่าตั้งล่วงหน้าการปรับใช้** แต่ละแท็บจะเก็บตัวกรอง ลำดับการเรียง และหมายเลขหน้าของตนเองไว้ ดังนั้นเมื่อสลับไปแท็บอื่นแล้วกลับมา แท็บพรีเซ็ตการดีพลอยจะกลับสู่สภาพเดิมที่คุณทิ้งไว้
