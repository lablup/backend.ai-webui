...
:::tip
หากฟิลด์ที่จำเป็นว่างเปล่าหรือมีค่าที่ไม่ถูกต้อง ปุ่มยืนยันในขั้นตอนการทบทวนจะยังคงถูกปิดใช้งานจนกว่าจะแก้ไขข้อผิดพลาด และการ์ดที่มีฟิลด์ดังกล่าวจะถูกตีกรอบสีแดงพร้อมไอคอนข้อผิดพลาดข้าง ๆ ลิงก์ **แก้ไข** ในส่วนหัวของการ์ด รายการขั้นตอนทางด้านขวายังทำเครื่องหมายทุกขั้นตอนที่มีข้อผิดพลาด รวมถึงข้อผิดพลาดในฟิลด์ของขั้นตอนที่คุณผ่านไปแล้วด้วย ฟิลด์ที่จำเป็นจะแสดงข้อความตรวจสอบความถูกต้องในตำแหน่งของฟิลด์ขณะที่คุณพิมพ์
:::
