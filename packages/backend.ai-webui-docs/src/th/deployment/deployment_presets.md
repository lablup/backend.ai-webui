...
หน้าการปรับใช้ของผู้ดูแลระบบมีหลายแท็บ ได้แก่ **การปรับใช้**, **การจัดการร้านค้าโมเดล**, **Prometheus Preset** และ **ค่าตั้งล่วงหน้าการปรับใช้** ตัวกรอง ลำดับการเรียง และหมายเลขหน้าของแต่ละแท็บจะถูกเก็บไว้ใน URL ซึ่งให้ประโยชน์สองข้อ:

- เมื่อสลับไปแท็บอื่นแล้วกลับมา แท็บพรีเซ็ตการดีพลอยจะกลับสู่สภาพเดิมที่คุณทิ้งไว้
- คุณสามารถบุ๊กมาร์กหรือแชร์ URL ของรายการพรีเซ็ตที่กรองไว้ได้ และผู้รับจะเปิดมาที่ตัวกรอง ลำดับการเรียง และหน้าเดียวกัน
