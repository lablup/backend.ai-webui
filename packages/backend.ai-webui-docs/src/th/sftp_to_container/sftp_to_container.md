...
name `id_container.ppk__PROTECTED_22__id_container.ppk__PROTECTED_23__id_container__PROTECTED_24__/home/work/__PROTECTED_25__~/.ssh/config__PROTECTED_26__C:\Users\[ผู้ใช้ name]\.ssh\config` (for Windows) and add the following block.
