...
<!-- TODO: ถ่ายภาพหน้าจอใหม่ของโมดอลเพิ่มสิทธิ์ที่แสดงชื่อเป้าหมายของขอบเขตที่ได้รับการแปลและป้ายกำกับประเภทสิทธิ์ที่แปลแล้ว (แทนที่ rbac_add_permission_modal.png) -->
...
1. ในแท็บ **การมอบหมายบทบาท** คลิกปุ่ม**เพิกถอนผู้ใช้**ถัดจากผู้ใช้ที่ต้องการเพิกถอน
2. ป๊อปอัปยืนยันขนาดเล็กจะปรากฏแนบกับปุ่ม คลิก **ตกลง** เพื่อเพิกถอนการมอบหมาย หรือ **ยกเลิก** เพื่อปิด

![](../images/rbac_revoke_popconfirm.png)
<!-- TODO: ถ่ายภาพหน้าจอของการยืนยันการเพิกถอนแบบป๊อปอัปที่แนบกับปุ่มเพิกถอนผู้ใช้ -->

การเพิกถอนผู้ใช้จะลบเฉพาะการมอบหมายของผู้ใช้นั้นกับบทบาทนี้เท่านั้น บทบาทและการมอบหมายอื่น ๆ ยังคงอยู่ และสามารถเพิ่มผู้ใช้กลับเข้ามาได้จาก **เพิ่มผู้ใช้** เมื่อใดก็ได้ เนื่องจากการดำเนินการนี้สามารถย้อนกลับได้ จึงใช้ป๊อปอัปยืนยันแบบเบาแทนการยืนยันด้วยการพิมพ์ชื่อ
