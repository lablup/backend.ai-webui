...
- **ตัวกรองคุณสมบัติ**: ตัวกรองคุณสมบัติสำหรับจำกัดรายการ ช่องป้อนค่าของตัวกรองจะปรับเปลี่ยนตามคุณสมบัติที่เลือก มีคุณสมบัติต่อไปนี้ให้ใช้:
   ...
   * **รหัสขอบเขต**: กรองรายการด้วย UUID ขอบเขตที่ตรงกันทุกตัวอักษร
...
- **ประเภทขอบเขต**: ประเภทของขอบเขตที่กำหนดให้กับบทบาท แสดงพร้อมกับชื่อขอบเขต
- **รหัสขอบเขต**: ID ดั้งเดิมของขอบเขตที่กำหนดให้กับบทบาท
...
บทบาทหนึ่งจะผูกกับขอบเขตเพียงหนึ่งรายการเท่านั้น หากคุณเชื่อมต่อกับ manager เวอร์ชันก่อน 26.9 ซึ่งบทบาทหนึ่งสามารถมีหลายขอบเขตได้ คอลัมน์ **ประเภทขอบเขต** และ **รหัสขอบเขต** จะแสดงขอบเขตแรกพร้อมกับ `+N` สำหรับจำนวนที่เหลือ
...
- **กำหนดเอง**: บทบาทที่สร้างโดยผู้ดูแลระบบระดับสูง สามารถแก้ไขชื่อ คำอธิบาย การมอบหมายผู้ใช้ และสิทธิ์ได้ทั้งหมด

## การสร้างบทบาท

ในการสร้างบทบาท คุณต้องกำหนด**ขอบเขต**ล่วงหน้า ขอบเขตจะผูกบทบาทเข้ากับเอนทิตีทรัพยากรที่ระบุ (เช่น โดเมน โปรเจกต์ หรือผู้ใช้) เพื่อให้สิทธิ์ทุกข้อที่เพิ่มในภายหลังถูกจำกัดให้อยู่ภายในขอบเขตที่กำหนดไว้ที่นี่เท่านั้น บทบาทหนึ่งกำหนดขอบเขตได้เพียงหนึ่งรายการ
...
2. ในโมดอลการสร้าง ให้กรอกฟิลด์ต่อไปนี้:
   ...
   - **ประเภทขอบเขต** (จำเป็น): เลือกประเภทขอบเขตที่บทบาทจะมีผล (เช่น โดเมน, โปรเจกต์, หรือผู้ใช้)
   - **เป้าหมาย** (จำเป็น): เลือกเป้าหมายเฉพาะภายในประเภทขอบเขตนั้น บทบาทหนึ่งจะผูกกับขอบเขตเพียงหนึ่งรายการเท่านั้น
3. คลิก **ตกลง** เพื่อสร้างบทบาท

![](../images/rbac_create_role_modal.png)

:::info
**ประเภทขอบเขต**และ**เป้าหมาย**ที่คุณกำหนดเมื่อสร้างบทบาทจะไม่ให้สิทธิ์ใด ๆ ด้วยตัวมันเอง แต่จะกำหนดล่วงหน้าว่า**ประเภทขอบเขต / เป้าหมาย**ใดที่สามารถใช้ได้เมื่อคุณเพิ่ม[สิทธิ์](#manage-permissions)ให้กับบทบาทนี้ในภายหลัง กล่าวคือ ขั้นตอนการสร้างบทบาทเป็นเพียงการจำกัดประเภทขอบเขตและเป้าหมายที่สิทธิ์ของบทบาทนี้สามารถใช้ได้ไว้ล่วงหน้า และสิทธิ์แต่ละข้อจะตั้งค่าได้เฉพาะภายในประเภทขอบเขตและเป้าหมายที่กำหนดไว้ที่นี่เท่านั้น
:::
...
:::info
การรวม **ประเภทขอบเขต / เป้าหมาย** ของแต่ละสิทธิ์ได้รับการสืบทอดมาจากขอบเขตของบทบาท คุณสามารถมอบสิทธิ์ได้เฉพาะบนขอบเขตที่กำหนดไว้เมื่อสร้างบทบาทเท่านั้น หากต้องการขยายการเข้าถึงของบทบาท ให้สร้างบทบาทอีกบทบาทหนึ่งพร้อมกับขอบเขตที่ต้องการ
:::
