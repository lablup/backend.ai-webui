...
2. ในโมดอลการสร้าง ให้กรอกฟิลด์ต่อไปนี้:
   ...
   - **โปรเจกต์** (ไม่บังคับ): เลือกโปรเจกต์ที่จะใช้สิทธิ์ของบทบาท จำเป็นเฉพาะเมื่อต้องการกำหนดขอบเขตสิทธิ์ให้กับโปรเจกต์เฉพาะเท่านั้น
3. คลิก **ตกลง** เพื่อสร้างบทบาท

:::info
ในเวอร์ชันอนาคต ตัวเลือกโปรเจกต์จะถูกลบออกจากโมดอลการสร้างบทบาท สิทธิ์ที่กำหนดขอบเขตโปรเจกต์จะสามารถกำหนดค่าได้โดยตรงในการตั้งค่าสิทธิ์โดยไม่ต้องเลือกโปรเจกต์ระหว่างการสร้างบทบาท
:::
...
ต่อไปนี้คือตัวอย่างการตั้งค่าสิทธิ์ทั่วไปเพื่อช่วยให้คุณเข้าใจว่าองค์ประกอบทั้งสี่ทำงานร่วมกันอย่างไร:
