...
1. ในแท็บ **การมอบหมายบทบาท** คลิกปุ่มไอคอนเพิกถอน (ถังขยะ) ถัดจากผู้ใช้ที่ต้องการนำออก
2. โมดอลยืนยัน **นำผู้ใช้ออกจากบทบาท** จะเปิดขึ้น คุณต้องพิมพ์ **`ลบถาวร`** ในช่องป้อนข้อมูลให้ตรงกับที่แสดงทุกตัวอักษร ปุ่ม **นำผู้ใช้ออกจากบทบาท** จะยังถูกปิดใช้งานจนกว่าข้อความที่พิมพ์จะตรงกัน คลิก **นำผู้ใช้ออกจากบทบาท** เพื่อยืนยัน หรือ **ยกเลิก** เพื่อปิด
...
:::danger
การเพิกถอนผู้ใช้จากบทบาทไม่สามารถยกเลิกได้ โมดอลยืนยันกำหนดให้คุณพิมพ์ `ลบถาวร` ก่อนที่ปุ่ม **นำผู้ใช้ออกจากบทบาท** จะเปิดใช้งาน
:::
