...
กล่องโต้ตอบที่เปิดขึ้นจะขึ้นอยู่กับเวอร์ชันของเซิร์ฟเวอร์ บนเซิร์ฟเวอร์
เวอร์ชันเก่า กล่องโต้ตอบ **ข้อมูลคู่คีย์ของฉัน** จะแสดงตารางแบบอ่านอย่างเดียว
ที่มีคีย์การเข้าถึงและรหัสลับ พร้อมปุ่ม **ปิด** คีย์การเข้าถึงหลักของคุณจะ
ถูกทำเครื่องหมายด้วยป้าย **คีย์การเข้าถึงหลัก**

![](../images/my_keypair_information.png)

บนเซิร์ฟเวอร์ที่รองรับการจัดการคู่คีย์ การคลิกปุ่ม Config จะเปิดกล่องโต้ตอบ
**การจัดการคีย์คู่ของฉัน** แบบเต็มที่อธิบายไว้ด้านล่างแทน

<a id="my-keypair-management"></a>

### การจัดการคีย์คู่ของฉัน

บนเซิร์ฟเวอร์ที่รองรับการจัดการคู่คีย์ ปุ่ม Config จะเปิดกล่องโต้ตอบ
**การจัดการคีย์คู่ของฉัน** จากที่นี่ คุณสามารถถือครองคู่คีย์หลายคู่พร้อมกัน
ออกคู่คีย์ใหม่ เลือกว่าคู่คีย์ใดเป็นคีย์การเข้าถึงหลักของคุณ และปิดใช้งาน
คืนค่า หรือลบคู่คีย์อย่างถาวร
