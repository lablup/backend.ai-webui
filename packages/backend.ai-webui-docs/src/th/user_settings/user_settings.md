...
กล่องโต้ตอบการตั้งค่าผู้ใช้ช่วยให้คุณปรับแต่งประสบการณ์การใช้งาน Backend.AI
WebUI ได้ คุณสามารถเปิดได้โดยคลิกที่ไอคอนคนที่มุมขวาบนและเลือกเมนูการตั้งค่า
กล่องจะเปิดทับหน้าที่คุณกำลังดูอยู่ ดังนั้นเมื่อปิดคุณจะกลับมาที่เดิม
...
บนหน้าจอแคบ รายการจะเต็มกล่อง และเมื่อเลือกหมวดหนึ่งจะเปิดหมวดนั้นขึ้นมา
พร้อมปุ่มย้อนกลับเพื่อกลับไปที่รายการ
...
หมวดทั่วไปประกอบด้วยรายการตั้งค่าทั้งหมดที่จัดกลุ่มเป็น **การตั้งค่า**,
**สภาพแวดล้อมเชลล์** และ **คุณสมบัติการทดลอง** ทุกกลุ่มจะแสดงต่อกันไป
ใช้แถบค้นหาเพื่อจำกัดรายการให้เหลือเฉพาะการตั้งค่าที่คุณกำลังมองหา
...
session ของ Backend.AI โดยใช้คีย์ของคุณเองได้ หากเซิร์ฟเวอร์ปฏิเสธคีย์
(เช่น คีย์มีรูปแบบไม่ถูกต้อง หรือคีย์สาธารณะกับคีย์ส่วนตัวไม่ตรงกัน)
...
- **เอเจนต์ AI**: เปิดใช้งานฟีเจอร์เอเจนต์ AI ซึ่งให้ความสามารถ AI แบบ
  ...
  ในเซสชันของคุณ
- **แผงแดชบอร์ดที่กำหนดเอง**: ให้คุณเพิ่มแผงที่กำหนดเองของคุณเองลงในหน้า
  แดชบอร์ดได้ แต่ละแผงจะแสดงแหล่งข้อมูลที่คุณเลือก ซึ่งถูกกรองด้วยเงื่อนไข
  ที่คุณกำหนด แผงเหล่านี้จะแสดงเฉพาะเมื่อเปิดใช้งานฟีเจอร์นี้เท่านั้น
  หากปิดใช้งานในภายหลัง แผงของคุณจะถูกซ่อนไว้โดยไม่ถูกลบ และจะกลับมาเหมือนเดิม
  เมื่อเปิดใช้งานอีกครั้ง ดูวิธีเพิ่มและจัดการแผงได้ที่หัวข้อ
  [แผงที่กำหนดเอง](#custom-panels)
- **แผงคำสั่ง**: เพิ่มปุ่ม **ค้นหา** ในส่วนหัว และเปิดใช้งานคีย์ลัด `Ctrl+K`
  (`⌘K` บน macOS) ซึ่งทั้งสองอย่างจะเปิดแผงสำหรับค้นหาหน้า แท็บของหน้า
  และรายการตั้งค่า นอกจากนี้แผงยังมีการดำเนินการด่วน เช่น การสลับระหว่าง
  โหมดมืดและโหมดสว่าง การเปลี่ยนภาษาของ UI การเปิดการแจ้งเตือน
  การเปิด/ปิดแถบด้านข้าง และการเปิดคู่มือของหน้าปัจจุบัน ปุ่มและคีย์ลัดนี้
  จะใช้งานได้เฉพาะเมื่อเปิดใช้งานฟีเจอร์นี้เท่านั้น ดูรายละเอียดได้ที่หัวข้อ
  [ค้นหา](#search)
...
- **มุมมองกริดทรัพยากรเซสชัน**: เพิ่มปุ่มสลับ **โหมดมุมมอง** ระหว่าง
  **ตาราง** และ **กริด** เหนือรายการเซสชันในหน้าเซสชัน หน้า Admin Session
  และแท็บ **เซสชัน** ของแผง **ข้อมูลเอเจนต์** ในหน้าทรัพยากร
  เมื่อเลือก **กริด** ระบบจะแสดงเซลล์หนึ่งเซลล์ต่อหนึ่งเซสชันแทนตาราง
  โดยสีของเซลล์แสดงอัตราการใช้ทรัพยากรแบบเรียลไทม์ของเซสชันนั้น
  ปุ่มสลับนี้จะปรากฏเฉพาะเมื่อเปิดใช้งานฟีเจอร์นี้เท่านั้น
  สำหรับตัวควบคุมของกริดเอง ดูที่
...
แสดงข้อมูลรายละเอียดของบันทึกต่างๆ ที่บันทึกไว้ในฝั่งไคลเอนต์ เปิดหมวดนี้
เพื่อหาข้อมูลเพิ่มเติมเกี่ยวกับข้อผิดพลาดที่เกิดขึ้น
...
อย่างถูกต้อง บันทึกเป็นการรวมคำขอไปยังเซิร์ฟเวอร์และการตอบสนองจาก
เซิร์ฟเวอร์ และหน้าที่อยู่หลังกล่องโต้ตอบนี้จะไม่ส่งคำขอใดๆ ขณะที่คุณ
กำลังอ่านบันทึกอยู่ หากต้องการตรวจสอบว่าบันทึกกำลังถูกจัดเรียงอย่างถูกต้อง
ให้ปิดกล่องโต้ตอบ ทำอะไรสักอย่างในหน้าอื่น แล้วเปิด **บันทึก** อีกครั้ง
:::
...
หมวดเซสชันเข้าสู่ระบบจะแสดงรายการเซสชันเข้าสู่ระบบที่เชื่อมโยงกับบัญชีของคุณ
อยู่ในขณะนี้ โดยมีหนึ่งรายการสำหรับทุกที่ที่คุณลงชื่อเข้าใช้ Backend.AI
ใช้หมวดนี้เพื่อตรวจสอบว่าบัญชีของคุณถูกใช้งานที่ใดบ้าง
...
หมวดประวัติการเข้าสู่ระบบจะแสดงความพยายามเข้าสู่ระบบที่บันทึกไว้สำหรับบัญชี
...
หมวดนี้เป็นแบบอ่านอย่างเดียว และไม่มีการดำเนินการใดๆ บนแถว
...
- **IP ของไคลเอ็นต์**: ที่อยู่ IP ที่ใช้ในการพยายามเข้าสู่ระบบ แสดงตามที่เซิร์ฟเวอร์รายงานทุกประการ
  ที่อยู่อาจถูกปิดบังบางส่วนตามนโยบายการปิดบัง IP ของไคลเอ็นต์ที่ผู้ดูแลระบบกำหนด
  และจะแสดงเป็น `-` หากไม่มีการบันทึก
