...
(เช่น คีย์มีรูปแบบไม่ถูกต้อง) ระบบจะแสดงข้อความแสดงข้อผิดพลาดที่เซิร์ฟเวอร์
ส่งกลับมา และกล่องโต้ตอบจะยังคงเปิดอยู่เพื่อให้คุณแก้ไขข้อมูลที่ป้อนได้
...
- **แผงคำสั่ง**: เพิ่มปุ่ม **ค้นหา** ในส่วนหัว และเปิดใช้งานคีย์ลัด `Ctrl+K`
  ...
  จะใช้งานได้เฉพาะเมื่อเปิดใช้งานฟีเจอร์นี้เท่านั้น
