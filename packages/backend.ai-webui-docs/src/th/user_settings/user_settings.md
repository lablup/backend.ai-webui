...
- **แผงแดชบอร์ดที่กำหนดเอง**: ให้คุณเพิ่มแผงที่กำหนดเองของคุณเองลงในหน้า
  แดชบอร์ดได้ แต่ละแผงคือตารางของทรัพยากรที่คุณเลือก ซึ่งถูกกรองด้วยเงื่อนไข
...
- **มุมมองกริดทรัพยากรเซสชัน** (ยังไม่ได้แปลใน UI ภาษาไทย จึงแสดงเป็น
  `__NOT_TRANSLATED__`): เพิ่มปุ่มสลับโหมดการแสดงผล (**View mode**) ระหว่าง
  **Table** และ **Grid** เหนือรายการเซสชันในหน้าเซสชันและหน้า Admin Session
  เมื่อเลือก **Grid** ระบบจะแสดงเซลล์หนึ่งเซลล์ต่อหนึ่งเซสชันแทนตาราง
