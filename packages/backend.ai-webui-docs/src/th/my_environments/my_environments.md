...
[session commits](#save-session-commit) ของผู้ใช้
...
คุณยังสามารถคัดลอกชื่อภาพและสร้างเซสชันด้วยภาพแบบแมนนวล คลิกไอคอนคัดลอกข้างชื่อภาพในคอลัมน์ Full Image Path เพื่อคัดลอกไปยังคลิปบอร์ด จากนั้นไปที่หน้าเซสชันและสร้างเซสชัน กรอกข้อมูลในช่องป้อนภาพแบบแมนนวลโดยการวางชื่อภาพที่คุณคัดลอกไว้
