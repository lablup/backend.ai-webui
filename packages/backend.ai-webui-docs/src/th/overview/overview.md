...
- `wsproxy` ท้องถิ่น: เซิร์ฟเวอร์พร็อกซีที่สร้างขึ้นในแอป Web-UI `wsproxy` ท้องถิ่นจะแปลงคำขอ HTTP ทั่วไประหว่างเซิร์ฟเวอร์กับแอป Web-UI เป็น websocket และส่งข้อความไปยังกันและกัน หากแอป Web-UI สูญเสียการเชื่อมต่อกับ `wsproxy` หรือเซิร์ฟเวอร์ `wsproxy` หยุดทำงาน จะไม่สามารถเข้าถึงบริการต่างๆ เช่น Jupyter Notebook และ Terminal ได้ ใน WebUI องค์ประกอบนี้ปรากฏในชื่อ **App Proxy** (ชื่อเดิม WSProxy)
