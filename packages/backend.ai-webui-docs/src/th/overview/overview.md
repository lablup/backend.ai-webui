...
- Web `wsproxy`: ในกรณีของ WebUI ที่จัดเตรียมไว้ในเว็บ เซิร์ฟเวอร์ที่ติดตั้งมายังไม่สามารถใช้งานได้เนื่องจากธรรมชาติของเบราว์เซอร์ ในกรณีนี้ คุณสามารถใช้บริการต่าง ๆ เช่น Jupyter Notebook, Terminal, ฯลฯ ในสภาพแวดล้อมเว็บโดยการทำให้เซิร์ฟเวอร์ `wsproxy` เป็นเซิร์ฟเวอร์เว็บแยกที่สามารถทำให้แอป WebUI มองเห็นเว็บ `wsproxy` ได้
