...
- เมื่อทั้งสองค่าต่างกัน จะแสดงจำนวนที่จัดสรรตามด้วยจำนวนที่ร้องขอด้วยสีจาง โดยใช้หน่วยร่วมกันเพียงหน่วยเดียว เช่น `0.0 / 0.5 fGPU` เมื่อวางเมาส์เหนือตัวเลขจะแสดงคำแนะนำ **ที่จัดสรร / ที่ร้องขอ**
