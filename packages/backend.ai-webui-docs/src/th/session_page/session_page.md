...
การส่งออกนี้ใช้ได้กับผู้ใช้ทุกคน ไม่ใช่เฉพาะผู้ดูแลระบบ โดยผู้ใช้แต่ละคนสามารถส่งออกประวัติเซสชันของตนเองได้
การส่งออก CSV จากหน้าเซสชันส่วนตัวจะรวมเฉพาะเซสชันของคุณเองเสมอ
:::
