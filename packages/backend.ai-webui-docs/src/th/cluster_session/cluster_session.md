...
# เซสชันการคำนวณคลัสเตอร์ Backend.AI

<a id="backendai-cluster-compute-session"></a>

### ภาพรวมของเซสชันการคำนวณคลัสเตอร์ Backend.AI

Backend.AI รองรับเซสชันการคำนวณคลัสเตอร์เพื่อสนับสนุนงานคำนวณ/การฝึกสอนแบบกระจาย เซสชันคลัสเตอร์ประกอบด้วยคอนเทนเนอร์หลายรายการ ซึ่งแต่ละรายการจะถูกสร้างข้ามโหนดกายภาพหลายโหนด คอนเทนเนอร์ภายใต้เซสชันคลัสเตอร์จะเชื่อมต่อกันโดยอัตโนมัติผ่านเครือข่ายส่วนตัวที่ถูกสร้างขึ้นแบบไดนามิก นอกจากนี้ยังมีการกำหนดชื่อโดเมนชั่วคราว (`main1`, `sub1`, `sub2` ฯลฯ) ให้ด้วย ทำให้การทำงานด้านเครือข่าย เช่น การเชื่อมต่อ SSH เป็นเรื่องง่าย คีย์ลับและการตั้งค่าต่าง ๆ ที่จำเป็นสำหรับการเชื่อมต่อ SSH ระหว่างคอนเทนเนอร์จะถูกสร้างขึ้นโดยอัตโนมัติ

สำหรับรายละเอียดเกี่ยวกับเซสชันของคลัสเตอร์ Backend.AI โปรดดูที่ด้านล่างนี้

![](../images/overview_cluster_session.png)

- คอนเทนเนอร์ภายใต้เซสชันคลัสเตอร์จะถูกสร้างขึ้นข้ามโหนดกายภาพหนึ่งหรือหลายโหนดที่สังกัดอยู่ในกลุ่มทรัพยากร
...
- ทุกคอนเทนเนอร์ภายใต้เซสชันคลัสเตอร์จะทำการเชื่อมต่อโฟลเดอร์จัดเก็บเดียวกันที่กำหนดไว้เมื่อสร้างเซสชันการคำนวณ
...
- มีสองโหมด/ประเภทของเซสชันคลัสเตอร์
   ...
   * เซสชันคลัสเตอร์แบบโหนดเดียว: เซสชันคลัสเตอร์ที่ประกอบด้วยสองหรือมากกว่าคอนเทนเนอร์บนโหนดกายภาพเดียวกัน ในภาพด้านบน นี่คือเซสชัน Z ซึ่งถูกผูกกับเครือข่ายสะพานท้องถิ่น
   * เซสชันคลัสเตอร์หลายโหนด: เซสชันคลัสเตอร์ที่ประกอบด้วยสองหรือมากกว่าคอนเทนเนอร์ต่างโหนดกายภาพ ในภาพด้านบน นี่คือเซสชัน X ซึ่งผูกติดกับเครือข่ายแบบโอเวอร์เลย์
   * เซสชันการคำนวณที่มีเพียงหนึ่งคอนเทนเนอร์จะถูกจำแนกเป็นเซสชันคอมพิวเตอร์ปกติ ไม่ใช่เซสชันคลัสเตอร์ ในรูปด้านบน เซสชันนี้คือเซสชัน Y.
...
### การใช้เซสชันการคำนวณของคลัสเตอร์ Backend.AI

ในส่วนนี้ เราจะดูว่าจริง ๆ แล้วจะสร้างและใช้เซสชันการคำนวณคลัสเตอร์ผ่าน GUI ของผู้ใช้ได้อย่างไร

ในหน้าสมาชิก ให้เปิดกล่องสร้างเซสชันและตั้งค่าในลักษณะเดียวกับการสร้างเซสชันการคำนวณปกติ จำนวนทรัพยากรที่ตั้งค่าในครั้งนี้คือจำนวนที่จัดสรรให้กับ **หนึ่งคอนเทนเนอร์** ตัวอย่างเช่น หากคุณตั้งค่า 4 CPUs จะมีการจัดสรร 4 คอร์ให้กับแต่ละคอนเทนเนอร์ภายใต้เซสชันคลัสเตอร์ โปรดทราบว่านี่ไม่ใช่จำนวนทรัพยากรที่จัดสรรให้กับเซสชันการคำนวณคลัสเตอร์ทั้งหมด สำหรับการสร้างเซสชันการคำนวณคลัสเตอร์ ต้องการทรัพยากรเซิร์ฟเวอร์เท่ากับ N เท่าของจำนวนทรัพยากรที่ตั้งค่าไว้ที่นี่ (N คือขนาดของคลัสเตอร์) นอกจากนี้ยังอย่าลืมเชื่อมต่อโฟลเดอร์จัดเก็บสำหรับการเก็บรักษาข้อมูลอีกด้วย

![](../images/session_launch_dialog.png)

ในฟิลด์ "โหมดคลัสเตอร์" ที่ด้านล่าง คุณสามารถเลือกประเภทของคลัสเตอร์ที่คุณต้องการสร้างได้

- โหนดเดียว (Single Node): คอนเทนเนอร์ทั้งหมดจะถูกสร้างขึ้นบนโหนดกายภาพเดียว
- หลายโหนด (Multi Node): คอนเทนเนอร์จะถูกสร้างขึ้นกระจายไปทั่วโหนดกายภาพหลายโหนดภายในกลุ่มทรัพยากร อย่างไรก็ตาม หากคอนเทนเนอร์ทั้งหมดสามารถสร้างขึ้นในโหนดกายภาพเดียวได้ คอนเทนเนอร์ทั้งหมดจะถูกสร้างในโหนดนั้น ทั้งนี้เพื่อลดความหน่วงของเครือข่ายระหว่างคอนเทนเนอร์ให้น้อยที่สุด
