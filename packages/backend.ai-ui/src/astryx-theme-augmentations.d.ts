/**
 ...
 (`STATUS_TEXT_COLORS`, `LINK_BUTTON_VARIANT`) — that module is the source of
 truth; this file only restates its `color:*` / `variant:*` keys for the type
 system. `backendAiTheme.test.ts` covers the theme side; a drift here surfaces
 as a `tsc` error at the call site, which is the intended failure mode.
*/
...
declare module '@astryxdesign/core/Button' {
  interface ButtonVariantMap {
    /** antd `Button type="link"` — accent text, no hover box, no button box. */
    link: true;
  }
}
