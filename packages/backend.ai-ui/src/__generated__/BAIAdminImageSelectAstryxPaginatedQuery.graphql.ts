/**
 * @generated SignedSource<<f68e96e2cd2d2087c28ad5b911e13fa1>>
...
export type BAIAdminImageSelectAstryxPaginatedQuery$variables = {
  filter?: ImageV2Filter | null | undefined;
  limit: number;
  offset: number;
};
export type BAIAdminImageSelectAstryxPaginatedQuery$data = {
...
export type BAIAdminImageSelectAstryxPaginatedQuery = {
  response: BAIAdminImageSelectAstryxPaginatedQuery$data;
  variables: BAIAdminImageSelectAstryxPaginatedQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "BAIAdminImageSelectAstryxPaginatedQuery",
    "selections": (v3/*: any*/),
    "type": "Query",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "b69dddfd91283f330a57b338d27a6931",
    "id": null,
    "metadata": {},
    "name": "BAIAdminImageSelectAstryxPaginatedQuery",
    "operationKind": "query",
    "text": "query BAIAdminImageSelectAstryxPaginatedQuery(\n  $offset: Int!\n  $limit: Int!\n  $filter: ImageV2Filter\n) {\n  adminImagesV2(offset: $offset, limit: $limit, filter: $filter, orderBy: [{field: NAME, direction: ASC}]) {\n    count\n    edges {\n      node {\n        id\n        identity {\n          canonicalName\n          architecture\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "53c09b9cccaf389c6e58611434b6cfce";
