/**
 * @generated SignedSource<<4e5e90a1f903ce43d41559238c0b9562>>
...
export type BAIAdminSessionSelectAstryxPaginatedQuery$variables = {
  filter?: SessionV2Filter | null | undefined;
  limit: number;
  offset: number;
};
export type BAIAdminSessionSelectAstryxPaginatedQuery$data = {
...
export type BAIAdminSessionSelectAstryxPaginatedQuery = {
  response: BAIAdminSessionSelectAstryxPaginatedQuery$data;
  variables: BAIAdminSessionSelectAstryxPaginatedQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "BAIAdminSessionSelectAstryxPaginatedQuery",
    "selections": (v3/*: any*/),
    "type": "Query",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "c9d946a96ca07bdc58fa7a5f34f7adc9",
    "id": null,
    "metadata": {},
    "name": "BAIAdminSessionSelectAstryxPaginatedQuery",
    "operationKind": "query",
    "text": "query BAIAdminSessionSelectAstryxPaginatedQuery(\n  $offset: Int!\n  $limit: Int!\n  $filter: SessionV2Filter\n) {\n  adminSessionsV2(offset: $offset, limit: $limit, filter: $filter) {\n    count\n    edges {\n      node {\n        id\n        metadata {\n          name\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "2204e530a55476de983280942403cae6";
