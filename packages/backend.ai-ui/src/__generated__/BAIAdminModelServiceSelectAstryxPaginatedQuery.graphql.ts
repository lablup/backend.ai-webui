/**
 * @generated SignedSource<<1904f64c2ea1a626455217f27dfda3db>>
...
export type BAIAdminModelServiceSelectAstryxPaginatedQuery$variables = {
  filter?: DeploymentFilter | null | undefined;
  limit: number;
  offset: number;
};
export type BAIAdminModelServiceSelectAstryxPaginatedQuery$data = {
...
export type BAIAdminModelServiceSelectAstryxPaginatedQuery = {
  response: BAIAdminModelServiceSelectAstryxPaginatedQuery$data;
  variables: BAIAdminModelServiceSelectAstryxPaginatedQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "BAIAdminModelServiceSelectAstryxPaginatedQuery",
    "selections": (v3/*: any*/),
    "type": "Query",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "c332be59699d5764f18dabe7dd24e881",
    "id": null,
    "metadata": {},
    "name": "BAIAdminModelServiceSelectAstryxPaginatedQuery",
    "operationKind": "query",
    "text": "query BAIAdminModelServiceSelectAstryxPaginatedQuery(\n  $offset: Int!\n  $limit: Int!\n  $filter: DeploymentFilter\n) {\n  adminDeployments(offset: $offset, limit: $limit, filter: $filter) {\n    count\n    edges {\n      node {\n        id\n        metadata {\n          name\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "7c83569120087bdc376d1d45f77ebace";
