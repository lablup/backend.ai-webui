/**
 * @generated SignedSource<<d6fdf257997b9dda71cc6978d22f5966>>
...
export type BAIProjectVfolderSelectAstryxPaginatedQuery$variables = {
  filter?: VFolderFilter | null | undefined;
  limit: number;
  offset: number;
  projectId: string;
};
export type BAIProjectVfolderSelectAstryxPaginatedQuery$data = {
...
export type BAIProjectVfolderSelectAstryxPaginatedQuery = {
  response: BAIProjectVfolderSelectAstryxPaginatedQuery$data;
  variables: BAIProjectVfolderSelectAstryxPaginatedQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "BAIProjectVfolderSelectAstryxPaginatedQuery",
    "selections": (v4/*: any*/),
    "type": "Query",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "8283c757f10cc1f44bc45cb5f6808304",
    "id": null,
    "metadata": {},
    "name": "BAIProjectVfolderSelectAstryxPaginatedQuery",
    "operationKind": "query",
    "text": "query BAIProjectVfolderSelectAstryxPaginatedQuery(\n  $offset: Int!\n  $limit: Int!\n  $projectId: UUID!\n  $filter: VFolderFilter\n) {\n  projectVfolders(projectId: $projectId, offset: $offset, limit: $limit, filter: $filter, orderBy: [{field: CREATED_AT, direction: DESC}]) {\n    count\n    edges {\n      node {\n        id\n        metadata {\n          name\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "1fa882bb24ba90c96b293f553f773967";
