...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'boolean',
      description:
        'Renders the Projects column. Must be paired with spreading the fragment as `...BAIAdminUserV2TableFragment @arguments(withProjects: true)` — the argument decides whether the memberships are fetched, this prop whether the column exists. Leave both off on project-scoped surfaces.',
    },
    {
      name: 'disableSorter',
      type: 'boolean',
