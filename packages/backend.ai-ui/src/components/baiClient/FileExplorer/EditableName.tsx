...
type EditableNameProps = {
  editableNameFrgmt?: EditableNameFragment$key | null;
    ...
    <>
      {!isEditing ? (
        <Component
          ...
          className={isEditable ? styles.hoverEdit : undefined}
          style={{
            ...style,
          }}
          {...props}
          ...
          onFinish={(values) => {
            ...
            if (fileInfo?.type === 'FILE') {
              ...
              if (_.includes(existingFileNames, values.newName)) {
                modal.confirm({
                  title: t('comp:FileExplorer.MoveFolderIntoAnother'),
                  content: t('comp:FileExplorer.MoveFolderIntoAnotherDesc', {
                    fileName: fileInfo.name,
                    targetName: values.newName,
                  }),
                  onOk: () => {
                    renameMutation.mutate(variables, {
                      onSuccess: () => {
