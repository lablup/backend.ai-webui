...
export const docs = {
  ...
  props: [
    ...
    {
      name: 'includeSFTPResourceGroups',
      type: 'boolean',
      description:
        'Keeps the SFTP-designated resource groups in the list, which are otherwise removed. Set it only where an SSH/SFTP system session is being configured — the groups are reserved for those.',
    },
    {
      name: 'value',
      type: 'string',
