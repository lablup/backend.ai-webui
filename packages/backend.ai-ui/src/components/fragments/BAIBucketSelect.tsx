/**
 ...
 BAIBucketSelect — ticket-27 Astryx sibling of the antd
...
export interface BAIBucketSelectProps extends Omit<
...
const BAIBucketSelect: React.FC<BAIBucketSelectProps> = ({
  objectStorageId,
  fetchKey,
  multiple = false,
  isLoading,
