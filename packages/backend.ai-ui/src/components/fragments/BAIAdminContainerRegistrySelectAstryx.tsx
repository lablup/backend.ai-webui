/**
 ...
 BAIAdminContainerRegistrySelectAstryx — ticket-27 Astryx sibling of
...
*/
import { BAIAdminContainerRegistrySelectAstryxPaginatedQuery } from '../../__generated__/BAIAdminContainerRegistrySelectAstryxPaginatedQuery.graphql';
...
export type AstryxContainerRegistryNode = NonNullable<
  NonNullable<
    BAIAdminContainerRegistrySelectAstryxPaginatedQuery['response']['container_registry_nodes']
  >['edges'][number]
>['node'];

export interface BAIAdminContainerRegistrySelectAstryxRef {
  refetch: () => void;
}

export interface BAIAdminContainerRegistrySelectAstryxProps extends Omit<
...
> {
  ...
  open?: boolean;
  defaultOpen?: boolean;
  ref?: React.Ref<BAIAdminContainerRegistrySelectAstryxRef>;
}

const BAIAdminContainerRegistrySelectAstryx: React.FC<
...
> = ({
  ...
  const { container_registry_nodes: selectedRegistryNodes } =
    useLazyLoadQuery<BAIAdminContainerRegistrySelectAstryxValueQuery>(
      graphql`
        query BAIAdminContainerRegistrySelectAstryxValueQuery(
  ...
  const { paginationData, result, loadNext, isLoadingNext } =
    useLazyPaginatedQuery<
      BAIAdminContainerRegistrySelectAstryxPaginatedQuery,
      AstryxContainerRegistryNode
    >(
      graphql`
        query BAIAdminContainerRegistrySelectAstryxPaginatedQuery(
          $offset: Int!
          $limit: Int!
          $filter: String
        ) {
...
export default BAIAdminContainerRegistrySelectAstryx;
