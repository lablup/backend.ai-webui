/**
 ...
 BAIAdminModelServiceSelectAstryx — ticket-27 Astryx sibling of
...
*/
import { BAIAdminModelServiceSelectAstryxPaginatedQuery } from '../../__generated__/BAIAdminModelServiceSelectAstryxPaginatedQuery.graphql';
import { BAIAdminModelServiceSelectAstryxValueQuery } from '../../__generated__/BAIAdminModelServiceSelectAstryxValueQuery.graphql';
...
export type AstryxModelServiceNode = NonNullable<
  NonNullable<
    BAIAdminModelServiceSelectAstryxPaginatedQuery['response']['adminDeployments']
  >['edges'][number]
>['node'];

export interface BAIAdminModelServiceSelectAstryxRef {
  refetch: () => void;
}

export interface BAIAdminModelServiceSelectAstryxProps extends Omit<
...
> {
  ...
  open?: boolean;
  defaultOpen?: boolean;
  ref?: React.Ref<BAIAdminModelServiceSelectAstryxRef>;
}

const BAIAdminModelServiceSelectAstryx: React.FC<
...
> = ({ multiple = false, isLoading, ref, ...selectProps }) => {
  ...
  const { deployment: selectedDeployment } =
    useLazyLoadQuery<BAIAdminModelServiceSelectAstryxValueQuery>(
      graphql`
        query BAIAdminModelServiceSelectAstryxValueQuery(
          $id: ID!
  ...
  const { paginationData, result, loadNext, isLoadingNext } =
    useLazyPaginatedQuery<
      BAIAdminModelServiceSelectAstryxPaginatedQuery,
      AstryxModelServiceNode
    >(
      graphql`
        query BAIAdminModelServiceSelectAstryxPaginatedQuery(
          $offset: Int!
          $limit: Int!
...
export default BAIAdminModelServiceSelectAstryx;
