...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "'token' | 'text'",
      description:
        'Inline appearance: `token` renders a Token per item for interactive contexts, `text` renders nowrap plain text for dense table cells.',
      default: "'token'",
    },
    {
      name: 'trigger',
...
/>`,
    ...
    {
      label: 'Tokens in a bulk-edit modal',
      code: `<BAITokenList
