...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'string',
      description:
        "Label of the ghost cancel button. Defaults to ui-common's `uic.common.cancel` catalog string, so override it only when the dismissal means something more specific.",
    },
    {
      name: 'actionVariant',
