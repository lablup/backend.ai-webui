...
/**
 * BAIAuditLogStatusBadge displays an audit log entry's status using a semantic
 * color-coded badge.
 *
 * Key features:
 ...
 */
const meta: Meta<typeof BAIAuditLogStatusBadge> = {
  title: 'Badge/BAIAuditLogStatusBadge',
  component: BAIAuditLogStatusBadge,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    docs: {
...
export default meta;
type Story = StoryObj<typeof BAIAuditLogStatusBadge>;
  ...
  render: () => {
    ...
    return (
      <BAIFlex direction="column" gap="md">
        {statuses.map((status) => (
          <BAIAuditLogStatusBadge key={status} status={status} />
        ))}
