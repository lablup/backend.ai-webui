...
export type BAICompareFn<RecordType> = (
  a: RecordType,
  b: RecordType,
 ...
 */
export interface BAIColumnGroupType<RecordType = BAIAnyObject> extends Omit<
...
export const isColumnVisible = (
  ...
  columnKey: string,
  overrides?: BAITableColumnOverrideRecord,
): boolean => {
