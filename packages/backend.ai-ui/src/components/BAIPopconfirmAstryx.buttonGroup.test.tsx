 ...
 * has to sit inside an Astryx `ButtonGroup` must use `BAIPopconfirmAstryx`'s
 ...
 */
import BAIPopconfirmAstryx from './BAIPopconfirmAstryx';
...
describe('BAIPopconfirmAstryx inside an Astryx ButtonGroup', () => {
  it('render-prop form keeps the trigger a DIRECT child of the group', () => {
    render(
      <ButtonGroup label="Control">
        <BAIPopconfirmAstryx title="Apply revision?">
          {(triggerProps) => (
