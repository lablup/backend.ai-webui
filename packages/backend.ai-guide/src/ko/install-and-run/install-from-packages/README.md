...
Backend.AI consists of a [variety of components](https://github.com/lablup/backend.ai#major-components), including open-source core components, pluggable extensions, and enterprise modules. Some of the major components are:
