...
The API server imposes a rate limit to prevent clients from overloading the server. The limit is applied to the last _N_ minutes at ANY moment (_N_ is 15 minutes by default).
