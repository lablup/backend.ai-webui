...
2. Manually creating [`APIConfig`](https://docs.backend.ai/en/latest/client/func/config.html#ai.backend.client.config.APIConfig) instance and creating sessions with it.
