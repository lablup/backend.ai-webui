...
* [Backend.AI Architecture](backend.ai-overview/backend.ai-architecture/architecture-overview.md)
  * [Service Components](backend.ai-overview/backend.ai-architecture/service-components/service-components-overview.md)
...
* [Enterprise Applications](backend.ai-overview/enterprise-applicatioins/enterprise-applications-overview.md)
...
* [FAQ](backend.ai-overview/faq/frequently-asked-questions.md)
...
* [Prerequisites](install-and-run/prerequisites/installation-prerequisites.md)
...
* [All-in-one (Single-node) Installation](install-and-run/single-node-all-in-one/single-node-installation.md)
  * [Install from Binary](install-and-run/single-node-all-in-one/install-from-binary/binary-installation-guide.md)
...
* [Advanced (Multi-node) Installation](install-and-run/advanced-installation/multi-node-installation.md)
  * [Multi-node Setup](install-and-run/advanced-installation/multi-node-setup.md)
* [Install from Packages](install-and-run/install-from-packages/package-installation-guide.md)
  * [Install Backend.AI Manager](install-and-run/install-from-packages/install-backend.ai-manager.md)
* [Install on Cloud Services](install-and-run/install-on-cloud-services/cloud-deployment-guide.md)
...
* [Run Applications](get-started/run-applications/application-running-guide.md)
...
* [Summary](backend.ai-usage-guide/summary/usage-summary.md)
  * [How to accept / reject invitations](backend.ai-usage-guide/summary/how-to-accept-reject-invitations.md)
* [Storage](backend.ai-usage-guide/storage/storage-overview.md)
  * [Data](backend.ai-usage-guide/storage/data/data-management-guide.md)
...
* [Workload](backend.ai-usage-guide/workload/workload-overview.md)
  * [Sessions](backend.ai-usage-guide/workload/sessions/session-management.md)
  ...
  * [Import & Run](backend.ai-usage-guide/workload/import-and-run/import-and-run-guide.md)
...
* [Playground](backend.ai-usage-guide/playground/playground-overview.md)
  * [AI Agents](backend.ai-usage-guide/playground/ai-agents.md)
  * [Chat](backend.ai-usage-guide/playground/chat/chat-interface-guide.md)
    * [How to create multiple chat windows](backend.ai-usage-guide/playground/chat/how-to-create-multiple-chat-windows.md)
* [Service](backend.ai-usage-guide/serving/model-serving-overview.md)
  * [Serving](backend.ai-usage-guide/serving/serving/model-serving-guide.md)
  ...
  * [Model Store](backend.ai-usage-guide/serving/model-store/model-store-guide.md)
...
* [Metrics](backend.ai-usage-guide/preferences/metrics-and-preferences.md)
  * [Statistics](backend.ai-usage-guide/preferences/statistics.md)
* [Profile & Preferences](backend.ai-usage-guide/data-and-storage/profile-and-preferences.md)
...
* [CLI (User)](cli-user/user-cli-guide.md)
...
* [CLI (Admin)](cli-admin/admin-cli-guide.md)
...
* [Starting FastTrack 2](fasttrack-2-mlops/starting-fasttrack-2/fasttrack-getting-started.md)
  * [Registering account and Logging-in](fasttrack-2-mlops/starting-fasttrack-2/registering-account-and-logging-in.md)
* [Pipelines](fasttrack-2-mlops/pipelines/pipeline-overview.md)
...
* [Pipeline Jobs](fasttrack-2-mlops/pipeline-jobs/pipeline-jobs-guide.md)
...
* [Manager API Reference](api-reference/manager-api-reference/manager-api-overview.md)
  * [Manager API Common Concepts](api-reference/manager-api-reference/manager-api-common-concepts/api-common-concepts.md)
  ...
  * [Manager REST API](api-reference/manager-api-reference/manager-rest-api/rest-api-reference.md)
...
* [Client SDK for Python](backend.ai-sdk/client-sdk-for-python.md)
  ...
  * [Command Line Interface](backend.ai-sdk/client-sdk-for-python/command-line-interface/python-sdk-cli-reference.md)
...
* [Forklift Key Concepts](deprecated/forklift-key-concepts/forklift-concepts.md)
