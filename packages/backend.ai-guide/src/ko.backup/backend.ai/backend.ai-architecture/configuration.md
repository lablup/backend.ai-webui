...
[The sample configurations in our source repository](https://github.com/lablup/backend.ai/tree/main/configs). Inside each component directory, `sample.toml` contains the full configuration schema and descriptions.
:::
