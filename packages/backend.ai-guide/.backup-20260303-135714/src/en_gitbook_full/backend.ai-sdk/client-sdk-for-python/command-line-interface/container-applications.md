...
This shell access does _NOT_ grant your root access. All compute session processes are executed as the user privilege.
...
<pre><code><strong>$ ssh-keygen -t rsa -b 2048 -f id_container
</strong>$ cat id_container.pub > authorized_keys
