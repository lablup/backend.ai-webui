...
- **속성 필터 및 정렬**: ID, 세션 이름 또는 소유자로 목록을 필터링할 수 있습니다. 소유자 값은 UUID를 직접 입력하는 대신 검색 가능한 사용자 계정 목록에서 선택 가능합니다. 적용된 필터 태그에는 선택한 계정의 이메일 주소가 표시됩니다. 정렬 가능한 열 헤더를 클릭하여 테이블을 정렬할 수 있습니다.
