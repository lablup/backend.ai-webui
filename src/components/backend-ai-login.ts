...
export default class BackendAILogin extends BackendAIPage {
  ...
  @property({type: Boolean}) always_enuqneue_compute_session = false;
  ...
  refreshWithConfig(config) {
    ...
    if (typeof config.general === 'undefined' || typeof config.general.alwaysEnqueueComputeSession === 'undefined' || config.general.alwaysEnqueueComputeSession === '' || config.general.alwaysEnqueueComputeSession == false) {
      this.always_enuqneue_compute_session = false;
    } else {
      this.always_enuqneue_compute_session = true;
    }
  ...
  * */
  ...
  _connectViaGQL() {
    ...
    return this.client.query(q, v).then((response) => {
      ...
      globalThis.backendaiclient._config.always_enuqneue_compute_session = this.always_enuqneue_compute_session;
