  ...
  firstUpdated() {
    ...
    this._parseConfig(configPath).then(() => {
      ...
      if (typeof globalThis.backendaiclient === 'undefined' || globalThis.backendaiclient === null || globalThis.backendaiclient.ready === false) {
        ...
        } else if (this._page === 'edu-applauncher' || this._page === 'applauncher') {
    ...
    html`
            ...
            <footer id="short-height">
              ...
              <address class="full-menu">
                ...
                <small class="sidebar-footer" style="font-size:9px;">23.03.4.230819</small>
              </address>
              ...
              <div class="content" style="box-sizing:border-box; padding:14px;">
                ...
                <section role="main" id="content" class="container layout vertical center">
                  <div id="app-page">
                    ...
                    <backend-ai-edu-applauncher class="page" name="edu-applauncher" ?active="${this._page === 'edu-applauncher' || this._page === 'applauncher'}"><mwc-circular-progress indeterminate></mwc-circular-progress></backend-ai-edu-applauncher>
