...
@customElement('backend-ai-maintenance-view-legacy')
export default class BackendAiMaintenanceViewLegacy extends BackendAIPage {
...
declare global {
  interface HTMLElementTagNameMap {
    'backend-ai-maintenance-view-legacy': BackendAiMaintenanceViewLegacy;
  }
}
