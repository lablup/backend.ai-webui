  ...
  render() {
    ...
    return html`
      <vaadin-grid class="${this.condition}" theme="row-stripes column-borders compact" aria-label="Job list"
        ...
        <vaadin-grid-column auto-width header="${_t('agent.Endpoint')}" .renderer="${this._boundEndpointRenderer}">
        </vaadin-grid-column>
        <vaadin-grid-column width="120px" resizable header="${_t('agent.BackendType')}"
                            .renderer="${this._boundTypeRenderer}">
        </vaadin-grid-column>
        <vaadin-grid-column resizable width="100px" header="${_t('agent.Resources')}"
                            .renderer="${this._boundResourceRenderer}">
        </vaadin-grid-column>
        <vaadin-grid-column width="100px" flex-grow="0" resizable header="${_t('agent.Capabilities')}"
