...
export default class BackendAiHelpButton extends BackendAIPage {
  ...
  showOnlineHelpPage(postfix: string) {
    globalThis.backendaiwindowmanager.addWindowWithURL(`https://webui.docs.backend.ai/${this.lang}/latest/` + postfix,
      'Help', 'help_outline', 'resources/menu_icons/help.svg');
