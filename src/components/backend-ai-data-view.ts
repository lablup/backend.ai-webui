          ...
          <div slot="message">
            <h3 class="horizontal center flex layout tab">
              <mwc-tab-bar>
                ...
                <mwc-tab title="data-folder" label="${_t("data.DataStore")}"
                    @click="${(e) => this._showTab(e.target)}">
                </mwc-tab>
                <mwc-tab title="model-folder" label="${_t("data.ModelStore")}"
                    @click="${(e) => this._showTab(e.target)}">
                </mwc-tab>
            ...
            <div id="automount-folder-lists" class="tab-content folder-lists" style="display:none;">
            ...
            <div id="data-folder-lists" class="tab-content folder-lists" style="display:none;">
              <div class="horizontal layout">
            ...
            <div id="model-folder-lists" class="tab-content folder-lists" style="display:none;">
              <div class="horizontal layout">
