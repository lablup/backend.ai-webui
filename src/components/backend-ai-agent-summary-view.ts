 ...
 */
type BackendAIAgentSummaryList =
  HTMLElementTagNameMap['backend-ai-agent-summary-list'];
...
export default class BackendAIAgentSummaryView extends BackendAIPage {
  ...
  _showTab(tab) {
    ...
    (
      this.shadowRoot?.querySelector('#' + tab.title) as HTMLDivElement
    ).style.display = 'block';
    this._tab = tab.title;
  }
