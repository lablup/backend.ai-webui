...
` : html``}
        ...
        <div class="layout horizontal wrap center">
          <div class="layout horizontal configuration">
            ...
            <span>${this._convertValueByUnit(rowData.item.max_vfolder_size)}</span>
            <span class="indicator">GB</span>
          </div>
          <div class="layout horizontal configuration">
   ...
   * @param unit - if true it enable unit conversion
   * @returns if number then returns number, else if then string
   */
  _convertValueByUnit(value, unit='GB') {
    value = globalThis.backendaiutils._markIfUnlimited(value);
    if (typeof value === 'number') {
      switch(unit) {
        case 'GB':
          value = globalThis.backendutils._bytesToGB(value);
          break;
        case 'MB':
          value = globalThis.backendutils._bytesToMB(value);
          break;
        case 'KB':
          value = globalThis.backendutils._bytesToGB(value);
          break;
