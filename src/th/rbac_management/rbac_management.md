...
บทบาทผู้ดูแลโปรเจกต์ที่ระบบสร้างขึ้น (บทบาท `project-<project_id>-admin` ที่มี**แหล่งที่มา**เป็น**ระบบ**) ไม่สามารถมอบหมายหรือเพิกถอนผู้ใช้ได้โดยตรงจากแท็บการมอบหมายบทบาท แท็บนี้จะแสดงการแจ้งเตือน **บทบาทที่ระบบสร้างขึ้นโดยอัตโนมัติไม่สามารถมอบหมายหรือนำผู้ใช้ออกได้โดยตรง** และตารางการมอบหมายจะเป็นแบบอ่านอย่างเดียว (ตัวควบคุม **เพิ่มผู้ใช้** และการเพิกถอนจะถูกซ่อนไว้)
