...
ผู้ดูแลระบบระดับสูงสามารถมอบและเพิกถอนสิทธิ์ผู้ดูแลโปรเจกต์ให้กับผู้ใช้หนึ่งคนหรือมากกว่าได้ในที่เดียวผ่านโมดอล **ตั้งค่าผู้ดูแลโปรเจกต์** ซึ่งเปิดจากหน้าผู้ดูแล**โปรเจกต์** (**ผู้ใช้ → โปรเจกต์**)
...
ถัดจากชื่อโมดอล ไอคอน **ดูสิทธิ์ RBAC** จะเปิดหน้าการจัดการ RBAC โดยที่บทบาท `role_project_<project_id>_admin` ของโปรเจกต์ถูกกรองไว้ล่วงหน้าและแผงรายละเอียดเปิดอยู่ เพื่อให้คุณตรวจสอบบทบาทพื้นฐานได้ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับบทบาทนั้น ดูที่[การมอบสิทธิ์ผู้ดูแลโปรเจกต์](#grant-project-admin)ในบทการจัดการ RBAC
...
- **ตัวกรองคุณสมบัติและการจัดเรียง**: กรองรายการตาม ID, ชื่อเซสชัน หรือเจ้าของ ค่าเจ้าของจะเลือกจากรายการบัญชีผู้ใช้ที่ค้นหาได้แทนการพิมพ์ UUID และแท็กตัวกรองที่ได้จะแสดงอีเมลของบัญชีนั้น คลิกที่ส่วนหัวคอลัมน์ที่สามารถจัดเรียงได้เพื่อจัดเรียงตาราง
