---
navTitle: การเมาท์โฟลเดอร์จัดเก็บ
---
...
ให้ไปที่ขั้นตอน 'ข้อมูลและการจัดเก็บ' แล้วเปิดดรอปดาวน์ **เลือกโฟลเดอร์** เพื่อดูโฟลเดอร์ที่ผู้ใช้สามารถเมาท์ได้
เลือกโฟลเดอร์หนึ่งโฟลเดอร์หรือมากกว่านั้นจากดรอปดาวน์นี้ โฟลเดอร์ที่เลือกแต่ละรายการจะถูกเพิ่มเข้าไปในรายการโฟลเดอร์ที่จะเมาท์
...
โปรดทราบว่าขั้นตอน 'ข้อมูลและการจัดเก็บ' จะแสดงเฉพาะโฟลเดอร์จัดเก็บที่ผู้ใช้ปัจจุบันสามารถเมาท์ได้เท่านั้น
...
หากต้องการกำหนดพาธของการเมาท์เอง ให้ระบุพาธแบบสัมบูรณ์ในช่อง **พาธในคอนเทนเนอร์ (destination)** ที่แถวของโฟลเดอร์นั้น
การระบุ `/workspace` ในช่องของโฟลเดอร์ `test` จะเมาท์ไปที่ `/workspace` ภายในเซสชัน
การระบุพาธแบบสัมพัทธ์จะเมาท์โฟลเดอร์ภายใต้ `/home/work/` ด้วยพาธดังกล่าว
:::

:::note
หากต้องการเมาท์โฟลเดอร์ย่อยแทนทั้งโฟลเดอร์ ให้ระบุช่อง **พาธในโฟลเดอร์ (source)** ที่แถวของโฟลเดอร์นั้น
คลิกที่ช่องนี้เพื่อเรียกดูโฟลเดอร์และเลือกพาธ หากเว้นว่างไว้จะเป็นการเมาท์ root ของโฟลเดอร์
:::
