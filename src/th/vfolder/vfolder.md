...
- **IP ของไคลเอ็นต์**: ที่อยู่ IP ที่ใช้ร้องขอการดำเนินการ แสดงตามที่เซิร์ฟเวอร์รายงานทุกประการ อาจถูกปิดบังบางส่วนตามนโยบายการปิดบัง IP ของไคลเอ็นต์ที่ผู้ดูแลระบบกำหนด และจะแสดงเป็น `-` หากไม่มีการบันทึก
...
หากบางโฟลเดอร์ที่เลือกไว้ยังคงลบไม่สำเร็จ โฟลเดอร์ที่ลบได้จะถูกย้ายไปยังแท็บถังขยะตามปกติ
และไดอะล็อกแจ้งความล้มเหลวจะแสดงรายชื่อโฟลเดอร์ที่ล้มเหลวพร้อมเหตุผลในคอลัมน์
