...
ให้คลิกปุ่ม `ป้อนด้วยตนเอง` จากนั้นคุณจะเห็นพื้นที่
...
แล้วเขียนเนื้อหา คุณสามารถบันทึกสคริปต์โดยคลิกปุ่ม `บันทึก` หรือ
`บันทึกและปิด` คลิกปุ่ม `ลบ` เพื่อลบสคริปต์
