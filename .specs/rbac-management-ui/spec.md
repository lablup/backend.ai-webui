...
│  [이름 검색...]  [Source: 전체 ▼]                             │
├──────┬─────────┬──────────┬──────────┬──────────┬──────────┤
│ 이름  │ 액션    │ 설명     │ Source   │ 생성일    │ 수정일    │
├──────┼─────────┼──────────┼──────────┼──────────┼──────────┤
│ role1│[수정][삭제]│ 설명... │ CUSTOM   │ 2026-... │ 2026-... │
│ role2│[수정][삭제]│ 설명... │ SYSTEM   │ 2026-... │ 2026-... │
│ role3│[수정][삭제]│ 설명... │ CUSTOM   │ 2026-... │ 2026-... │
└──────┴─────────┴──────────┴──────────┴──────────┴──────────┘
                     [< 1 2 3 ... >]
```
...
| 액션 | - | X | 이름 옆에 위치. 수정/삭제 버튼을 **항상 표시**하되, SYSTEM 역할은 수정 버튼을 disabled 처리. |
...
- [ ] SYSTEM 역할 행의 액션 컬럼에는 수정/삭제 버튼이 모두 표시되되, 수정 버튼은 disabled 처리된다
...
- **완전 삭제 (purge)**: "역할 '{name}'을(를) 영구적으로 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다."
...
2. 강한 경고 확인 다이얼로그가 표시된다: "역할 '{name}'을(를) 영구적으로 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다."
3. 사용자가 "확인"을 클릭한다
...
- [ ] 완전 삭제(purge) 확인 다이얼로그에는 되돌릴 수 없음을 안내하는 강한 경고 메시지가 표시된다
...
│ 이메일    │ 액션  │ 이름  │ 할당자│ 할당일│
├──────────┼───────┼──────┼──────┼──────┤
│ a@ex.com │[제거] │ 김OO │admin │03-01 │
│ b@ex.com │[제거] │ 이OO │admin │03-02 │
└──────────┴───────┴──────┴──────┴──────┘
          [< 1 2 ... >]
```
...
| 컬럼 | 데이터 소스 | 비고 |
|------|------------|------|
| 이메일 | `node.user.email` | `UserV2`의 `email` 필드. 행을 식별하는 주요 컬럼. |
| 액션 | - | 이메일 옆에 위치. "제거" 버튼을 **항상 표시**. |
