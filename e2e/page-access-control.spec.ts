...
test.describe('Page Access Control - Config-Based Menu Management', () => {
  ...
  test(
    ...
    async ({ page, request }) => {
      ...
      await expect(dashboardMenuItem).not.toHaveClass(/ant-menu-item-disabled/);
...
test.describe
  .serial('Page Access Control - Permission-Based Access (401 Page)', () => {
  test.afterEach(async ({ page, request }) => {
    // Reset config after each test
    await modifyConfigToml(page, request, {
      menu: {
...
test.describe.serial('Page Access Control - Not Found Page (404)', () => {
  test.afterEach(async ({ page, request }) => {
    // Reset config after each test
    await modifyConfigToml(page, request, {
      menu: {
...
test.describe
  .serial('Page Access Control - Root Redirect with Configuration', () => {
  test.afterEach(async ({ page, request }) => {
    // Reset config after each test
    await modifyConfigToml(page, request, {
      menu: {
...
test.describe
  .serial('Page Access Control - Combined Scenarios (blocklist + inactiveList)', () => {
  test.afterEach(async ({ page, request }) => {
    // Reset config after each test
    await modifyConfigToml(page, request, {
      menu: {
