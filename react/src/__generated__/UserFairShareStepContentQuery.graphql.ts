/**
 * @generated SignedSource<<e9e28f5518bd792933ccb53a8e306fb6>>
...
export type UserFairShareStepContentQuery$variables = {
  domainName: string;
...
export type UserFairShareStepContentQuery$data = {
...
export type UserFairShareStepContentQuery = {
  response: UserFairShareStepContentQuery$data;
  variables: UserFairShareStepContentQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "UserFairShareStepContentQuery",
    "selections": [
      {
