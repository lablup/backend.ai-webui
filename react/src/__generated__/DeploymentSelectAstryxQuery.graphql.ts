/**
 * @generated SignedSource<<1a8670d3d46b97a0a25defc3fee2a286>>
...
export type DeploymentSelectAstryxQuery$variables = {
  filter?: DeploymentFilter | null | undefined;
  limit: number;
  offset: number;
};
export type DeploymentSelectAstryxQuery$data = {
...
export type DeploymentSelectAstryxQuery = {
  response: DeploymentSelectAstryxQuery$data;
  variables: DeploymentSelectAstryxQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "DeploymentSelectAstryxQuery",
    "selections": (v3/*: any*/),
    "type": "Query",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "225e9d57cc561a7d90b1d432ee10bc6c",
    "id": null,
    "metadata": {},
    "name": "DeploymentSelectAstryxQuery",
    "operationKind": "query",
    "text": "query DeploymentSelectAstryxQuery(\n  $offset: Int!\n  $limit: Int!\n  $filter: DeploymentFilter\n) {\n  myDeployments(offset: $offset, limit: $limit, filter: $filter) {\n    count\n    edges {\n      node {\n        id\n        metadata {\n          name\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "8a10cfe7037e983b5d803cb67c2c4407";
