/**
 * @generated SignedSource<<4724a9976c8d537dc03eb77f7533b890>>
...
export type DeploymentAddRevisionModalCardDetailQuery$variables = {
  id: string;
};
export type DeploymentAddRevisionModalCardDetailQuery$data = {
  readonly modelCardV2: {
    readonly " $fragmentSpreads": FragmentRefs<"ModelCardDrawerFragment">;
  } | null | undefined;
};
export type DeploymentAddRevisionModalCardDetailQuery = {
  response: DeploymentAddRevisionModalCardDetailQuery$data;
  variables: DeploymentAddRevisionModalCardDetailQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "de2c58a7de350330d8559997572df6e3",
    "id": null,
    "metadata": {},
    "name": "DeploymentAddRevisionModalCardDetailQuery",
    "operationKind": "query",
...
(node as any).hash = "7a00abc85c6a3022e3769179674ef33e";
