...
import React, { forwardRef, useEffect, useMemo, useTransition } from 'react';
...
const ResourceAllocationFormItems: React.FC<ResourceAllocationFormItemsProps> =
  forwardRef(
    (
      {
        enableNumOfSessions,
      ...
      const updateResourceFieldsBasedOnImage = (force?: boolean) => {
        ...
        const minimumResources: Partial<
          ResourceAllocationFormValue['resource']
        > = {
      ...
      return (
        <>
          ...
          <Card
            className="resource-allocation-card"
            style={{
