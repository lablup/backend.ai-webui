import {
  ImageListBefore202506Query,
  ImageListBefore202506Query$data,
} from '../__generated__/ImageListBefore202506Query.graphql';
...
import ManageAppsModalBefore202506 from './ManageAppsModalBefore202506';
import ManageImageResourceLimitModalBefore202506 from './ManageImageResourceLimitModalBefore202506';
...
export type EnvironmentImage = NonNullable<
  NonNullable<ImageListBefore202506Query$data['images']>[number]
>;
...
const ImageList: React.FC<{ style?: React.CSSProperties }> = ({ style }) => {
  ...
  const { images } = useLazyLoadQuery<ImageListBefore202506Query>(
    graphql`
      query ImageListBefore202506Query {
        images {
          id
          ...
          ...ManageImageResourceLimitModalBefore202506_image
          ...ManageAppsModalBefore202506_image
        }
      }
    `,
    {},
  ...
  return (
    <>
      ...
      <ManageImageResourceLimitModalBefore202506
