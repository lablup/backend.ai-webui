        ...
        <BAIGraphQLPropertyFilter
          ...
          onChange={(next) => {
            onReload(
              {
                ...queryRef.variables,
                // `UserResourcePolicyV2Filter` has no AND/OR/NOT keys, so the
                // structurally wider `GraphQLFilter` needs a narrowing cast.
                filter: next as UserResourcePolicyV2Filter | undefined,
                offset: 0,
              },
