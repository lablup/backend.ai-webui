/**
 ...
 GAP COMPONENT 3/5 (cn-oss-removal / ticket 10) — `BAIPopconfirm`.
 ...
 reserves the modal-with-typed-string (`BAIDeleteConfirmModalAstryx`, built in
 phase 6) for IRREVERSIBLE actions, and keeps the anchored one-click
