...
} from '../__generated__/LegacyCreatePermissionModalCreateMutation.graphql';
...
export const PermissionMatrixQuery = graphql`
  query LegacyCreatePermissionModalPermissionMatrixQuery {
...
interface LegacyCreatePermissionModalProps extends BAIModalProps {
  roleId: string;
  /** Preloaded query reference produced by the opener via `useQueryLoader`. */
  queryRef: PreloadedQuery<LegacyCreatePermissionModalPermissionMatrixQuery>;
  roleScopeFrgmt?: LegacyCreatePermissionModal_roleScopeFragment$key | null;
  editingPermission?: EditingPermission | null;
  onRequestClose: (success: boolean) => void;
}

const LegacyCreatePermissionModal: React.FC<
  LegacyCreatePermissionModalProps
> = ({
  roleId,
  queryRef,
  roleScopeFrgmt,
  ...
  const { rbacPermissionMatrix } =
    usePreloadedQuery<LegacyCreatePermissionModalPermissionMatrixQuery>(
  ...
  const [commitCreatePermission, isCreateInFlight] =
    useMutation<LegacyCreatePermissionModalCreateMutation>(graphql`
      mutation LegacyCreatePermissionModalCreateMutation(
  ...
  const [commitUpdatePermission, isUpdateInFlight] =
    useMutation<LegacyCreatePermissionModalUpdateMutation>(graphql`
      mutation LegacyCreatePermissionModalUpdateMutation(
...
export default LegacyCreatePermissionModal;
