...
import BAICodeMirror from './BAICodeMirror';
        ...
        {shellInfo === 'userconfig' && (
          <Select
            ...
            options={[
              ...
              { value: '.tmux.conf.local', label: '.tmux.conf.local' },
              { value: '.vimrc', label: '.vimrc' },
              { value: '.Renviron', label: '.Renviron' },
            ]}
            style={{ width: '200px' }}
          />
        )}
