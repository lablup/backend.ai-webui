...
const CodeBlock: React.FC<{ content: string; copyable?: boolean }> = ({
  content,
  copyable = false,
}) => {
  'use memo';
    ...
    <div style={{ position: 'relative' }}>
      <Typography.Paragraph
        style={{
          ...
          // Reserve room on the right so long lines don't run under the
          // absolutely-positioned copy icon.
          paddingRight: copyable
            ? token.padding + token.paddingXL
            : token.padding,
  ...
  return (
    <BAIFlex direction="column" align="stretch" gap="lg">
          ...
          <BAIFlex direction="column" align="stretch" gap="sm">
            ...
            {selectedOS === 'MacOS' ? (
              <Alert
                ...
                description={
                  <BAIFlex direction="column" align="stretch" gap="xs">
                    ...
                    <CodeBlock content={macOSUnblockSnippet} copyable />
                  </BAIFlex>
                }
              />
            ) : (
              <BAIFlex direction="column" align="stretch" gap="xs">
                ...
                <CodeBlock content={runSnippet} copyable />
              </BAIFlex>
            )}
          </BAIFlex>
      ...
      <BAIFlex direction="column" align="stretch" gap="sm">
        ...
        <CodeBlock content={pipSnippet} copyable />
      </BAIFlex>
    </BAIFlex>
  );
};
