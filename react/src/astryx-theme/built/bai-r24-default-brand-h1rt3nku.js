...
/**
 * bai-r24-default-brand-h1rt3nku theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { baiR24DefaultBrandH1rt3nkuTheme } from './bai-r24-default-brand-h1rt3nku';
 *   import './bai-r24-default-brand-h1rt3nku.css';
 */
export const baiR24DefaultBrandH1rt3nkuTheme = {
  name: 'bai-r24-default-brand-h1rt3nku',
  __built: true,
  tokens: {
  ...
  __localTokenLineage: ["neutral","bai-r24-default-brand-h1rt3nku"],
  components: {
    "heading": {
      "level:1": {
