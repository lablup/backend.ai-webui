...
import { BAIFlex, compareNumberWithUnits, useBAILogger } from 'backend.ai-ui';
...
import ResourceAllocationFormItems from 'src/components/SessionFormItems/ResourceAllocationFormItems';
import {
  JsonParam,
  NumberParam,
  StringParam,
        ...
        const deploymentInput: DeploymentLauncherPageCreateModelDeploymentMutation$variables['input'] =
          {
            metadata: {
              ...
              domainName: values.metadata.domainName,
