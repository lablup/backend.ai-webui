...
import { BAIImportArtifactModalArtifactFragment$key } from 'backend.ai-ui/__generated__/BAIImportArtifactModalArtifactFragment.graphql';
...
const ReservoirPage: React.FC = () => {
  ...
  const [selectedArtifact, setSelectedArtifact] =
    useState<BAIImportArtifactModalArtifactFragment$key | null>(null);
