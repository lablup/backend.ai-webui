import BAIModal, { DEFAULT_BAI_MODAL_Z_INDEX } from '../components/BAIModal';
...
import VFolderTableFormItem from '../components/VFolderTableFormItem';
import {
...
import { ServiceLauncherPageModifyMutation } from './__generated__/ServiceLauncherPageModifyMutation.graphql';
...
const ServiceValidationView = React.lazy(
  () => import('../components/ServiceValidationView'),
);
...
interface ServiceLauncherPageProps {}

const ServiceLauncherPage: React.FC<ServiceLauncherPageProps> = () => {
  ...
  const { endpoint } = useLazyLoadQuery<ServiceLauncherPageQuery>(
    graphql`
      query ServiceLauncherPageQuery(
        $endpointId: UUID!
        $skipEndpointQuery: Boolean!
      ) {
        endpoint(endpoint_id: $endpointId) @skip(if: $skipEndpointQuery) {
          endpoint_id
  ...
  ] = useMutation<ServiceLauncherPageModifyMutation>(graphql`
    mutation ServiceLauncherPageModifyMutation(
      $endpoint_id: UUID!
