...
import BAIFallbackCard from '../components/BAIFallbackCard';
...
const VFolderNodeListPage: React.FC<VFolderNodeListPageProps> = ({
  ...
  const isDeletedCategory = (status?: string | null) => {
    return _.includes(
      ['DELETE_PENDING', 'DELETE_ONGOING', 'DELETE_COMPLETE', 'DELETE_ERROR'],
      status,
    );
  };
