...
const DeploymentDetailPage: React.FC = () => {
  ...
  // PAGE decides the project context: on the project-agnostic (global admin)
  // URL space there is no ambient project (`null` — no mismatch alert, no
  // switch-project shortcut, and the Add-revision CTA is not suppressed);
  // elsewhere the narrowed ambient project keeps today's behavior exactly.
