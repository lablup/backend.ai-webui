...
const DeploymentDetailPage: React.FC = () => {
  ...
  const [commitSetCurrentRevision, isInFlightSetCurrentRevision] = useMutation(
    graphql`
            ...
            <BAIFlex direction="column" align="stretch" gap="sm">
              <BAIFlex direction="row" justify="end">
                <Button
                  type="primary"
                  onClick={() => {
                    // TODO: implement route synchronization mutation request
                  }}
                >
                  {t('deployment.SyncRoutes')}
                </Button>
              </BAIFlex>
              <BAIFlex direction="column" align="stretch" gap="sm">
                <RouteList
                  routesFrgmt={filterOutNullAndUndefined(
                    _.flatMap(
                      ...
                      (edge) =>
                        edge.node?.routings?.edges?.map(
                          (routingEdge) => routingEdge.node,
                        ) ?? [],
                    ),
                  )}
                />
