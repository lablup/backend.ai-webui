  ...
  style.textContent = `
    ...
    * { box-sizing: border-box; font-family: ui-sans-serif, system-ui, sans-serif; }
    ...
    .panel header {
      ...
      font-size: 16px; display: flex; align-items: center; gap: 6px; flex-wrap: wrap;
    }
    ...
    .srcline {
      padding: 6px 12px; border-bottom: 1px solid #eee; font-size: 13px;
    ...
    .item .meta { color: #888; font-size: 13px; margin-bottom: 3px; display: flex; gap: 6px; align-items: center; flex-wrap: wrap; }
    ...
    .item .lastreply {
      ...
      background: #f0f8ff; color: #444; font-size: 13px;
      white-space: pre-wrap; word-break: break-word;
    }
    .item .actions { margin-top: 4px; display: flex; gap: 6px; }
    .item .actions button { font-size: 13px; }
    .badge {
      font-size: 12px; border-radius: 9px; padding: 1px 7px; border: 1px solid;
    }
    ...
    .pin {
      position: absolute; z-index: 2147482999; width: 24px; height: 24px;
      margin: -12px 0 0 -12px; border-radius: 50% 50% 50% 0;
