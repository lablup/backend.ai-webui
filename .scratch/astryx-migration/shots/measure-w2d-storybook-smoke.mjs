...
const PORT = process.argv[2] || '5881';
...
const SHOOT_IDS = [
  // W2-D: one story per converted component family.
  'card-baicard--with-tabs',
  'card-baicard--status-variants',
  'button-baibutton--default',
  'button-baibackbutton--default',
  'button-baifetchkeybutton--interval-dropdown',
  'input-baicheckbox--form-error-status',
  'input-baiuncontrolledinput--default',
  'input-baidynamicstepinputnumber--cpu-cores',
  'input-baidynamicunitinputnumber--default',
  'input-baidynamicunitinputnumberwithslider--extra-marks',
  'select-baiallowedhostnamesselect--multiple-selection',
  'select-baiselect--default',
  'components-baibulkeditformitem--with-select',
  'components-baitaglist--default',
  'notification-bainotificationitem--default',
  'components-baiprogresswithlabel--default',
  'components-bairesourcenumberwithicon--default',
  'components-baiquestioniconwithtooltip--default',
  'components-baiselectionlabel--default',
  'components-booleantag--default',
  'components-resourcestatistics--default',
];
