...
description: Capture screenshots for the user manual documentation. Uses Playwright MCP to navigate the live application, take screenshots, and save them to the docs image directories. Invoke for TODO screenshot markers in docs, explicit capture requests, or refreshing screenshots after a UI change.
