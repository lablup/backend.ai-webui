...
- **Update plan**: `packages/backend.ai-webui-docs/docs-update-plan.md` (if available)
...
1. Save the review report to `packages/backend.ai-webui-docs/docs-review-report.md`
2. Apply all fixes directly to the documentation files
3. Present a summary of findings and changes to the user
