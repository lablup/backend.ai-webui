...
description: Explore a running Backend.AI WebUI page with the browser and write a Markdown e2e test plan (user-scenario test names, steps, expected results, cleanup and execution-mode notes). Use when the user wants test scenarios for a page or feature before tests are generated.
