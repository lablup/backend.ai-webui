...
description: Create comprehensive test plans for a web application. Explores the target pages in a browser and produces detailed test scenarios. Invoke when a page or flow needs test coverage designed before writing tests.
