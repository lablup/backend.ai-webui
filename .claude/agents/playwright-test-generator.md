...
description: Generate Playwright e2e tests (e2e/**/*.spec.ts) from a test plan by executing each step live in the browser and writing the resulting test. Use when a plan exists and the user wants runnable automated tests.
