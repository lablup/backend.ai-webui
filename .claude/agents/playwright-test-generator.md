...
description: Create automated browser tests using Playwright. Invoke when a specific user flow (login, checkout, form submission, etc.) needs to be turned into a validated Playwright test.
