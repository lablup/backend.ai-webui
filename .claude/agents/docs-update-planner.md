...
description: Plan user manual documentation updates (packages/backend.ai-webui-docs/). Analyzes PR/stack changes or a plain feature description to identify what needs to be added or updated in the manual. Invoke when checking whether a PR, a PR stack, or a described feature needs docs changes.
