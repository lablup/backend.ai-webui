...
- **Format**: Markdown (`.md`)
- **Update plan**: `packages/backend.ai-webui-docs/docs-update-plan.md` (created by docs-update-planner)

## Workflow

### Step 1: Read the Documentation Update Plan

Read the plan file at `packages/backend.ai-webui-docs/docs-update-plan.md` to understand:
